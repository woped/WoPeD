...
public abstract class Messages {
  ...
  public static boolean exists(String key) {
    try {
      PropertyResourceBundle.getBundle(
              BUNDLE_NAME, ConfigurationManager.getConfiguration().getLocale())
          .getString(key);
      return true;
  ...
  public static String getStringForLocale(String key, Locale locale) {
    PropertyResourceBundle tempRB =
        (PropertyResourceBundle) PropertyResourceBundle.getBundle(BUNDLE_NAME, locale);
    try {
