...
/** Class AnalysisTools. Provides static methods for analyzing Messages.properties files */
public class AnalysisTools {
  ...
  /**
   * Substring before last seperator. Returns substring before last occurrence of a given seperator.
   *
  ...
  /**
   * List files. retruns all .java files in a given directory (incl. subdirectories)
   *
