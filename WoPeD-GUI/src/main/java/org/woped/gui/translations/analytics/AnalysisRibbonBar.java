...
/** The Class AnalysisRibbonBar. Provides the RibbonUI for AnalyticTools */
...
public class AnalysisRibbonBar extends JRibbon {
  ...
  private JRibbonBand getAnalysisBand() {
    if (analysisBand == null) {
      ...
      analysisBand.setResizePolicies(
          (List)
              Arrays.asList(
                  new CoreRibbonResizePolicies.None(analysisBand.getControlPanel()),
                  new IconRibbonBandResizePolicy(analysisBand.getControlPanel())));
      analysisBand.setResizePolicies(
          (List)
              Arrays.asList(
                  new CoreRibbonResizePolicies.None(analysisBand.getControlPanel()),
  ...
  private JRibbonBand getActionBand() {
    if (actionBand == null) {
      ...
      actionBand.setResizePolicies(
          (List)
              Arrays.asList(
                  new CoreRibbonResizePolicies.None(actionBand.getControlPanel()),
                  new IconRibbonBandResizePolicy(actionBand.getControlPanel())));
      actionBand.setResizePolicies(
          (List)
              Arrays.asList(
                  new CoreRibbonResizePolicies.None(actionBand.getControlPanel()),
  ...
  private JCommandButton getLanguageChooser() {
    if (fileChooserButton == null) {
      ...
      fileChooserButton.setPopupCallback(
