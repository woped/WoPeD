 ...
 */
public class help_reportbug implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(6.7027130126953125, 73.61571502685547),
            7.228416f,
            new Point2D.Double(6.7027130126953125, 73.61571502685547),
            new float[] {0.0f, 1.0f},
            ...
            new AffineTransform(1.9022200107574463f, 0.0f, 0.0f, 0.5257030129432678f, 0.0f, 0.0f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(9.164306640625, 38.070892333984375),
            new Point2D.Double(9.885503768920898, 52.09067916870117),
            new float[] {0.0f, 0.23809524f, 1.0f},
            new Color[] {
              new Color(223, 224, 223, 255),
              new Color(166, 176, 166, 255),
              new Color(181, 190, 181, 255)
            },
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(27.741130828857422, 38.71150588989258),
            17.977943f,
            new Point2D.Double(27.741130828857422, 38.71150588989258),
            new float[] {0.0f, 1.0f},
            ...
            new AffineTransform(
                0.6299290060997009f,
                0.45937299728393555f,
                -0.14767499268054962f,
                0.24851199984550476f,
                16.517200469970703f,
                9.053739547729492f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(11.742170333862305, 11.484869956970215),
            new Point2D.Double(13.846982955932617, 11.98198127746582),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(226, 226, 226, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(10.027000427246094, 20.21976089477539),
            new Point2D.Double(17.178024291992188, -7.527464389801025),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(226, 226, 226, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(11.841544151306152, 4.250730514526367),
            new Point2D.Double(40.0240592956543, 7.412107467651367),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(17.39720344543457, 33.35737609863281),
            new Point2D.Double(22.177709579467773, 31.02674102783203),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(28.789100646972656, 20.971200942993164),
            13.2807f,
            new Point2D.Double(28.789100646972656, 20.971200942993164),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(228, 30, 8, 255), new Color(144, 21, 5, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.3103899955749512f,
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(26.887432098388672, 20.479358673095703),
            14.6944f,
            new Point2D.Double(26.887432098388672, 20.479358673095703),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(228, 30, 8, 255), new Color(144, 21, 5, 255)},
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(15.338735580444336, 5.924462795257568),
            new Point2D.Double(43.1409797668457, 49.89507293701172),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 161, 150, 255), new Color(255, 31, 6, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.9757279753684998f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(18.570419311523438, 9.443662643432617),
            new Point2D.Double(29.957399368286133, 22.78322410583496),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 63), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.0286699533462524f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(21.587093353271484, 23.499000549316406),
            new Point2D.Double(21.587093353271484, 2.8163671493530273),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(114, 159, 207, 255), new Color(175, 201, 228, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.106909990310669f,
                -0.2584039866924286f,
                0.25974801182746887f,
                1.1016700267791748f,
                -19.66699981689453f,
                12.19789981842041f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(25.95013427734375, 2.8703360557556152),
            new Point2D.Double(29.477813720703125, 46.06208038330078),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(7.2054595947265625, 75.56610870361328),
            7.228416f,
            new Point2D.Double(7.2054595947265625, 75.56610870361328),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(0, 0, 0, 0)},
            ...
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.9022200107574463f, 0.0f, 0.0f, 0.35548698902130127f, 0.0f, 12.862600326538086f));
    shape = new GeneralPath();
    ((GeneralPath) shape).moveTo(26.5, 38.7);
    ((GeneralPath) shape).curveTo(26.5, 40.798683, 20.343916, 42.5, 12.75, 42.5);
    ((GeneralPath) shape).curveTo(5.1560845, 42.5, -1.0, 40.798683, -1.0, 38.7);
