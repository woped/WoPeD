 ...
 */
public class home implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.0374000072479248f, 0.0f, -1.6485999822616577f));
    // _0_0_0
    g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
    ...
    paint =
        new RadialGradientPaint(
            ...
            new AffineTransform(2.0f, 0.0f, 0.0f, 0.800000011920929f, -13.0f, -79.19999694824219f));
    ...
    paint =
        new RadialGradientPaint(
            ...
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(2.0f, 0.0f, 0.0f, 0.800000011920929f, 36.0f, 8.800000190734863f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(21.875, 48.000999450683594),
            new Point2D.Double(21.875, 40.0),
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(8.177200317382812, 5.857699871063232),
            new Point2D.Double(8.177200317382812, 15.677000045776367),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(114, 159, 207, 255), new Color(56, 110, 166, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                3.137200117111206f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(26.062000274658203, 23.266000747680664),
            new Point2D.Double(29.0310001373291, 55.26599884033203),
            new float[] {0.0f, 1.0f},
