 ...
 */
public class document_print implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new LinearGradientPaint(
            ...
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.4901609420776367f, 0.0f, 0.0f, 0.66874098777771f, 0.08895131945610046f, 2.0f));
