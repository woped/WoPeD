 ...
 */
public class format_indent_less
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(
            0.023305730894207954f,
            0.0f,
            0.0f,
            0.012270580045878887f,
            44.47890853881836f,
            44.416908264160156f));
    // _0_0_0
    ...
    shape = new Rectangle2D.Double(10.0, 6.0, 17.63051986694336, 2.0);
    g.setPaint(paint);
    g.fill(shape);
    ...
    // _0_0_3
    paint = new Color(153, 153, 153, 255);
    shape = new Rectangle2D.Double(10.0, 10.0, 16.324554443359375, 2.0);
    g.setPaint(paint);
    g.fill(shape);
    ...
    // _0_0_4
    paint = new Color(153, 153, 153, 255);
    shape = new Rectangle2D.Double(10.0, 14.0, 15.0, 2.0);
    g.setPaint(paint);
    g.fill(shape);
    ...
    // _0_0_5
    paint = new Color(153, 153, 153, 255);
    shape = new Rectangle2D.Double(10.0, 18.0, 17.63051986694336, 2.0);
    g.setPaint(paint);
    g.fill(shape);
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(10.729690551757812, 26.422195434570312),
            new Point2D.Double(2.394106388092041, 26.422195434570312),
            new float[] {0.0f, 1.0f},
            ...
            new AffineTransform(
                ...
                4.174915790557861f));
    shape = new GeneralPath();
    ((GeneralPath) shape).moveTo(35.851425, 26.743532);
    ((GeneralPath) shape).lineTo(35.851425, 38.610554);
    ((GeneralPath) shape).lineTo(22.739004, 38.610554);
    ((GeneralPath) shape).lineTo(22.739004, 44.458668);
    ((GeneralPath) shape).lineTo(9.0, 32.65186);
    ((GeneralPath) shape).lineTo(22.741562, 21.0);
    ((GeneralPath) shape).lineTo(22.741562, 26.747164);
    ((GeneralPath) shape).lineTo(35.851425, 26.743532);
    ((GeneralPath) shape).closePath();
    g.setPaint(paint);
    g.fill(shape);
