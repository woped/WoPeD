...
public class woped implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  ...
  private void paintShapeNode_0_0_0_0(Graphics2D g) {
    RoundRectangle2D.Double shape0 =
  ...
  private void paintShapeNode_0_0_0_2(Graphics2D g) {
    RoundRectangle2D.Double shape2 =
        new RoundRectangle2D.Double(
            6.073121547698975,
            146.05706787109375,
            198.55467224121094,
  ...
  private void paintShapeNode_0_0_0_3(Graphics2D g) {
    Rectangle2D.Double shape3 =
        new Rectangle2D.Double(
            5.56222677230835, 143.93276977539062, 200.2532196044922, 1.9198436737060547);
  ...
  private void paintShapeNode_0_0_0_4(Graphics2D g) {
    Rectangle2D.Double shape4 =
        new Rectangle2D.Double(
            5.946183681488037, -179.25787353515625, 198.8957061767578, 33.40525817871094);
    g.setPaint(new Color(255, 173, 0, 241));
    g.fill(shape4);
  }
