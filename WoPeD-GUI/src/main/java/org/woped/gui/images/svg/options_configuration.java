 ...
 */
public class options_configuration
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(24.8125, 39.125),
            17.6875f,
            new Point2D.Double(24.8125, 39.125),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(19.64834213256836, 42.25360107421875),
            new Point2D.Double(20.631223678588867, 6.775803089141846),
            new float[] {0.0f, 0.5f, 0.6761296f, 0.8405172f, 0.875f, 1.0f},
            new Color[] {
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(50.152931213378906, -3.6324477195739746),
            new Point2D.Double(25.291086196899414, -4.300265312194824),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(38.22765350341797, 13.602526664733887),
            new Point2D.Double(37.535369873046875, 6.628589630126953),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(152, 160, 169, 255), new Color(195, 208, 221, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.8782699704170227f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(31.177404403686523, 19.821514129638672),
            new Point2D.Double(40.85917663574219, 9.656853675842285),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(9.750324249267578, 32.28376007080078),
            new Point2D.Double(16.91529655456543, 39.44321823120117),
            new float[] {0.0f, 1.0E-9f, 0.0f, 0.75f, 1.0f},
            new Color[] {
              new Color(52, 101, 164, 255),
              new Color(159, 188, 225, 255),
              new Color(107, 149, 202, 255),
              new Color(61, 106, 165, 255),
              new Color(56, 110, 180, 255)
            },
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(12.0046968460083, 35.68846130371094),
            new Point2D.Double(10.650805473327637, 33.19496536254883),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.0072499513626099f,
                -0.02636530064046383f,
                0.02636530064046383f,
                1.0072499513626099f,
                1.5934100151062012f,
                0.07919099926948547f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(14.017541885375977, 36.942543029785156),
            new Point2D.Double(15.415793418884277, 38.268367767333984),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(0, 0, 0, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
