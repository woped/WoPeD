 ...
 */
public class applications_graphics
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(26.78166961669922, 42.34314727783203),
            14.407301f,
            new Point2D.Double(26.78166961669922, 42.34314727783203),
            new float[] {0.0f, 1.0f},
            ...
            new AffineTransform(
                ...
                0.0f,
                0.0f,
                0.28220900893211365f,
                2.9361279033079946E-15f,
                30.393550872802734f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(28.058631896972656, 18.867767333984375),
            new Point2D.Double(33.43698501586914, 23.742767333984375),
            new float[] {0.0f, 0.24242425f, 0.6212121f, 1.0f},
            new Color[] {
              new Color(110, 61, 9, 255),
              new Color(234, 129, 19, 255),
              new Color(92, 51, 7, 255),
              new Color(224, 124, 18, 255)
            },
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, -3.906949996948242f, -1.8028559684753418f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(19.39473533630371, 30.001331329345703),
            new Point2D.Double(23.109331130981445, 33.4388313293457),
            new float[] {0.0f, 0.33333334f, 0.6666667f, 1.0f},
            new Color[] {
              new Color(189, 189, 189, 255),
    ...
    g.transform(
        new AffineTransform(
            1.3383699655532837f, 0.0f, 0.0f, 1.0f, -20.92639923095703f, -3.409010887145996f));
    // _0_0_3
    paint =
        new RadialGradientPaint(
            new Point2D.Double(26.78166961669922, 42.34314727783203),
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(15.415101051330566, 35.35650634765625),
            7.5791564f,
            new Point2D.Double(15.415101051330566, 35.35650634765625),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(105, 105, 105, 255), new Color(0, 0, 0, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.9946550130844116f,
                3.2628759978485836E-16f,
                6.564545998802296E-13f,
                0.9693220257759094f,
                -4.583016872406006f,
                0.1659190058708191f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(13.236154556274414, 37.75224685668945),
            new Point2D.Double(7.752109050750732, 42.28214645385742),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(52.71793746948242, 2.3161637783050537),
            new Point2D.Double(67.46598815917969, 2.3161637783050537),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(114, 159, 207, 255), new Color(60, 116, 177, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.8624820113182068f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(53.168766021728516, 24.244796752929688),
            new Point2D.Double(69.69099426269531, 24.244796752929688),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(242, 242, 242, 255), new Color(195, 195, 195, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.7194399833679199f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(61.87184524536133, 29.615222930908203),
            new Point2D.Double(61.87184524536133, 41.45926284790039),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(174, 174, 174, 255), new Color(196, 196, 196, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.8886190056800842f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(49.8530387878418, 64.2596206665039),
            new Point2D.Double(62.76822280883789, 64.2596206665039),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(114, 159, 207, 255), new Color(43, 85, 130, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.7189139723777771f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(60.168766021728516, 40.11979675292969),
            new Point2D.Double(60.44099426269531, 43.86979675292969),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(242, 242, 242, 255), new Color(195, 195, 195, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(48.25, 54.75),
            new Point2D.Double(48.25, 71.25),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
