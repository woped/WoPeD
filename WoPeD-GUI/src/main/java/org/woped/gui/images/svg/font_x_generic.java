 ...
 */
public class font_x_generic implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(36.66853713989258, 36.38324737548828),
            new Point2D.Double(10.30355453491211, 7.492883205413818),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(18.561553955078125, 12.998213768005371),
            new Point2D.Double(30.93592071533203, 33.68109130859375),
            new float[] {0.0f, 1.0f},
    ...
    ((GeneralPath) shape)
        .curveTo(23.246136, 10.5006275, 22.751476, 10.921088, 22.141281, 10.921088);
    ...
    shape =
        new Rectangle2D.Double(
            4.487087726593018, 3.5124998092651367, 39.01362228393555, 41.0338134765625);
    g.setPaint(paint);
    g.setStroke(stroke);
    g.draw(shape);
