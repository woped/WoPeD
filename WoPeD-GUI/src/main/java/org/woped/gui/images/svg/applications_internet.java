 ...
 */
public class applications_internet
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.2432440519332886f, 0.0f, -10.27241039276123f));
    // _0_0_0
    paint =
    ...
    paint =
        new RadialGradientPaint(
            ...
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(0.9999889731407166f, 0.0f, 0.0f, 1.0000109672546387f, 0.0f, 0.0f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(-25.176177978515625, 30.057165145874023),
            new Point2D.Double(-22.252471923828125, 21.041553497314453),
            new float[] {0.0f, 1.0f},
    ...
    ((GeneralPath) shape)
        .curveTo(-2.8284283, 26.264816, -9.872389, 30.499107, -18.561554, 30.499107);
    ((GeneralPath) shape)
        .curveTo(-27.250721, 30.499107, -34.29468, 26.264816, -34.29468, 21.041553);
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(-25.176177978515625, 30.057165145874023),
            new Point2D.Double(-22.113542556762695, 22.661523818969727),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 14.950260162353516f, 22.930469512939453f));
    // _0_0_6_0
    paint =
        new RadialGradientPaint(
            new Point2D.Double(12.07132339477539, 12.493138313293457),
            6.7175145f,
            new Point2D.Double(12.07132339477539, 12.493138313293457),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
    ...
    g.transform(
        new AffineTransform(
            -1.2803159952163696f,
            -0.12615899741649628f,
            0.09806226193904877f,
            -0.9951800107955933f,
            -2.4051249027252197f,
            40.523868560791016f));
    // _0_0_7
    paint =
        new LinearGradientPaint(
            new Point2D.Double(-22.82256507873535, 28.33773422241211),
            new Point2D.Double(-22.113542556762695, 22.661523818969727),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(-21.658580780029297, 15.649428367614746),
            new Point2D.Double(-21.962100982666016, 21.336345672607422),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
