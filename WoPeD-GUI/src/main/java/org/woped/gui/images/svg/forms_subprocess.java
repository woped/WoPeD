 ...
 */
public class forms_subprocess implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    shape =
        new Rectangle2D.Double(
            6.883368015289307, 1011.4984741210938, 34.26283264160156, 34.26285934448242);
    g.setPaint(paint);
    g.fill(shape);
    ...
    shape =
        new Rectangle2D.Double(
            10.252973556518555, 1014.6484985351562, 27.450410842895508, 27.816490173339844);
    g.setPaint(paint);
    g.fill(shape);
    paint = new Color(0, 0, 0, 255);
