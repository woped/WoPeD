 ...
 */
public class forms_and_split implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(-1.0f, 0.0f, 0.0f, -1.0f, 48.426612854003906f, 2055.323486328125f));
    // _0_0_1
    g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
    ...
    shape =
        new Rectangle2D.Double(
            18.121706008911133, 1008.3270263671875, 24.545581817626953, 38.63694381713867);
    g.setPaint(paint);
    g.fill(shape);
    paint = new Color(0, 0, 0, 255);
