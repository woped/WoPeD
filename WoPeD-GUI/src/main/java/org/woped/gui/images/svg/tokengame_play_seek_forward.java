 ...
 */
public class tokengame_play_seek_forward
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(90.0, 155.05650329589844),
            new Point2D.Double(89.00727844238281, 142.03872680664062),
            new float[] {0.0f, 1.0f},
            new Color[] {green, new Color(70, 71, 68, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                -1.0f, 3.7784399389005527E-17f, -3.7784399389005527E-17f, -1.0f, 279.0f, 290.0f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(88.99994659423828, 149.4308319091797),
            new Point2D.Double(88.99994659423828, 140.0359344482422),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 255, 0, 255), new Color(238, 238, 236, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                -1.0f,
                -6.342579813908057E-18f,
                6.342579813908057E-18f,
                -1.0f,
                278.968994140625f,
                290.0f));
