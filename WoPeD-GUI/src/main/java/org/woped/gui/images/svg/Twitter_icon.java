 ...
 */
public class Twitter_icon implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(
            0.03979337587952614f, 0.0f, 0.0f, 0.03979337587952614f, 0.005731955998271587f, -0.0f));
    // _0
    g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
