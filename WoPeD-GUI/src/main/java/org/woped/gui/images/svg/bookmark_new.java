 ...
 */
public class bookmark_new implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new RadialGradientPaint(
            ...
            new AffineTransform(
                ...
                0.0f,
                1.044769048690796f,
                -0.10355299711227417f,
                -0.15918299555778503f));
    shape =
        new RoundRectangle2D.Double(
            6.5, 3.5, 34.875, 41.06343078613281, 2.2980971336364746, 2.298096179962158);
    g.setPaint(paint);
    g.fill(shape);
    paint =
        new RadialGradientPaint(
            ...
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.9682729840278625f, 0.0f, 0.0f, 1.0363739728927612f, 3.25f, 0.4895220100879669f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(19.452348709106445, 13.174174308776855),
            new Point2D.Double(19.685436248779297, 27.095338821411133),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(0, 0, 0, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(18.431310653686523, 19.119474411010742),
            new Point2D.Double(18.4024715423584, 4.270232677459717),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(133, 157, 188, 255), new Color(84, 114, 153, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.3195489645004272f,
    ...
    ((GeneralPath) shape)
        .curveTo(26.277287, 0.50728625, 26.581888, 1.1910177, 26.581888, 2.1095588);
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(16.8125, 1.875),
            new Point2D.Double(16.8125, 4.71875),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(19.0, 9.773824691772461),
            new Point2D.Double(19.0, 15.63559627532959),
            new float[] {0.0f, 0.5f, 1.0f},
            new Color[] {new Color(0, 0, 0, 0), new Color(0, 0, 0, 145), new Color(0, 0, 0, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.3195489645004272f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(19.97037696838379, 6.116710662841797),
            new Point2D.Double(19.97037696838379, 2.53125),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 49), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.3195489645004272f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(13.354310989379883, 1.4866424798965454),
            new Point2D.Double(14.075843811035156, 2.4017651081085205),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.1848160028457642f, 0.0f, -0.7278800010681152f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(14.584076881408691, 1.6392649412155151),
            new Point2D.Double(14.552827835083008, 2.4912447929382324),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(0, 0, 0, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.5942139625549316f, 0.0f, -0.7902489900588989f));
    shape = new GeneralPath();
