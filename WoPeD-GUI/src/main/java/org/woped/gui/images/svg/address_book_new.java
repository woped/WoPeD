 ...
 */
public class address_book_new implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new LinearGradientPaint(
            ...
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                2.262742042541504f, 0.0f, 0.0f, 0.4419420063495636f, 1.0f, -0.875f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            ...
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.9577500224113464f, 0.0f, 0.0f, 1.0279890298843384f, 1.0f, -0.5719109773635864f));
    shape = new GeneralPath();
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, -0.035827308893203735f, 0.9993579983711243f, 0.0f, 0.0f));
    // _0_0_10
    paint =
        new LinearGradientPaint(
    ...
    paint =
        new LinearGradientPaint(
            ...
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.025428056716919f, 0.0f, 0.0f, 0.957302987575531f, 0.0f, -0.8067579865455627f));
