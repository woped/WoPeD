 ...
 */
public class edit_find_replace implements
...
// _0_2_3
paint = new RadialGradientPaint(new Point2D.Double(23.5625, 40.4375), 19.5625f, new Point2D.Double(23.5625, 40.4375), new float[] {0.0f,1.0f}, new Color[] {new Color(0, 0, 0, 255),new Color(0, 0, 0, 0)}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(1.0f, 0.0f, 0.0f, 0.34824299812316895f, -2.3965179409631172E-14f, 26.355430603027344f));
shape = new GeneralPath();
...
g.transform(new AffineTransform(1.0336990356445312f, -0.276978999376297f, 0.276978999376297f, 1.0336990356445312f, 16.068279266357422f, -14.548230171203613f));
// _0_2_4
g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
