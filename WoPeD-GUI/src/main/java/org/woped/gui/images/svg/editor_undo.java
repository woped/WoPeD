 ...
 */
public class editor_undo implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(26.5, 34.25),
            new Point2D.Double(26.25, 43.57183074951172),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(237, 212, 0, 255), new Color(237, 212, 0, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(17.060806274414062, 11.39501953125),
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(15.094030380249023, 13.282720565795898),
            10.16466f,
            new Point2D.Double(15.094030380249023, 13.282720565795898),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
            ...
            new AffineTransform(
                2.49603009223938f,
                -1.1518999573058243E-16f,
                1.0617599683735527E-16f,
                2.300689935684204f,
                -25.124000549316406f,
                -17.826400756835938f));
    shape = new GeneralPath();
