 ...
 */
public class format_justify_left
  ...
  public static void paint(Graphics2D g) {
    ...
    shape = new Rectangle2D.Double(9.0, 10.0, 27.0, 2.0);
    g.setPaint(paint);
    g.fill(shape);
    ...
    // _0_0_3
    paint = new Color(153, 153, 153, 255);
    shape = new Rectangle2D.Double(9.0, 16.0, 25.0, 2.0);
    g.setPaint(paint);
    g.fill(shape);
