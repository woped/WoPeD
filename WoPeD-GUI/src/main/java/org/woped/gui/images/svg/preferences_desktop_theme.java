 ...
 */
public class preferences_desktop_theme
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(14.883313179016113, 27.847455978393555),
            new Point2D.Double(13.400960922241211, 20.06928062438965),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(214, 214, 214, 255), new Color(240, 240, 240, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 15.998330116271973f, -9.914664268493652f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(16.940231323242188, 27.853084564208984),
            new Point2D.Double(16.940231323242188, 24.13514518737793),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(176, 176, 176, 255), new Color(147, 147, 147, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 15.998330116271973f, -9.914664268493652f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(17.456695556640625, 37.66166687011719),
            new Point2D.Double(17.456695556640625, 27.231843948364258),
            new float[] {0.0f, 1.0f},
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 15.114439964294434f, -11.15211009979248f));
    // _0_0_5
    paint =
        new RadialGradientPaint(
            new Point2D.Double(18.16380500793457, 22.53187370300293),
            2.842291f,
            new Point2D.Double(18.16380500793457, 22.53187370300293),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(176, 176, 176, 255), new Color(117, 117, 117, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 0.86006098985672f, 0.0f, 3.2537600994110107f));
    shape = new GeneralPath();
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(12.910969734191895, 13.001997947692871),
            7.488951f,
            new Point2D.Double(12.910969734191895, 13.001997947692871),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(240, 240, 240, 255), new Color(201, 201, 201, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.8027249574661255f,
                2.307501924799594E-23f,
                -2.6369310276807938E-23f,
                1.5033420324325562f,
                5.634344100952148f,
                -15.57903003692627f));
    shape = new GeneralPath();
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(17.09746742248535, 19.777185440063477),
            4.5473714f,
            new Point2D.Double(17.09746742248535, 19.777185440063477),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(139, 139, 139, 255), new Color(169, 169, 169, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.2083330154418945f,
    ...
    paint =
        new LinearGradientPaint(
            ...
            new Point2D.Double(13.400960922241211, 20.06928062438965),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(80, 121, 173, 255), new Color(114, 159, 207, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 15.998330116271973f, -9.914664268493652f));
    shape = new GeneralPath();
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(18.16380500793457, 22.42910385131836),
            2.842291f,
            new Point2D.Double(18.16380500793457, 22.42910385131836),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(117, 80, 123, 255), new Color(84, 57, 88, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.8709900379180908f,
                -2.4998940770107683E-15f,
                2.150062058256454E-15f,
                1.6091660261154175f,
                -15.820500373840332f,
                -13.547989845275879f));
    shape = new GeneralPath();
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(27.848600387573242, 4.607162952423096),
            7.488951f,
            new Point2D.Double(27.848600387573242, 4.607162952423096),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(200, 213, 230, 255), new Color(66, 126, 191, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.0f, 0.0f, 0.0f, 0.8339279890060425f, 2.121324062347412f, 0.6557289958000183f));
    shape = new GeneralPath();
    ((GeneralPath) shape).moveTo(33.057243, 10.331398);
    ((GeneralPath) shape).lineTo(28.01911, 14.132097);
    ((GeneralPath) shape).curveTo(28.01911, 14.132097, 26.162954, 8.565209, 26.162954, 6.0887585);
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(30.974437713623047, 12.172572135925293),
            4.890574f,
            new Point2D.Double(30.974437713623047, 12.172572135925293),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(32, 74, 135, 255), new Color(20, 46, 85, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                2.132075071334839f,
                -4.7341581982461144E-15f,
                2.2673780272753057E-15f,
                1.0211360454559326f,
                -32.94403839111328f,
                -3.6894469261169434f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(31.643028259277344, 13.61693286895752),
            new Point2D.Double(31.643028259277344, 9.63847541809082),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 2.121324062347412f, -0.8838850259780884f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            ...
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, -2.121319055557251f, 3.005204916000366f));
    shape = new GeneralPath();
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, -3.0052080154418945f, 1.7677680253982544f));
    // _0_1_5
    paint =
        new RadialGradientPaint(
            new Point2D.Double(18.16380500793457, 22.53187370300293),
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(15.335378646850586, 28.37778663635254),
            new Point2D.Double(15.335378646850586, 34.3881950378418),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(85, 87, 83, 255), new Color(124, 127, 121, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(18.16380500793457, 22.22356414794922),
            2.842291f,
            new Point2D.Double(18.16380500793457, 22.22356414794922),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(128, 131, 125, 255), new Color(76, 77, 74, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 0.86006098985672f, 0.0f, 3.2537600994110107f));
    shape = new GeneralPath();
