 ...
 */
public class text_html implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(15.115513801574707, 63.965389251708984),
            12.289036f,
            new Point2D.Double(15.115513801574707, 63.965389251708984),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(0, 0, 0, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.6439900398254395f, 0.0f, 0.0f, 0.6082760095596313f, 0.0f, 0.0f));
    shape = new GeneralPath();
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(18.247644424438477, 15.716078758239746),
            29.99335f,
            new Point2D.Double(18.247644424438477, 15.716078758239746),
            new float[] {0.0f, 0.15517241f, 0.75f, 1.0f},
            new Color[] {
              new Color(211, 233, 255, 255),
              new Color(211, 233, 255, 255),
              new Color(64, 116, 174, 255),
              new Color(54, 72, 108, 255)
            },
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(11.82690715789795, 10.476452827453613),
            32.66485f,
            new Point2D.Double(11.82690715789795, 10.476452827453613),
            new float[] {0.0f, 1.0f},
            ...
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.179535984992981f, 0.0f, 0.0f, 0.8477910161018372f, 0.0f, 0.0f));
    shape = new GeneralPath();
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(18.633779525756836, 17.486207962036133),
            40.692665f,
            new Point2D.Double(18.93430519104004, 17.810213088989258),
            new float[] {0.0f, 0.37931034f, 1.0f},
            new Color[] {
            ...
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.036821961402893f, 0.0f, 0.0f, 0.9644860029220581f, 0.0f, 0.0f));
    shape = new GeneralPath();
    ((GeneralPath) shape).moveTo(44.0713, 20.7144);
    ((GeneralPath) shape).curveTo(44.0713, 20.9771, 44.0713, 20.7144, 44.0713, 20.7144);
    ((GeneralPath) shape).lineTo(43.5264, 21.3316);
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(15.601279258728027, 12.142301559448242),
            43.526714f,
            new Point2D.Double(15.601279258728027, 12.142301559448242),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 42)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.5871300101280212f,
