 ...
 */
public class zoom_chooser implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(17.25, 12.5625),
            new Point2D.Double(21.0, 28.4375),
            new float[] {0.0f, 1.0f},
