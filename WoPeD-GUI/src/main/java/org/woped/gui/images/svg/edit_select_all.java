 ...
 */
public class edit_select_all implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(
            0.023828109726309776f,
            0.0f,
            0.0f,
            0.014487880282104015f,
            44.94353103637695f,
            43.77878189086914f));
    // _0_0_0
    ...
    shape =
        new Rectangle2D.Double(
            5.499715328216553, 1.5274455547332764, 37.00001907348633, 43.022315979003906);
    g.setPaint(paint);
    g.setStroke(stroke);
    g.draw(shape);
