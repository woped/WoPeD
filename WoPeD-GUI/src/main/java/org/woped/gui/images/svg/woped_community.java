...
public class woped_community implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  ...
  private void paintShapeNode_0_0_0_3(Graphics2D g) {
    Rectangle2D.Double shape3 =
        new Rectangle2D.Double(
            5.561999797821045, 130.03199768066406, 180.25399780273438, 1.7289999723434448);
    g.setPaint(new Color(255, 255, 255, 241));
    g.fill(shape3);
  }

  private void paintShapeNode_0_0_0_4(Graphics2D g) {
    Rectangle2D.Double shape4 =
        new Rectangle2D.Double(
            5.9070000648498535, 131.75999450683594, 179.03199768066406, 30.066999435424805);
    g.setPaint(new Color(255, 173, 0, 241));
    g.fill(shape4);
  }
  ...
  private void paintCompositeGraphicsNode_0_0_0(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 34.29710006713867f, 118.3718032836914f));
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 34.15299987792969f, 168.81809997558594f));
  ...
  private void paintCanvasGraphicsNode_0_0(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, -5.56222677230835f, -4.742427349090576f));
  ...
  private void paintRootGraphicsNode_0(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(
            0.9987316131591797f, 0.0f, 0.0f, 0.9987316131591797f, -0.0f, 0.2922999833099311f));
