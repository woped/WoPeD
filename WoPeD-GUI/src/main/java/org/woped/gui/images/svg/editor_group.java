 ...
 */
public class editor_group implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    shape =
        new Rectangle2D.Double(
            11.54828929901123, 1014.1339721679688, 17.3599853515625, 18.077281951904297);
    g.setPaint(paint);
    g.fill(shape);
    ...
    shape =
        new Rectangle2D.Double(
            6.946263313293457, 1011.2816162109375, 34.4780158996582, 34.53501510620117);
    g.setPaint(paint);
    g.setStroke(stroke);
    g.draw(shape);
