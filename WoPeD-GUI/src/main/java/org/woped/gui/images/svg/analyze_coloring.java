 ...
 */
public class analyze_coloring implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(10.5625, 46.0625),
            8.5625f,
            new Point2D.Double(10.5625, 46.0625),
            new float[] {0.0f, 1.0f},
            ...
            new AffineTransform(1.0f, 0.0f, 0.0f, 0.532846987247467f, 0.0f, 21.518199920654297f));
    ...
    g.transform(
        new AffineTransform(0.0f, -1.0f, 5.888889789581299f, 0.0f, -94.88890075683594f, 53.0f));
    // _0_0_1_0
    paint =
        new RadialGradientPaint(
            new Point2D.Double(6.5, 23.5),
            4.5f,
            new Point2D.Double(6.5, 23.5),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(0, 0, 0, 0)},
    ...
    ((GeneralPath) shape).curveTo(2.0, 21.014719, 4.0147185, 19.0, 6.5, 19.0);
    ((GeneralPath) shape).curveTo(8.985281, 19.0, 11.0, 21.014719, 11.0, 23.5);
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(28.65760040283203, 33.9866943359375),
            18.572308f,
            new Point2D.Double(28.65760040283203, 33.9866943359375),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(231, 206, 121, 255), new Color(193, 125, 17, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                6.042990207672119f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(15.299922943115234, 9.144098281860352),
            new Point2D.Double(51.56820297241211, 83.0760726928711),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 133)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.0f, 0.0f, 0.0f, 1.0f, 1.0640300512313843f, 0.024633700028061867f));
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(28.469051361083984, 23.214420318603516),
            12.3671f,
            new Point2D.Double(28.469051361083984, 23.214420318603516),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(0, 0, 0, 0)},
            ...
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.16754400730133057f,
                0.13406799733638763f,
                -0.9393550157546997f,
                1.1739100217819214f,
                43.93769836425781f,
                -7.586750030517578f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(33.17571258544922, 18.65762710571289),
            new Point2D.Double(31.180810928344727, 17.177289962768555),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(21.424922943115234, 14.769098281860352),
            new Point2D.Double(16.63990020751953, 5.5),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 88)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.0f, 0.0f, 0.0f, 1.0f, 1.0640300512313843f, 0.024633700028061867f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(19.635454177856445, 29.59141731262207),
            new Point2D.Double(23.529132843017578, 33.4850959777832),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(238, 238, 236, 255), new Color(136, 138, 133, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.8048009872436523f,
    ...
    g.setComposite(AlphaComposite.getInstance(3, 0.13026817f * origAlpha));
    AffineTransform defaultTransform__0_0_9 = g.getTransform();
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 1.2209700345993042f, 0.4254760146141052f));
    // _0_0_9
    g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
    ...
    ((GeneralPath) shape).curveTo(25.843367, 38.089333, 26.895931, 38.770348, 27.369354, 39.167076);
    ((GeneralPath) shape).curveTo(27.744822, 39.481724, 27.180958, 41.00241, 26.50854, 40.330387);
    ((GeneralPath) shape).curveTo(25.73363, 39.555927, 25.2347, 38.478497, 24.930767, 38.450886);
    ((GeneralPath) shape).curveTo(23.183844, 38.292164, 24.528898, 40.598656, 23.123135, 40.09139);
    ((GeneralPath) shape).curveTo(22.281925, 39.787838, 23.328562, 38.51355, 22.20524, 38.122463);
    ((GeneralPath) shape).curveTo(21.312836, 37.811768, 21.401497, 38.766518, 20.88548, 38.301308);
    ((GeneralPath) shape).curveTo(18.456205, 36.1112, 19.733093, 34.20872, 20.857328, 32.722958);
    ((GeneralPath) shape).curveTo(21.98158, 31.23717, 24.202522, 31.07784, 25.849436, 32.39534);
    ((GeneralPath) shape).curveTo(27.496347, 33.712837, 27.933134, 35.998158, 26.824406, 37.4965);
    ((GeneralPath) shape).closePath();
    g.setPaint(paint);
    g.fill(shape);
    paint = new Color(0, 0, 0, 255);
    ...
    ((GeneralPath) shape).curveTo(36.369083, 34.48353, 37.870365, 34.634525, 38.26545, 35.099167);
    ((GeneralPath) shape).curveTo(39.189278, 36.18563, 40.008953, 34.756527, 39.30616, 34.139572);
    ((GeneralPath) shape).curveTo(38.496243, 33.428577, 37.41978, 33.019367, 37.3669, 32.717335);
    ((GeneralPath) shape).curveTo(37.062977, 30.981339, 39.391453, 32.134716, 38.782944, 30.769592);
    ((GeneralPath) shape).curveTo(38.41881, 29.952703, 37.28783, 31.107681, 36.815254, 30.015638);
    ((GeneralPath) shape).curveTo(36.439827, 29.14808, 37.363026, 29.156757, 36.87212, 28.67907);
    ...
    ((GeneralPath) shape).curveTo(32.217735, 34.77722, 32.501553, 36.296158, 33.238167, 36.47882);
    ((GeneralPath) shape).curveTo(34.29513, 36.740925, 33.22195, 34.48353, 35.474537, 34.48353);
    ((GeneralPath) shape).closePath();
    g.setPaint(paint);
    g.fill(shape);
    paint = new Color(0, 0, 0, 255);
    ...
    ((GeneralPath) shape).curveTo(36.139675, 23.50048, 35.96324, 24.108433, 35.54812, 24.500088);
    ((GeneralPath) shape).curveTo(35.218887, 24.810703, 33.83115, 24.195639, 34.523247, 23.647451);
    ((GeneralPath) shape).curveTo(35.32084, 23.015707, 35.496044, 22.26944, 35.54812, 22.001072);
    ((GeneralPath) shape).curveTo(35.84742, 20.458572, 32.89206, 21.208471, 33.5, 20.0);
    ((GeneralPath) shape).curveTo(33.94268, 19.120033, 35.552494, 19.957869, 35.54812, 19.502056);
    ((GeneralPath) shape).curveTo(35.54137, 18.799225, 35.128017, 17.737432, 36.008762, 17.56379);
    ...
    ((GeneralPath) shape).curveTo(40.512737, 24.15057, 39.717464, 25.66294, 38.795277, 25.480877);
    ((GeneralPath) shape).curveTo(37.748856, 25.274284, 39.238914, 23.50048, 37.02061, 23.50048);
    ((GeneralPath) shape).closePath();
    g.setPaint(paint);
    g.fill(shape);
    paint = new Color(0, 0, 0, 255);
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(18.1875, 28.625),
            new Point2D.Double(41.4375, 6.1875),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(23.537704467773438, 36.02513122558594),
            4.244812f,
            new Point2D.Double(23.537704467773438, 36.02513122558594),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(138, 226, 52, 255), new Color(115, 210, 22, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.9409279823303223f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(10.593055725097656, 38.58195495605469),
            new Point2D.Double(10.165061950683594, 43.38218688964844),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(85, 87, 83, 255), new Color(31, 35, 36, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.0f, 0.0f, 0.0f, 1.2675299644470215f, -0.9999949932098389f, -14.853599548339844f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(9.343700408935547, 38.8116569519043),
            new Point2D.Double(10.924744606018066, 46.82093048095703),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 17)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.6424149870872498f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(12.186543464660645, 38.012454986572266),
            new Point2D.Double(12.186543464660645, 39.532230377197266),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 17)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    ((GeneralPath) shape)
        .curveTo(13.324543, 39.214638, 12.815043, 39.625206, 12.1865425, 39.625206);
    ((GeneralPath) shape).curveTo(11.558043, 39.625206, 11.048543, 39.214638, 11.048543, 38.708176);
    ((GeneralPath) shape)
        .curveTo(11.048543, 38.201714, 11.558043, 37.791145, 12.1865425, 37.791145);
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(32.450172424316406, 33.60939407348633),
            5.0383153f,
            new Point2D.Double(32.450172424316406, 33.60939407348633),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(239, 41, 41, 255), new Color(204, 0, 0, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.6369420289993286f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(38.28942108154297, 5.253948211669922),
            new Point2D.Double(36.610626220703125, 7.3314619064331055),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(234, 197, 134, 255), new Color(234, 197, 134, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.8048009872436523f,
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(33.29081344604492, 36.0700569152832),
            5.0383153f,
            new Point2D.Double(33.29081344604492, 36.0700569152832),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(114, 159, 207, 255), new Color(52, 101, 164, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                -0.8570759892463684f,
