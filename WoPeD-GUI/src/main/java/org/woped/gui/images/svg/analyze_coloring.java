 ...
 */
public class analyze_coloring implements
...
g.transform(new AffineTransform(1.1094900369644165f, 0.0f, 0.0f, 0.5479450225830078f, -1.7189799547195435f, 16.635299682617188f));
// _0_0_0
paint = new RadialGradientPaint(new Point2D.Double(10.5625, 46.0625), 8.5625f, new Point2D.Double(10.5625, 46.0625), new float[] {0.0f,1.0f}, new Color[] {new Color(0, 0, 0, 255),new Color(0, 0, 0, 0)}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(1.0f, 0.0f, 0.0f, 0.532846987247467f, 0.0f, 21.518199920654297f));
...
g.transform(new AffineTransform(1.2345999479293823f, 0.0f, 0.0f, 1.1113200187683105f, -22.672000885009766f, -10.707500457763672f));
// _0_0_1
g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
AffineTransform defaultTransform__0_0_1_0 = g.getTransform();
g.transform(new AffineTransform(0.0f, -1.0f, 5.888889789581299f, 0.0f, -94.88890075683594f, 53.0f));
// _0_0_1_0
...
// _0_0_4
paint = new RadialGradientPaint(new Point2D.Double(28.469051361083984, 23.214420318603516), 12.3671f, new Point2D.Double(28.469051361083984, 23.214420318603516), new float[] {0.0f,1.0f}, new Color[] {new Color(0, 0, 0, 255),new Color(0, 0, 0, 0)}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(0.16754400730133057f, 0.13406799733638763f, -0.9393550157546997f, 1.1739100217819214f, 43.93769836425781f, -7.586750030517578f));
shape = new GeneralPath();
...
g.transform(new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 1.2209700345993042f, 0.4254760146141052f));
// _0_0_9
g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
...
g.transform(new AffineTransform(2.636199951171875f, 0.0f, 0.0f, 2.180959939956665f, -21.12619972229004f, -49.4208984375f));
// _0_0_15
