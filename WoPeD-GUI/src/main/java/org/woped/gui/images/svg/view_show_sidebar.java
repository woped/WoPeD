 ...
 */
public class view_show_sidebar implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 4.049505710601807f, 42.16498947143555f));
    // _0_0_0_2
    paint = new Color(0, 0, 0, 255);
