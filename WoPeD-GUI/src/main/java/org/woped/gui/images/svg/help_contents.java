 ...
 */
public class help_contents implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new RadialGradientPaint(
            ...
            new AffineTransform(
                1.0f, 0.0f, 0.0f, 0.5952379703521729f, 3.369690028870903E-16f, 14.875f));
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(26.544321060180664, 28.458724975585938),
            22.376116f,
            new Point2D.Double(26.544321060180664, 28.458724975585938),
            new float[] {0.0f, 1.0f},
            ...
            new AffineTransform(
                1.2383400201797485f,
                0.005954849999397993f,
                -0.006507759913802147f,
                1.3512699604034424f,
                -6.992509841918945f,
                -9.744839668273926f));
    shape = new GeneralPath();
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(-19.51563835144043, 16.855663299560547),
            8.753643f,
            new Point2D.Double(-19.51563835144043, 16.855663299560547),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(184, 184, 184, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                4.445990085601807f,
                -8.852600206199197E-16f,
                1.367220020602163E-15f,
                6.866499900817871f,
                67.25070190429688f,
                -104.66799926757812f));
    shape = new GeneralPath();
    ...
    ((GeneralPath) shape)
        .curveTo(-27.366371, 12.574563, -27.355812, 12.585121, -27.34375, 12.59375);
    ...
    ((GeneralPath) shape)
        .curveTo(-17.550438, 22.803871, -17.539879, 22.793312, -17.53125, 22.78125);
    ...
    ((GeneralPath) shape)
        .curveTo(-23.866371, 31.074562, -23.855812, 31.085121, -23.84375, 31.09375);
    ...
    ((GeneralPath) shape)
        .curveTo(-17.571129, 25.050438, -17.581688, 25.039879, -17.59375, 25.03125);
