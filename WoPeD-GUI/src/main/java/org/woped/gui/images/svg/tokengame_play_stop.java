 ...
 */
public class tokengame_play_stop
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new RadialGradientPaint(
            ...
            new Point2D.Double(172.1193389892578, 100.89449310302734),
            new float[] {0.0f, 1.0f},
            new Color[] {red, new Color(211, 215, 207, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.9391829967498779f,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(14.617093086242676, 15.36176586151123),
            new Point2D.Double(14.577069282531738, 33.35448455810547),
            new float[] {0.0f, 1.0f},
            new Color[] {red, new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 145.0f, 71.0f));
    ...
    paint =
        new LinearGradientPaint(
            ...
            new float[] {0.0f, 1.0f},
            new Color[] {red, new Color(85, 87, 83, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
