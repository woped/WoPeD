 ...
 */
public class tokengame_play_start
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, -83.00039672851562f, -71.09429931640625f));
    // _0_1_0
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(110.35346221923828, 84.47499084472656),
            12.551644f,
            new Point2D.Double(110.35346221923828, 84.47499084472656),
            new float[] {0.0f, 1.0f},
            ...
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.053243398666381836f,
                -0.8362380266189575f,
                2.019469976425171f,
                0.12856799364089966f,
                -106.91899871826172f,
                179.17100524902344f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(56.81288528442383, 112.14862823486328),
            new Point2D.Double(57.254825592041016, 114.10179901123047),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 1.62568998336792f, -26.6018009185791f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(58.55234909057617, 115.93924713134766),
            new Point2D.Double(59.17106628417969, 119.10179901123047),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(59.178348541259766, 120.81781768798828),
            new Point2D.Double(60.50599670410156, 126.43153381347656),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(58.08574295043945, 129.01956176757812),
            new Point2D.Double(61.177520751953125, 134.5398406982422),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(57.9375, 86.0),
            new Point2D.Double(57.94369125366211, 103.04012298583984),
            new float[] {0.0f, 1.0f},
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(13.375120162963867, 17.812509536743164),
            new Point2D.Double(13.500120162963867, 32.9375114440918),
            new float[] {0.0f, 1.0f},
            new Color[] {green, new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.0f, 44.999900817871094f, 71.0f));
    shape = new GeneralPath();
