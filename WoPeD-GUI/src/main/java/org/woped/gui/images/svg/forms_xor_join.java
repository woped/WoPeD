 ...
 */
public class forms_xor_join implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(-1.0f, 0.0f, 0.0f, -1.0f, 48.42661666870117f, 2055.323486328125f));
    // _0_0_1
    g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
    AffineTransform defaultTransform__0_0_1_0 = g.getTransform();
    g.transform(
        new AffineTransform(-1.0f, 0.0f, 0.0f, -1.0f, 73.1390609741211f, 2055.268798828125f));
    // _0_0_1_0
    g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
    ...
    shape =
        new Rectangle2D.Double(
            -30.304906845092773, -1046.99658203125, 24.545581817626953, 38.63694381713867);
    g.setPaint(paint);
    g.fill(shape);
    paint = new Color(0, 0, 0, 255);
