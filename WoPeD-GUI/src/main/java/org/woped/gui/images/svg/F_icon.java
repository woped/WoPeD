 ...
 */
public class F_icon implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    shape =
        new Rectangle2D.Double(
            5.666999816894531, 98.9800033569336, 116.66600036621094, 18.038999557495117);
    g.setPaint(paint);
    g.fill(shape);
