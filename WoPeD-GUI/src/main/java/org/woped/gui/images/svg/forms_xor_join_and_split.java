 ...
 */
public class forms_xor_join_and_split
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(-1.0f, 0.0f, 0.0f, -1.0f, 48.387779235839844f, 2055.35791015625f));
    // _0_0_1
    g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
    ...
    shape =
        new Rectangle2D.Double(
            5.700922012329102, 1008.3087768554688, 12.327022552490234, 38.74211502075195);
    g.setPaint(paint);
    g.fill(shape);
    ...
    shape =
        new Rectangle2D.Double(
            18.03297233581543, 1008.3076782226562, 12.327022552490234, 38.74211502075195);
    g.setPaint(paint);
    g.fill(shape);
    paint = new Color(0, 0, 0, 255);
    stroke = new BasicStroke(0.85863113f, 2, 0, 4.0f, null, 0.0f);
    ...
    g.transform(
        new AffineTransform(-1.0f, 0.0f, 0.0f, -1.0f, 73.10025787353516f, 2055.302978515625f));
    // _0_0_1_3
    g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
    ...
    shape =
        new Rectangle2D.Double(
            -42.72569274902344, -1047.0147705078125, 12.327022552490234, 38.74211502075195);
    g.setPaint(paint);
    g.fill(shape);
    paint = new Color(0, 0, 0, 255);
    stroke = new BasicStroke(0.85863113f, 2, 0, 4.0f, null, 0.0f);
