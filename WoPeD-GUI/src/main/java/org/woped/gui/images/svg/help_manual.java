 ...
 */
public class help_manual implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(1.1507899761199951f, 0.0f, 0.0f, 1.0f, -4.913690090179443f, 0.625f));
    // _0_0_0
    paint =
        new RadialGradientPaint(
            new Point2D.Double(25.125, 36.75),
            15.75f,
            new Point2D.Double(25.125, 36.75),
            new float[] {0.0f, 1.0f},
            ...
            new AffineTransform(
                1.0f, 0.0f, 0.0f, 0.5952379703521729f, -6.245009807472426E-16f, 14.875f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(10.496114730834961, 93.33804321289062),
            new Point2D.Double(10.219901084899902, 84.28707885742188),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(203, 203, 203, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                2.262739896774292f, 0.0f, 0.0f, 0.4419420063495636f, 1.0f, -0.875f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(6.587181091308594, 22.132999420166016),
            new Point2D.Double(14.511404037475586, 22.132999420166016),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(214, 227, 240, 255), new Color(149, 177, 207, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.9577500224113464f, 0.0f, 0.0f, 1.0279899835586548f, 1.0f, -0.5719109773635864f));
    shape = new GeneralPath();
    ...
    g.transform(
        new AffineTransform(1.0f, 0.0f, -0.03582730144262314f, 0.9993579983711243f, 0.0f, 0.0f));
    // _0_0_5
    paint =
        new LinearGradientPaint(
            new Point2D.Double(35.43303680419922, 4.953004837036133),
            new Point2D.Double(41.2191276550293, 4.953004837036133),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 18), new Color(255, 255, 255, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.2540000081062317f,
                0.0f,
                1.8221499816276597E-16f,
                3.759809970855713f,
                0.7886289954185486f,
                0.14856700599193573f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(73.36198425292969, 26.652196884155273),
            new Point2D.Double(-2.7582900524139404, 21.270376205444336),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(255, 255, 255, 255), new Color(255, 255, 255, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.0254299640655518f, 0.0f, 0.0f, 0.957302987575531f, 0.0f, -0.8067579865455627f));
