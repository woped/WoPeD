 ...
 */
public class file_open implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    g.transform(
        new AffineTransform(
            0.021651500836014748f,
            0.0f,
            0.0f,
            0.019038399681448936f,
            42.415401458740234f,
            36.93370056152344f));
    // _0_1_4
    ...
    paint =
        new LinearGradientPaint(
            ...
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.4627000093460083f, 0.0f, 0.06907910108566284f, 0.6836689710617065f, 0.0f, 0.0f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            ...
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.2388099431991577f, 0.0f, -7.8805999755859375f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            ...
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.0f, 0.0f, 0.0f, 1.0221199989318848f, 52.05690002441406f, -1.3230299949645996f));
    shape = new GeneralPath();
    ...
    paint =
        new LinearGradientPaint(
            ...
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.4215400218963623f, 0.0f, 0.0f, 0.7034639716148376f, 0.0f, 0.0f));
