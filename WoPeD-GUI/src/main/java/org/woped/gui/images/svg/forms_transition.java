 ...
 */
public class forms_transition implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    shape =
        new Rectangle2D.Double(
            6.442099094390869, 1010.8228759765625, 34.26285171508789, 34.26285171508789);
    g.setPaint(paint);
    g.fill(shape);
