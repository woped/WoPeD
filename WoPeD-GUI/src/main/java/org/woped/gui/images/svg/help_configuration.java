  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(14.287617683410645, 68.87297058105469),
            11.68987f,
            new Point2D.Double(14.287617683410645, 72.56800079345703),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(0, 0, 0, 83), new Color(0, 0, 0, 0)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                1.3992600440979004f,
                -2.2344499939208617E-7f,
                8.19618009018086E-8f,
                0.513264000415802f,
                4.36506986618042f,
                4.839280128479004f));
    ...
    paint =
        new LinearGradientPaint(
            new Point2D.Double(99.77729797363281, 15.423800468444824),
            new Point2D.Double(153.00050354003906, 248.631103515625),
            new float[] {0.0f, 1.0f},
            new Color[] {new Color(24, 67, 117, 255), new Color(200, 189, 220, 255)},
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(
                0.20068499445915222f,
                0.0f,
                0.0f,
                0.20068499445915222f,
                -54.33580017089844f,
    ...
    ((GeneralPath) shape)
        .curveTo(25.64437, 1.0042729, 24.769749, 0.94746965, 23.874992, 0.94746965);
    ((GeneralPath) shape)
        .curveTo(23.633165, 0.94746965, 23.384287, 0.93986064, 23.144297, 0.94746965);
    ((GeneralPath) shape)
        .curveTo(23.027302, 0.9511791, 22.911526, 0.94066346, 22.794832, 0.94746965);
