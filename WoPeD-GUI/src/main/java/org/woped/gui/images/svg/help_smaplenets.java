 ...
 */
public class help_smaplenets implements org.pushingpixels.flamingo.api.common.icon.ResizableIcon {
  /**
  ...
  public static void paint(Graphics2D g) {
    ...
    paint =
        new RadialGradientPaint(
            new Point2D.Double(30.4375, 30.09375),
            10.612f,
            new Point2D.Double(30.4375, 30.09375),
            new float[] {0.0f, 0.56296295f, 1.0f},
            new Color[] {
              new Color(255, 160, 0, 255), new Color(255, 142, 0, 255), new Color(255, 108, 0, 255)
            },
            MultipleGradientPaint.CycleMethod.NO_CYCLE,
            MultipleGradientPaint.ColorSpaceType.SRGB,
            new AffineTransform(1.0f, 0.0f, 0.0f, 1.1089568138122559f, 0.0f, -3.2789199352264404f));
