 ...
 */
public class help_contents implements
...
g.transform(new AffineTransform(1.173799991607666f, 0.0f, 0.0f, 0.6000000238418579f, -5.00439977645874f, 20.325000762939453f));
// _0_0_0
paint = new RadialGradientPaint(new Point2D.Double(25.125, 36.75), 15.75f, new Point2D.Double(25.125, 36.75), new float[] {0.0f,1.0f}, new Color[] {new Color(0, 0, 0, 255),new Color(0, 0, 0, 0)}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(1.0f, 0.0f, 0.0f, 0.5952379703521729f, 3.369690028870903E-16f, 14.875f));
...
g.transform(new AffineTransform(0.9384419918060303f, 0.0f, 0.0f, 0.9386799931526184f, 1.5640699863433838f, 1.6339099407196045f));
// _0_0_1
paint = new RadialGradientPaint(new Point2D.Double(26.544321060180664, 28.458724975585938), 22.376116f, new Point2D.Double(26.544321060180664, 28.458724975585938), new float[] {0.0f,1.0f}, new Color[] {new Color(156, 188, 222, 255),new Color(32, 74, 135, 255)}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(1.2383400201797485f, 0.005954849999397993f, -0.006507759913802147f, 1.3512699604034424f, -6.992509841918945f, -9.744839668273926f));
shape = new GeneralPath();
...
g.transform(new AffineTransform(0.8551030158996582f, 0.0f, 0.0f, 0.8552129864692688f, 3.5552899837493896f, 3.6250200271606445f));
// _0_0_2
...
g.transform(new AffineTransform(0.8498950004577637f, 0.0f, 0.0f, 0.8352050185203552f, 41.729801177978516f, 8.548330307006836f));
// _0_0_3
paint = new RadialGradientPaint(new Point2D.Double(-19.51563835144043, 16.855663299560547), 8.753643f, new Point2D.Double(-19.51563835144043, 16.855663299560547), new float[] {0.0f,1.0f}, new Color[] {new Color(255, 255, 255, 255),new Color(184, 184, 184, 255)}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(4.445990085601807f, -8.852600206199197E-16f, 1.367220020602163E-15f, 6.866499900817871f, 67.25070190429688f, -104.66799926757812f));
shape = new GeneralPath();
