 ...
 */
public class tokengame_edit_random implements
...
g.transform(new AffineTransform(2.460050106048584f, 0.0f, 0.0f, 2.460050106048584f, -49.40950012207031f, -67.96369934082031f));
// _0_0_0
paint = new RadialGradientPaint(new Point2D.Double(30.203561782836914, 44.56548309326172), 6.5659914f, new Point2D.Double(30.203561782836914, 44.56548309326172), new float[] {0.0f,1.0f}, new Color[] {new Color(0, 0, 0, 255),new Color(0, 0, 0, 0)}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(1.0f, 0.0f, 0.0f, 0.3384619951248169f, -1.4354799706016636E-15f, 29.481800079345703f));
