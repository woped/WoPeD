 ...
 */
public class window_cascadewindows implements
...
shape = new RoundRectangle2D.Double(13.5, 14.500007629394531, 31.000003814697266, 29.00000762939453, 1.9907817840576172, 1.9907817840576172);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
