 ...
 */
public class forms_transition implements
...
shape = new Rectangle2D.Double(6.442099094390869, 1010.8228759765625, 34.26285171508789, 34.26285171508789);
g.setPaint(paint);
g.fill(shape);
paint = new Color(0, 0, 0, 255);
stroke = new BasicStroke(0.73714894f,0,0,4.0f,null,0.0f);
shape = new Rectangle2D.Double(6.442099094390869, 1010.8228759765625, 34.26285171508789, 34.26285171508789);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
g.transform(new AffineTransform(1.0909091234207153f, 0.0f, 0.0f, 1.3333332538604736f, -1.082792043685913f, 999.040771484375f));
// _0_0_1
