 ...
 *     <p>This class is the basic object for an element at the data model, for the easy navigation
 *     between the elements.
 *     <p>status: at work date: 12.12.2007
 */
public abstract class AbstractElement<E> {
  ...
  public boolean add_pre_object(AbstractElement<?> e) {
    if (!this.accept_pre_object(e)) return false;
    if (!e.accept_post_object(this)) return false;
    this._pre.add(e);
    return true;
  }

  /**
   * This is the method to a new AbstractElement as pre object and add this object as post object to
   * the new AbstractElement.
   *
   * @param e AbstractElement
   * @return boolean
   */
  public boolean add_pre_object_relationship(AbstractElement<?> e) {
    if (!this.accept_pre_object(e)) return false;
    if (!e.add_post_object(this)) return false;
    this._pre.add(e);
    return true;
  }

  /**
   * This method add a list of pre objects to this object and add this object to the elements of the
   * list as post object.
   *
   * @param list HashSet<AbstractElement>
  ...
  public boolean add_pre_object_list(HashSet<AbstractElement<?>> list) {
    ...
    boolean erg = true;
    while (iter.hasNext()) if (!this.add_pre_object(iter.next())) erg = false;
    return erg;
  }
   ...
   * @return returned false, if one object not added
   */
  public boolean add_pre_object_list_relationship(HashSet<AbstractElement<?>> list) {
    Iterator<AbstractElement<?>> iter = list.iterator();
    boolean erg = true;
    while (iter.hasNext()) if (!this.add_pre_object_relationship(iter.next())) erg = false;
    return erg;
  }
  ...
  public AbstractElement<?> find_pre_object_by_id(long id) {
    ...
    while (list.hasNext()) {
      if ((erg = list.next()).getID() == id) return erg;
    }
    return null;
  }
  ...
  /**
   * This method remove all links from pre object to this object and from this object to the pre
   * object.
   *
  ...
  /**
   * This is a method to remove an AbstractObject from the list of pre by this ID. objects.
   *
   * @param id long
   * @return boolean
   */
  ...
  /**
   * This is a method to remove an AbstractObject from the list of pre objects.
   *
   * @param e AbstractElement
   * @return boolean
   */
  ...
  public boolean add_post_object(AbstractElement<?> e) {
    if (!this.accept_post_object(e)) return false;
    if (!e.accept_pre_object(this)) return false;
    this._post.add(e);
    return true;
  }

  /**
   * This is the method to a new AbstractElement as post object and add this object as pre object to
   * the new AbstractElement.
   *
   * @param e AbstractElement
   * @return boolean
  ...
  public boolean add_post_object_Relationship(AbstractElement<?> e) {
    if (!this.accept_post_object(e)) return false;
    if (!e.add_pre_object(this)) return false;
    this._post.add(e);
    return true;
  }
  ...
  public boolean add_post_object_list(HashSet<AbstractElement<?>> list) {
    Iterator<AbstractElement<?>> iter = list.iterator();
    boolean erg = true;
    while (iter.hasNext()) if (!this.add_post_object(iter.next())) erg = false;
    return erg;
  }

  /**
   * This method add a list of post objects and add this object to the objects of the list as pre
   * object.
   *
   * @param list HashSet<AbstractElement>
   * @return returned false, if one object not added
   */
  public boolean add_post_object_list_relationship(HashSet<AbstractElement<?>> list) {
    Iterator<AbstractElement<?>> iter = list.iterator();
    boolean erg = true;
    while (iter.hasNext()) if (!this.add_post_object_Relationship(iter.next())) erg = false;
    return erg;
  }
  ...
  /**
   * This is a method to remove an AbstractObject from the list of post objects.
   *
   * @param e AbstractElement
   * @return boolean
   */
  ...
  /**
   * This is a method to remove an AbstractObject from the list of post by this ID. objects.
   *
   * @param id long
   * @return boolean
   */
  ...
  /**
   * This method remove all links from post object to this object and from this object to the post
   * object.
   *
   * @param pre AbstractElement
   */
   ...
   * @return boolean
   */
  public abstract boolean accept_pre_object(AbstractElement<?> e);
   ...
   * @return boolean
   */
  public abstract boolean accept_post_object(AbstractElement<?> e);
  ...
  public boolean equals(Object e) {
    if (!AbstractElement.class.isInstance(e)) return false;
    if (((AbstractElement<?>) e).getID() != this._id) return false;
   ...
   * @return boolean
   */
  public abstract boolean equals(AbstractElement<?> e);
   ...
   * @return String
   */
  public abstract TExtensibleElements getBpelCode();

  /**
   * With this method, you can find an AbstractElement. Searched by source.
   *
   * @param e AbstractElement
   * @return AbstractElement
   */
  ...
  /**
   * This method is the reccuriv algorithm to find a element at the model of the AbstractElements.
   *
   * @param begin
   * @param e
   * @param usedNotes
   * @return
   */
  private AbstractElement<?> findElement(
      AbstractElement<?> begin, AbstractElement<?> e, LinkedList<AbstractElement<?>> usedNotes) {
