...
public class XORJoinTransition extends Transition<XORJoinOperatorTransitionModel> {
  ...
  public boolean equals(AbstractElement<?> e) {
    if (!XORJoinTransition.class.isInstance(e)) return false;
    if (!this.getData().getId().equals(((XORJoinTransition) e).getData().getId())) return false;
    return true;
  }
