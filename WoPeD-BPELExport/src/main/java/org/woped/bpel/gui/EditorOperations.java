 ...
 *     <p>This is the class for BPEL Preview.
...
public class EditorOperations extends JPanel {
  ...
  public EventListenerEditorOperations getEventListener() {
    if (this._listener == null) this._listener = new EventListenerEditorOperations(this);
...
class EventListenerEditorOperations
    implements FocusListener, ChangeListener, java.awt.event.ComponentListener {
