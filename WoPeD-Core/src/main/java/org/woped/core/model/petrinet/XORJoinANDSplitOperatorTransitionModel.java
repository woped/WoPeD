...
public class XORJoinANDSplitOperatorTransitionModel extends CombiOperatorTransitionModel {
  ...
  public void registerIncomingConnection(
    ...
    TransitionModel inTransition = getCreateUnusedSimpleTrans();
  ...
  public void registerOutgoingConnection(
    ...
    TransitionModel outTransition = getCreateOUTTransition(processor);
