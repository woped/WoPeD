...
public class Toolspecific implements Serializable {
  ...
  public static enum OperatorDirection {
    IN,
    OUT
  }
   ...
   * Sets the operatorId.
   *
   * @param aalstId The operatorId to set
   */
  ...
  public OperatorDirection getOperatorOppositeDirection() {
    return OperatorDirection.values()[
        (direction.ordinal() + 1) % OperatorDirection.values().length];
  }
}
