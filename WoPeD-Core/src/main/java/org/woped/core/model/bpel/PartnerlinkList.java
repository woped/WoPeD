...
public class PartnerlinkList {
  ...
  public void addPartnerLinkWithoutPartnerRole(
    ...
    Partnerlink p = new Partnerlink(WsdlUrl);
    p.addPartnerLinkWithoutPartnerRole(name, namespace, partnerLinkType, myRole);
    this._list.add(p);
  }

  public void addPartnerLinkWithoutMyRole(
      String name, String namespace, String partnerLinktType, String partnerRole, String WsdlUrl) {
    Partnerlink p = new Partnerlink(WsdlUrl);
