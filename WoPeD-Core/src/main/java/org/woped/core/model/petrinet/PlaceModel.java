...
public class PlaceModel extends AbstractPetriNetElementModel {
   ...
   * @throws IllegalArgumentException if amount is negative or the addition would cause an overflow
   */
  public void addVirtualTokens(int amount) throws IllegalArgumentException {
    ...
    if ((Integer.MAX_VALUE - amount) < getVirtualTokenCount())
      throw new IllegalArgumentException("Amount would cause an overflow");
   ...
   * @throws IllegalArgumentException if the amount is a negative number or the place does not have
   *     enough tokens.
   */
  public void removeVirtualTokens(int amount) throws IllegalArgumentException {
    ...
    if (amount > getVirtualTokenCount())
      throw new IllegalArgumentException("Place does not have enough virtual tokens.");
