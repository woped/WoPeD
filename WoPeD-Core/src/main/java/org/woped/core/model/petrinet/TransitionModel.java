...
public class TransitionModel extends AbstractPetriNetElementModel {
   ...
   *
   * <p>Active means, that their token count is greater or equal to the weight of the arc.
   *
   ...
   *
   * <p>Because of the fact, that an arc must have a source and a target, this number is equal to
   * the number of incoming arcs.
   *
  ...
  public Point getResourcePosition() {
    ...
    else if (toolSpecific.getOperatorPosition() == OperatorPosition.NORTH
        || toolSpecific.getOperatorPosition() == OperatorPosition.SOUTH) {
