...
public class Partnerlink {
  ...
  public void setPartnerLink(
      String name, String namespace, String partnerLinkType, String partnerRole) {
  ...
  public void addPartnerLink(
      String name, String namespace, String partnerLinkType, String partnerRole, String myRole) {
    this.partnerLink.setName(name);
    this.partnerLink.setPartnerLinkType(new QName(namespace, partnerLinkType));
    this.partnerLink.setPartnerRole(partnerRole);
  ...
  public void addPartnerLinkWithoutPartnerRole(
      String name, String namespace, String partnerLinkType, String myRole) {
    this.partnerLink.setName(name);
    this.partnerLink.setPartnerLinkType(new QName(namespace, partnerLinkType));
    this.partnerLink.setMyRole(myRole);
  }
