...
public class XORSplitOperatorTransitionModel extends OperatorTransitionModel {
  ...
  public void registerIncomingConnection(
    ...
    Iterator<String> sourceIter = outerContainer.getSourceElements(getId()).keySet().iterator();
    while (sourceIter.hasNext()) {
      Iterator<AbstractPetriNetElementModel> simpleRootIter =
          getSimpleTransContainer().getRootElements().iterator();
      AbstractPetriNetElementModel tempSource = outerContainer.getElementById(sourceIter.next());
