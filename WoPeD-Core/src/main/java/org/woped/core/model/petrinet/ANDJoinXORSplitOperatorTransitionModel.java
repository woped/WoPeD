...
public class ANDJoinXORSplitOperatorTransitionModel extends CombiOperatorTransitionModel {
  ...
  public void registerIncomingConnection(
    ...
    TransitionModel inTransition = getCreateINTransition(processor);
  ...
  public void registerOutgoingConnection(
    ...
    TransitionModel outTransition = getCreateUnusedSimpleTrans();
