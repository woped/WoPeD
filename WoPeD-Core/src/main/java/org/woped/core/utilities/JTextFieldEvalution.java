 ...
 *     <p>Discription
 *     <p>This Class can be used to evaluate input on a JTextfield
 */
public class JTextFieldEvalution implements KeyListener {
  ...
  public final void keyPressed(KeyEvent e) {
    if (this._evaluateByKeyPressed == null) return;
  ...
  public final void keyReleased(KeyEvent e) {
    if (this._evaluateByKeyReleased == null) return;
  ...
  public final void keyTyped(KeyEvent e) {
    if (this._evaluateByKeyTyped == null) return;
