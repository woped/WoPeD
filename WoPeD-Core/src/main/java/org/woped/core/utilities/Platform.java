...
public class Platform {
  ...
  public static String getSystemLookAndFeel() {
    if (Platform.isMac()) return "com.apple.laf.AquaLookAndFeel";
    else if (Platform.isWindows()) return "com.sun.java.swing.plaf.windows.WindowsLookAndFeel";
    else return "javax.swing.plaf.metal.MetalLookAndFeel";
  }
}
