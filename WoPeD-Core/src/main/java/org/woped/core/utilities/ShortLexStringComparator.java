...
/**
 * This class is used to sort strings according to the short lex order.
 *
 * <p>In the short lex order strings are ordered by their length first. If the length is equal, the
 * lexicographic order is used to determine the total ordering.
 *
 * <p><code>
 * {"b", "a", "ab"} => "a" < "b" < "ab"
 * </code>
 */
public class ShortLexStringComparator implements Comparator<String> {
  /**
