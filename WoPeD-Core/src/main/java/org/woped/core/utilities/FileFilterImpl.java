...
public class FileFilterImpl extends javax.swing.filechooser.FileFilter {
  ...
  private int type;
  public static final int JPGFilter = 1;
  public static final int PNMLFilter = 2;
  public static final int TPNFilter = 3;
  public static final int SAMPLEFilter = 4;
  public static final int FOLDERFilter = 5;
  public static final int XMLFilter = 6;
  public static final int OLDPNMLFilter = 7;
  public static final int PNGFilter = 8;
  public static final int BMPFilter = 9;
  public static final int BPELFilter = 10;
  public static final int JPGBWFilter = 11;
  public static final int PNGBWFilter = 12;
  public static final int BMPBWFilter = 13;

  public static final int YAWLFilter = 14;
