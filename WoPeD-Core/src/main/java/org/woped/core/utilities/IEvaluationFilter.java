...
public interface IEvaluationFilter {
  ...
  /**
   * You must save this parameter in your implementation. This Method will be run when you are added
   * the specific evaluation filter to an object of the class JTextFieldEvalution.
   *
   * @param TextField
   */
