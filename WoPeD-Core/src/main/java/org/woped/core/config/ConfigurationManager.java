...
public class ConfigurationManager {
  ...
  private static DefaultStaticMetricsConfiguration staticMetricsConfiguration =
      new DefaultStaticMetricsConfiguration();

  public static IGeneralConfiguration getConfiguration() {
    if (configuration == null) return staticConfiguration;
    else return configuration;
  }

  public static IMetricsConfiguration getMetricsConfiguration() {
    if (metricsConfiguration == null) return staticMetricsConfiguration;
    else return metricsConfiguration;
  }
