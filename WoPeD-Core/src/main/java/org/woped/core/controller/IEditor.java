...
public interface IEditor extends IViewController {
  ...
  /**
   * Returns the last mouse position the AbstractMarqueeHandler has noticed. It is necessary
   * register the AbstractmarqueeHandler at the used Graph when instanciated.
   *
   * @return position
   */
