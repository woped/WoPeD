 ...
 *
 * <p>It offers the functionality to register/unregister event processors which are interested in
 * view events of a specific type.
 */
public class VEPController {
   ...
   *
   * <p>If the processor is not registered for this event, a warning will be logged.
   *
   ...
   *
   * @param viewEventType the type of the view event
   * @return a collection of all registered view event processors for the specified type or an empty
   *     collection if no processors are registered for the specified type
   */
