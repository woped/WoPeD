...
/**
 * Java class for ProcessVersionIdentifierType complex type.
 *
...
@XmlType(
    name = "ProcessVersionIdentifierType",
    propOrder = {"versionName"})
public class ProcessVersionIdentifierType {
   ...
   * there is not a <CODE>set</CODE> method for the versionName property.
   *
