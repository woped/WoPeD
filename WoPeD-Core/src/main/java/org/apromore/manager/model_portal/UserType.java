...
public class UserType {
   ...
   * there is not a <CODE>set</CODE> method for the searchHistories property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link SearchHistoriesType }
   */
