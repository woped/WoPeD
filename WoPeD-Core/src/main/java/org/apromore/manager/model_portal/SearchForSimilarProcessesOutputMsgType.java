...
/**
 * Java class for SearchForSimilarProcessesOutputMsgType complex type.
 *
...
@XmlType(
    name = "SearchForSimilarProcessesOutputMsgType",
    propOrder = {"result", "processSummaries"})
public class SearchForSimilarProcessesOutputMsgType {
   ...
   *
   * @return possible object is {@link ProcessSummariesType }
   */
   ...
   *
   * @param value allowed object is {@link ProcessSummariesType }
   */
