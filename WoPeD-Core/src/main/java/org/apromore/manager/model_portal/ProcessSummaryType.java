...
public class ProcessSummaryType {
   ...
   * there is not a <CODE>set</CODE> method for the versionSummaries property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link VersionSummaryType }
   */
