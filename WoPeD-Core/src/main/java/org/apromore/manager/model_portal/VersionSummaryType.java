...
/**
 * Java class for VersionSummaryType complex type.
 *
...
public class VersionSummaryType {
   ...
   * there is not a <CODE>set</CODE> method for the annotations property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AnnotationsType }
   */
