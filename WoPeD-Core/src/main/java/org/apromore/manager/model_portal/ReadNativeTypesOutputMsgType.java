...
/**
 * Java class for ReadNativeTypesOutputMsgType complex type.
 *
...
@XmlType(
    name = "ReadNativeTypesOutputMsgType",
    propOrder = {"result", "nativeTypes"})
public class ReadNativeTypesOutputMsgType {
   ...
   *
   * @return possible object is {@link NativeTypesType }
   */
   ...
   *
   * @param value allowed object is {@link NativeTypesType }
   */
