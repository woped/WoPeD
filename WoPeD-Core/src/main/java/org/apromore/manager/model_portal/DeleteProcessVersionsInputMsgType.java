...
/**
 * Java class for DeleteProcessVersionsInputMsgType complex type.
 *
...
@XmlType(
    name = "DeleteProcessVersionsInputMsgType",
    propOrder = {"processVersionIdentifier"})
public class DeleteProcessVersionsInputMsgType {
   ...
   * there is not a <CODE>set</CODE> method for the processVersionIdentifier property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ProcessVersionIdentifierType
   * }
   */
