...
/**
 * Java class for ProcessSummariesType complex type.
 *
...
@XmlType(
    name = "ProcessSummariesType",
    propOrder = {"processSummary"})
public class ProcessSummariesType {
   ...
   * there is not a <CODE>set</CODE> method for the processSummary property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ProcessSummaryType }
   */
