...
/**
 * OSXHelper class provides methods to set the OSX look and feel for specific
 * JComponents on mac platform
 * 
...
public class OSXHelper {
	...
	/**
	 * macToggleButton(JButton button) gets a JButton as input parameter and
	 * performs different style operations such as button styling for OSX,
	 * removing button icon and parsing HTML styles on the button label. It also
	 * sets the label font to the Mac OSX standard font.
	 * 
	 * @param button
	 *            The JButton element the style should applied on.
	 */
