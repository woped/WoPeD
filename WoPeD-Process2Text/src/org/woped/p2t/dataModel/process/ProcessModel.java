...
import org.woped.p2t.contentDetermination.labelAnalysis.EnglishLabelProperties;

import java.util.ArrayList;
import java.util.HashMap;

public class ProcessModel {
    private final HashMap<Integer, org.woped.p2t.dataModel.process.Arc> arcs;
    private final HashMap<Integer, org.woped.p2t.dataModel.process.Activity> activities;
    private final HashMap<Integer, org.woped.p2t.dataModel.process.Event> events;
    ...
    public void annotateModel(EnglishLabelDeriver lDeriver, EnglishLabelHelper lHelper) {
        for (org.woped.p2t.dataModel.process.Activity a : activities.values()) {
    ...
    public void addActivity(org.woped.p2t.dataModel.process.Activity activity) {
        activities.put(activity.getId(), activity);
    }

    public void addEvent(org.woped.p2t.dataModel.process.Event event) {
    ...
    public HashMap<Integer, org.woped.p2t.dataModel.process.Arc> getArcs() {
        return arcs;
    }

    public HashMap<Integer, org.woped.p2t.dataModel.process.Activity> getActivites() {
        return activities;
    }

    public HashMap<Integer, org.woped.p2t.dataModel.process.Event> getEvents() {
        return events;
    }
    ...
    public org.woped.p2t.dataModel.process.Activity getActivity(int id) {
        return activities.get(id);
    }
