...
public class FileManagerImpl implements FileManager {
     ...
     * {@inheritDoc}
     */
	public Object create(Map params, String contextPath) throws JWNLException {
		...
		String path = contextPath + "/" + ((Param)params.get(PATH)).getValue();

		System.out.println("Dict in " + path);
		try {
