...
public final class JWNL {
	 ...
	 */
	public static void initialize(InputStream propertiesStream, String configPath) throws JWNLException {
		...
		createElementFromNode(dictionaryNodeList.item(0)).install(configPath);
