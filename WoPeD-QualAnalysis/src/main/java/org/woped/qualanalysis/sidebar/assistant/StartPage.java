...
/**
 * shows the analysis startpage with the overview of soundness analysis, workflow analysis and the
 * net statistics
 *
  ...
  public StartPage(SideBar sideBar) {
    ...
    if (qualanalysisService.isWorkflowNet()) {
      ...
      if (qualanalysisService.getWronglyMarkedPlaces().size() > 0) {
        ...
        JLabel tokenMistakeLabel =
            new JLabel(Messages.getString(PREFIX_BEGINNER + "InitialMarkingMistake"));
        ...
        tokenMistakeIcon.setToolTipText(
            Messages.getString(PREFIX_BEGINNER + "InitialMarkingMistake.Info"));
    ...
    clickLabel =
        new ClickLabel(
            Messages.getString(PREFIX + "NumPlaces") + COLON,
    ...
    clickLabel =
        new ClickLabel(
            Messages.getString(PREFIX + "NumTransitions") + COLON,
    ...
    clickLabel =
        new ClickLabel(
            SUB_POINT + Messages.getString(PREFIX + "NumOperators") + COLON,
    ...
    clickLabel =
        new ClickLabel(
            SUB_POINT + Messages.getString(PREFIX + "NumSubprocesses") + COLON,
