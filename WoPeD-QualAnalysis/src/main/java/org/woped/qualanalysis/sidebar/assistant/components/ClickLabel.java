...
public class ClickLabel extends JLabel {
   ...
   */
  public ClickLabel(
      String string, Iterator<AbstractPetriNetElementModel> elementIterator, IEditor editor) {
    super(string);
  ...
  /**
   * Constructs a new label that highlights the provided arcs in the provided petri net on mouse
   * click.
   *
  ...
  private void initialize(
      IEditor editor,
      Iterator<AbstractPetriNetElementModel> elementIterator,
      Iterator<ArcModel> arcIterator) {
