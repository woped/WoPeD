...
/**
 * interface for NetStatistics-parts of qualanalysis servies. all classes which implement the
 * NetStatistics-methods of a service must implement this interface
 *
...
public interface INetStatistics {
  ...
  /**
   * @return a set with all AND-join operators and operators that function as an AND-join (e.g.
   *     and-split-join)
   */
  public Set<AbstractPetriNetElementModel> getAndJoins();

  /**
   * @return a set with all AND-split operators and operators that function as an AND-split (e.g.
   *     and-split-join)
   */
  public Set<AbstractPetriNetElementModel> getAndSplits();

  /**
   * @return a set with all XOR-join operators and operators that function as an XOR-join (e.g.
   *     xor-split-join)
   */
  public Set<AbstractPetriNetElementModel> getXorJoins();

  /**
   * @return a set with all XOR-split operators and operators that function as an XOR-split (e.g.
   *     xor-split-join)
   */
