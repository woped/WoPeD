...
public abstract class AbstractQualanalysisService implements IQualanalysisService {
  ...
  private Set<AbstractPetriNetElementModel> calcWronglyMarkedPlaces() {
    ...
    Set<AbstractPetriNetElementModel> wronglyMarkedPlaces =
        new HashSet<AbstractPetriNetElementModel>();
    Set<AbstractPetriNetElementModel> placesNotSource =
        new HashSet<AbstractPetriNetElementModel>(this.places);
