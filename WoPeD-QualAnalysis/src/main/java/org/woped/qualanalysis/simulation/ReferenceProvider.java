...
/**
 * PLEASE NOTE: THIS CLASS IS NOT FINAL, CURRENTLY AND MAY BE REMOVED, AGAIN. DO ONLY USE FOR
 * QUAL-ANALYSIS PURPOSES! The ReferenceProvider-Class is a help-class to be able to reference
 * several QualAnalysis-Components to Either Main-Window, Desktop-Pane or the
 * Default-Application-Mediator. This is needed for example, to attach QualAnalysis-Elements as
 * JInternalFrames, JDialogs etc. The constructor is just an empty method. The approach of this
 * method is, to link those three (in the application only once occurring) modules as references.
 * Each in a instance-variable. This is done through the get and set Methods of this Class
 *
...
public class ReferenceProvider {
  ...
  /**
   * Creates new ReferencePRovider Object to get or set the Reference-Instance-Variables Handle with
   * care!
   */
