...
public class TokenGameBarListener
    implements ActionListener, ChangeListener, ListSelectionListener, CaretListener {

  // Constants
  // ======================
  // Playback configuration
  public static final int CHOOSE_STEPWISE = 1;
  public static final int CHOOSE_PLAYBACK = 2;

  // Navigation Button
  public static final int CLICK_BACKWARD = 5;
  public static final int CLICK_STOP = 6;
  public static final int CLICK_PLAY = 7;
  public static final int CLICK_PAUSE = 8;
  public static final int CLICK_FORWARD = 9;

  // Process stepping
  public static final int CLICK_STEP_UP = 11;
  public static final int CLICK_STEP_DOWN = 12;

  // Use analysis functions from simulatorBar
  public static final int ANALYSIS = 39;
  public static final int QUANTCAP = 40;
  public static final int QUANTSIM = 41;
  public static final int REACHABILITY_GRAPH = 42;

  // AutoChoice List
  public static final int CHOOSE_REMOTECONTROLL = 43;
