...
public class NetAnalysisDialog extends JDialog implements WindowListener {
  ...
  public NetAnalysisDialog(
      JFrame owner, File temporaryFile, IEditor editor, AbstractApplicationMediator mediator) {
    ...
    getContentPane().add(expertPage = new ExpertPage(m_currentEditor, mediator, m_qualanService));
