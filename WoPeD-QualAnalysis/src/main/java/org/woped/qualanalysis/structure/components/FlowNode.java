 ...
 *     This class represents an element in a LowLevelNet. It is derived from a petri net node. There
 *     are always 2 flow nodes for 1 petri net node (first and second). FlowArcs are used to connect
 *     FlowNodes among themselves. <br>
 */
