...
public class Woflan {
  ...
  public int InfoSncNName =
      112; // Yes Name of node [theIndex] not strongly connected to SCTransition
  ...
  public int InfoNFCCNName =
      153; // No  Name of node [theSubIndex] in non-free-choice-cluster [theIndex]
  ...
  public int InfoPTHN1Name =
      204; // Yes Name of node [theSubIndex] on some path for PT-handle [theIndex]
  public int InfoPTHN2Name =
      205; // Yes Name of node [theSubIndex] on alternative path for PT-handle [theIndex]
  ...
  public int InfoTPHN1Name =
      304; // Yes Name of node [theSubIndex] on some path for TP-handle [theIndex]
  public int InfoTPHN2Name =
      305; // Yes Name of node [theSubIndex] on alternative path for TP-handle [theIndex]
  ...
  public int InfoSPInPName =
      604; // No  Name of place [theSubIndex] in semi-positive P-Invariant [theIndex]
  public int InfoSPInPWeight =
      605; // No  Weight of place [theSubIndex] in semi-positive P-Invariant [theIndex]
  public int InfoNotSPInPName =
      606; // No  Name of place [theIndex] not covered by semi-positive P-Invariants
  ...
  public int InfoTInvPWeight =
      705; // Yes Weight of transition [theSubIndex] in T-Invariant [theIndex]
  public int InfoNotTInvPName =
      706; // Yes Name of transition [theIndex] not covered by T-Invariants
  ...
  public int InfoNofPotSTIn =
      802; // Yes Number of transitions not covered by semi-positive T-Invariants
  public int InfoSTInNofP =
      803; // Yes Number of transitions in semi-positive T-Invariant [theIndex]
  public int InfoSTInPName =
      804; // Yes Name of transition [theSubIndex] in semi-positive T-Invariant [theIndex]
  public int InfoSTInPWeight =
      805; // Yes Weight of transition [theSubIndex] in semi-positive T-Invariant [theIndex]
  public int InfoNotSTInPName =
      806; // Yes Name of transition [theIndex] not covered by semi-positive T-Invariants
  ...
  public int InfoUnbSTName =
      905; // Yes Name of transition [theSubIndex] in unbounded sequence [theIndex]
  ...
  public int InfoNLiveSTName =
      1007; // Yes Name of transition [theSubIndex] in non-live sequence [theIndex]

  // Inheritance
  public int SetInh =
      1100; // No  Set inheritance info using net theIndex as base net and this net as potential
  // subnet
  ...
  // Note: InfoInhLC uses backtracking algorithm, but this depends on the existence of semi-positive
  // T-Invariants for the short-circuited net.
  // Thus: Invoking InfoInhLC will result in an effective backtracking algorithm iff SetSTIn has
  // been invoked beforehand.

  // Murata reduction rules
  public int SetMurata =
      1200; // Bth Apply the well-known Murata reduction rules to this net (and its short-circuited
  // net)
