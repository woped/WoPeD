 ...
 *
 * <p>The advantage of the extraction of this toString logic is that you can have different
 * representations (e.g. MultiSet, TokenVector) without changing the marking class itself.
 */
