...
/**
 * Defines the methods for the automatic formatting of a coverability graph node which is applied if
 * no other format is set. Individual setting set to the node attributes always overrides this
 * settings.
 */
