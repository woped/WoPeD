 ...
 *
 * <p>Different views are e.g. the result view or the assistant view.
 */
public class CoverabilityGraphVC extends JPanel {
   ...
   *
   * <p>All views have to be registered before they can be activated.
   *
  ...
  /**
   * Gets a value representing if the coverability graph is out of sync with the underlying petri
   * net.
   *
