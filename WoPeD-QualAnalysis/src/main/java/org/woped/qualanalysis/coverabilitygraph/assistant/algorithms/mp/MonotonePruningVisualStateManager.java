...
class MonotonePruningVisualStateManager {
   ...
   */
  MonotonePruningVisualStateManager(
      MonotonePruningEventTrigger eventTrigger, NodeFormatter formatter) {
  ...
  private static class NodeStyle {
    ...
    private static AttributeMap createActiveStyle() {
      ...
      GraphConstants.setRemoveAttributes(
          map, new Object[] {GraphConstants.DASHPATTERN, GraphConstants.BACKGROUND});
      GraphConstants.setLineWidth(map, 2);
      GraphConstants.setForeground(map, Color.black);
