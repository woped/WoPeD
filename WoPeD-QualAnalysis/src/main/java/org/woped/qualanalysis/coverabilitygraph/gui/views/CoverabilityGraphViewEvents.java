...
public class CoverabilityGraphViewEvents {
  ...
  /**
   * This event tells the coverability graph to remove all highlighting from the graph and the
   * related editor
   */
  ...
  /**
   * This event tells the coverability graph to set the zoom factor of the related view to the value
   * provided as data object.
   *
   * <p>The data object has to be of typ {@link Double}
   */
  ...
  /**
   * This event tells the coverability graph to change its layout to the layout with the provided
   * key
   *
   * <p>The data object has to of type {@link Integer} and represents the key of the layout
   */
