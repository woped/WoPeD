...
/**
 * This class is in charge of displaying the internationalized button text and tooltip for sidebar
 * actions. Sidebar actions are actions (mostly buttons) that can be triggered from the sidebar.
 * Custom sidebar actions should extend this class.
 */
public abstract class SidebarAction extends AbstractAction {

  /**
   * Constructs a new sidebar action that uses the provided properties prefix to load
   * internationalized action and tooltip messages.
   *
