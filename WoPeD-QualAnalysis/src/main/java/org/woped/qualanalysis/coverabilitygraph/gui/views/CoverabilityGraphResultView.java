...
public class CoverabilityGraphResultView extends CoverabilityGraphView {
  ...
  public static final String VIEW_NAME = "ResultView";
  ...
  private class EdgeHighlighter extends CoverabilityGraphMouseAdapter {
    ...
    private void setEdgeAttributes(
        Collection<CoverabilityGraphEdge> edges, AttributeMap highlightAttributes) {
      ...
      for (CoverabilityGraphEdge edge : edges) {
        ...
        GraphConstants.setForeground(
            undoAttributes, GraphConstants.getForeground(edge.getAttributes()));
        GraphConstants.setLineColor(
            undoAttributes, GraphConstants.getLineColor(edge.getAttributes()));
        GraphConstants.setLineWidth(
            undoAttributes, GraphConstants.getLineWidth(edge.getAttributes()));
