...
/**
 * An abstract class for receiving mouse events from a coverability graph. The methods in this class
 * are empty. This class exists for convenience for creating listeners objects.
 *
 * <p>Extend this class if you are only interested in a subset of events provided by listener
 * interface.
 */
