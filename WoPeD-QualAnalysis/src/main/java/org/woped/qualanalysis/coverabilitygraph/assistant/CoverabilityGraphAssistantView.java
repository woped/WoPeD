...
/**
 * This class should be used to display a coverability graph assistant in a {@link
 * CoverabilityGraphVC} to provide a consistent look & feel.
 */
public class CoverabilityGraphAssistantView extends CoverabilityGraphView {
  ...
  /**
   * Constructs a new coverability graph assistant view for the petri net designed in the provided
   * editor.
   *
