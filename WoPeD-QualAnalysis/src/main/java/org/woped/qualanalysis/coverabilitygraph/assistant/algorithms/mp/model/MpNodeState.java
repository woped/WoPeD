...
public enum MpNodeState {
  ...
  /**
   * The node has been processed and its marking is not covered by the marking of any other
   * processed node.
   */
  ACTIVE,

  /**
   * The node has been processed and its marking is covered by the marking of another processed
   * node.
   */
  INACTIVE
}
