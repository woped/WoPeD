 ...
 *
 * <p>The advantage of this class is that the logic of the textual representation is extracted from
 * the node itself. This makes it easy to use different textual representations without changing the
 * node.
 */
