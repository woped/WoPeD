...
/**
 * This class adds highlighting to the petri net if an marking is selected in the coverability
 * graph. The tokens are set according to the selected marking.
 */
public class PetriNetHighlighter {
  ...
  /**
   * Gets the mouse listener that automatically highlight the petri net based on user interactions
