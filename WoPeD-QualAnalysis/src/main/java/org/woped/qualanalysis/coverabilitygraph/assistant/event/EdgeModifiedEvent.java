...
public class EdgeModifiedEvent extends EdgeEvent {
  ...
  /**
   * Constructs an new modified edge event with the specified source, the related node and the
   * changed attributes.
   *
   ...
   */
  public EdgeModifiedEvent(
      Object source, CoverabilityGraphEdge edge, AttributeMap modifiedAttributes) {
    super(source, edge);
