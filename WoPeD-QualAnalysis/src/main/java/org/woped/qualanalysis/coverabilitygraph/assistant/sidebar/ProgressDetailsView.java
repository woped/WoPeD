...
/**
 * This class is responsible for displaying process steps in the info panel of the coverability
 * graph assistant view
 */
public class ProgressDetailsView extends JPanel {
   ...
   *
   * <p>Valid html tags can be used to format the output. The enclosing html tag is added
   * automatically.
   *
   ...
   *
   * <p>The details section has a dynamic table layout. The rows and columns are added as needed.
   *
   ...
   *
   * <p>Actions have a different design than details and should be used to describe the resulting
   * action to the currently processed node after the completion of the process step.
   *
   * <p>The actions section has a vertical stack layout. (Elements are stacked based on their
   * insertion)
   *
  ...
  public void addAction(String action) {
    JLabel actionLabel =
        new JLabel(String.format("<html><strong>\u21D2&nbsp;%s</strong></html>", action));
