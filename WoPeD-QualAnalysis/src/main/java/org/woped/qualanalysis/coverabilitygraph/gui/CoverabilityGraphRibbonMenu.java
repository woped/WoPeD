...
public class CoverabilityGraphRibbonMenu {
  ...
  private static ResizableIcon getResizableIcon(String resource) {
    ...
    if (icon == null) {
      LoggerManager.warn(
          Constants.QUALANALYSIS_LOGGER, "Unable do load icon from resources: " + resource);
      return null;
    }

    return ImageWrapperResizableIcon.getIcon(
        icon.getImage(), new Dimension(ICON_WIDTH, ICON_HEIGHT));
  }
  ...
  public CoverabilityGraphRibbonMenu(AbstractApplicationMediator mediator) {
    ...
    CoverabilityGraphFrameController graphFrameController =
        CoverabilityGraphFrameController.getInstance(mediator.getUi());
   ...
   *
   * <p>This group should be activated, when the contextual group gets visible
   *
  ...
  private RibbonTask createCoverabilityGraphTask() {
    return new RibbonTask(
        Messages.getString("CoverabilityGraph.Ribbon.Task.Title"),
        createMainBand(),
        createViewBand(),
        createAssistantBand());
  }
  ...
  private JRibbonBand createMainBand() {
    JRibbonBand mainBand =
        new JRibbonBand(Messages.getString("CoverabilityGraph.Ribbon.MainBand.Title"), null);
  ...
  private JRibbonBand createAssistantBand() {
    ...
    assistantBand =
        new JRibbonBand(Messages.getString("CoverabilityGraph.Ribbon.AssistantBand.Title"), null);
  ...
  private JCommandButton getCloseButton() {
    JCommandButton closeButton =
        createButton("CoverabilityGraph.Ribbon.CloseButton", new file_close());
  ...
  private JCommandButton getSettingsButton() {
    JCommandButton showSettingsButton =
        createButton("CoverabilityGraph.Ribbon.ShowSettingsButton", new help_configuration());
  ...
  private JCommandButton getExportButton() {
    JCommandButton exportButton =
        createButton("CoverabilityGraph.Ribbon.ExportButton", new file_exportas());
  ...
  private JCommandButton getLayoutButton() {
    ...
    JCommandButton layoutButton =
        createButton("CoverabilityGraph.Ribbon.LayoutButton", new layout());

    layoutButton.setCommandButtonKind(JCommandButton.CommandButtonKind.POPUP_ONLY);
    layoutButton.setPopupCallback(
        new PopupPanelCallback() {
          @Override
          public JPopupPanel getPopupPanel(JCommandButton commandButton) {
            String resourceKey = "CoverabilityGraph.Ribbon.LayoutOption.Hierarchic";
            JCommandMenuButton optionHierarchic =
                new JCommandMenuButton(
                    Messages.getString(resourceKey), getResizableIcon(resourceKey));
            addClickHandler(
                optionHierarchic,
                CoverabilityGraphViewEvents.CHANGE_LAYOUT,
                new HierarchicLayout());

            resourceKey = "CoverabilityGraph.Ribbon.LayoutOption.Circle";
            JCommandMenuButton optionCircular =
                new JCommandMenuButton(
                    Messages.getString(resourceKey), getResizableIcon(resourceKey));
            addClickHandler(
                optionCircular, CoverabilityGraphViewEvents.CHANGE_LAYOUT, new CircularLayout());

            resourceKey = "CoverabilityGraph.Ribbon.LayoutOption.Tree";
            JCommandMenuButton optionTree =
                new JCommandMenuButton(
                    Messages.getString(resourceKey), getResizableIcon(resourceKey));
            addClickHandler(
                optionTree, CoverabilityGraphViewEvents.CHANGE_LAYOUT, new TreeLayout());
  ...
  private JCommandButton getZoomInButton() {
    JCommandButton zoomInButton =
        createButton("CoverabilityGraph.Ribbon.ZoomInButton", new zoom_in());
  ...
  private JCommandButton getZoomOutButton() {
    ...
    JCommandButton zoomOutButton =
        createButton("CoverabilityGraph.Ribbon.ZoomOutButton", new zoom_out());
  ...
  private JCommandButton getZoomChooser() {
    JCommandButton zoomChooserButton =
        createButton("CoverabilityGraph.Ribbon.ZoomChooserButton", new zoom_chooser());

    zoomChooserButton.setCommandButtonKind(JCommandButton.CommandButtonKind.POPUP_ONLY);
    zoomChooserButton.setPopupCallback(
        new PopupPanelCallback() {
          @Override
          public JPopupPanel getPopupPanel(JCommandButton commandButton) {
    ...
    button.addActionListener(
        new ActionListener() {
          ...
          public void actionPerformed(ActionEvent e) {
            ...
            mediator.fireViewEvent(
                new ViewEvent(
                    CoverabilityGraphRibbonMenu.this,
  ...
  private void showContextGroup() {
    mediator.fireViewEvent(
        new ViewEvent(
            this,
            AbstractViewEvent.VIEWEVENTTYPE_COVERABILITY_GRAPH,
            CoverabilityGraphViewEvents.FRAME_ACTIVATED));
  }
  ...
  private void hideContextGroup() {
    mediator.fireViewEvent(
        new ViewEvent(
            this,
            AbstractViewEvent.VIEWEVENTTYPE_COVERABILITY_GRAPH,
            CoverabilityGraphViewEvents.FRAME_DEACTIVATED));
  }
  ...
  private class GraphListener implements CoverabilityGraphEventListener {
    ...
    /**
     * Invoked, when the synchronisation between the graph and the underlying petri net has been
     * renewed.
     */
    @Override
