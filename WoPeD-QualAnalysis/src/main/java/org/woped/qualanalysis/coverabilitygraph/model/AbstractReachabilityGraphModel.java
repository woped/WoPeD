...
/**
 * This class provides common functionality for graph models as applying layout or graph
 * initialization.
 */
public abstract class AbstractReachabilityGraphModel implements CoverabilityGraphModel {
   ...
   *
   * <p>The root node contains the initial marking of the petri net.
   *
   * @param graphNodes the nodes of the graph
   * @return the initial node of the graph or null, if no initial marking exists
   */
  public static CoverabilityGraphNode lookupInitialMarking(
      Collection<CoverabilityGraphNode> graphNodes) {
   ...
   */
  protected AbstractReachabilityGraphModel(
