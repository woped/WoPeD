 ...
 *
 * <p>It uses the text provided by the marking formatter without any decoration.
 */
public class DefaultNodeTextFormatter implements NodeTextFormatter {
  ...
  /**
   * Constructs a new node text formatter with an {@link MultiSetMarkingFormatter} as marking
   * formatter.
   */
   ...
   *
   * @param markingFormatter the marking formatter to create the textual representation of the
   *     marking
   */
