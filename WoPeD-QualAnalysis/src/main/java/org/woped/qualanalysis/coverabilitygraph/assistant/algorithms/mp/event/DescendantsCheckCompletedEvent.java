...
/**
 * Event that indicates, that the descendants check in the processing of the current node has been
 * completed.
 */
public class DescendantsCheckCompletedEvent extends EventObject {
   ...
   * @param activeTransitions the enabled transition in the resulting marking of the current
   *     processed node
   */
  public DescendantsCheckCompletedEvent(
      Object source, Collection<TransitionNode> activeTransitions) {
    super(source);
