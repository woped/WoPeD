 ...
 *
 * <p>* @author Patrick Spies, Patrick Kirchgaessner, Joern Liebau, Enrico Moeller, Sebastian Fuss
 */
public interface IStronglyConnectedComponentTestGen<K extends INode<K>> {
  ...
  /**
   * @return all strongly connected components. the first set contains the different strongly
   *     connected components. the second set includes all nodes, which are part of the strongly
   *     connected component.
   */
