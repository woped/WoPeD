...
public class JGraphModel2LowLevelPetriNet {
  ...
  private void test() {
    ...
    time = System.currentTimeMillis();
    System.out.println(
        AlgorithmFactory.createUnboundedPlacesTest(mNetWithTStar).getUnboundedPlaces());
    System.out.println("time: " + (System.currentTimeMillis() - time) + "ms");
    System.out.println();
    ...
    time = System.currentTimeMillis();
    System.out.println(
        AlgorithmFactory.createDeadTransitionTest(mNetWithoutTStar).getDeadTransitions());
    System.out.println("time: " + (System.currentTimeMillis() - time) + "ms");
    System.out.println();
    ...
    time = System.currentTimeMillis();
    System.out.println(
        AlgorithmFactory.createNonLiveTranstionTest(mNetWithTStar).getNonLiveTransitions());
    System.out.println("time: " + (System.currentTimeMillis() - time) + "ms");
    System.out.println();
