...
public class CircularLayout implements IReachabilityLayout {
    ...
    public ReachabilityJGraph layoutGraph(ReachabilityJGraph graph, Dimension dimension) {
        ...
        LinkedList<Point> coordinates = CircleCoordinates.getCircleCoordinates(dimension.width, dimension.height, AbstractReachabilityGraphModel.verticeCount(graph));
        // Build Graph
    ...
    private void setPlacesOnCircle(LinkedList<Point> coordinates, LinkedList<ReachabilityPlaceModel> places) {
