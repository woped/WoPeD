...
public class ExpertFactory extends DefaultMutableTreeNode {
    ...
    protected static DefaultMutableTreeNode getPlacesInfo(IQualanalysisService qualanService) {
        return new NodeGroupNetInfo(Messages.getString(prefix + "NumPlaces") + ": " + qualanService.getNumPlaces(),
                qualanService.getPlacesIterator());
    }
    ...
    /**
     * Show the places that are not covered by any S-Component of the net. If such a place exists the net is not s-coverable
     * 
    ...
    protected static DefaultMutableTreeNode getStronglyConnectedComponentsInfo(IQualanalysisService qualanService) {
        return new NodeGroupListNetInfo(Messages.getString(prefix + "stronglyConnectedComponents") + ": "
                + qualanService.getStronglyConnectedComponentNum(), qualanService
                .getStronglyConnectedComponentIterator()) {
            @Override
            public String getGroupDisplayString(int nIndex, Collection group) {
    ...
    /**
     * 
     * @return node containing information mistakes in the initial marking (source place should contain one token, all other places should contain no token)
     */
