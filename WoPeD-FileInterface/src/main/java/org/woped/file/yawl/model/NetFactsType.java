...
@XmlType(
    name = "NetFactsType",
    propOrder = {"localVariable", "processControlElements", "externalDataGateway"})
public class NetFactsType extends DecompositionFactsType {
   ...
   * there is not a <CODE>set</CODE> method for the localVariable property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link VariableFactsType }
   */
   ...
   *
   * @param value allowed object is {@link NetFactsType.ProcessControlElements }
   */
  ...
  @XmlType(
      name = "",
      propOrder = {"inputCondition", "taskOrCondition", "outputCondition"})
  public static class ProcessControlElements {
     ...
     *
     * @param value allowed object is {@link ExternalConditionFactsType }
     */
     ...
     * why there is not a <CODE>set</CODE> method for the taskOrCondition property.
     *
     * <p>For example, to add a new item, do as follows:
     *
     * <pre>
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link ExternalTaskFactsType }
     ...
     *
     * @param value allowed object is {@link OutputConditionFactsType }
     */
