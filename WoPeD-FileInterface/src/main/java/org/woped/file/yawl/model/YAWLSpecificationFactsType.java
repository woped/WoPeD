 ...
 *         &lt;any processContents='lax' namespace='http://www.w3.org/2001/XMLSchema' minOccurs="0"/>
...
@XmlType(
    name = "YAWLSpecificationFactsType",
    propOrder = {"name", "documentation", "metaData", "any", "decomposition", "importedNet"})
public class YAWLSpecificationFactsType extends SpecificationType {
   ...
   * there is not a <CODE>set</CODE> method for the decomposition property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link DecompositionType }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the importedNet property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
