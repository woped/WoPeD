...
/**
 * Java class for OutputConditionFactsType complex type.
 *
...
@XmlType(
    name = "OutputConditionFactsType",
    propOrder = {"name", "documentation"})
public class OutputConditionFactsType extends ExternalNetElementType {
