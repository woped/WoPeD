...
public class WfNet {
  ...
  /**
   * A hash map with an external search criterion. In case there is no external criterion the id of
   * the node will be used as key.
   */
  ...
  /**
   * Create a new Transition object, using the supplied string as 'internal' as well as 'external'
   * id.
   *
   * @param id
  ...
  /**
   * Create a new Place object with a newly generated id value, using it for the 'internal' id of
   * the Place as well as the 'external' (= second search criterion)
   *
  ...
  /**
   * Create a new Place object, using the supplied string as 'internal' as well as 'external' id.
   *
   * @param id
   * @return the generated Place object
   */
  ...
  /**
   * Create a new Place object, generate a new 'internal' id and use the supplied String as the
   * 'external' id
   *
   * @param external_id
   * @return the generated Place object
  ...
  /**
   * Create a new Transition object with a newly generated id value, using it for the 'internal' id
   * of the Transition as well as the 'external' (= second search criterion)
   *
   * @return the generated Transition object
   */
  ...
  /**
   * Create a new Transition object and generate a new id as 'internal' as well as 'external' id.
   *
   * @return the generated Transition object
   */
  ...
  /**
   * Create a new Transition object, using the supplied string as 'internal' as well as 'external'
   * id. Add the new Transition to the HashMaps
   *
   * @param id
   * @return the generated Transition object
   */
  ...
  /**
   * Create a new Transition object, generate a new 'internal' id and use the supplied String as the
   * 'external' id
   *
   * @param external_id
   * @return the generated Transition object
  ...
  private void addNode(WfNetNode node, String idExt) {
    if (this.nodes.containsKey(node.getId()) || this.nodesExt.containsKey(idExt)) {
  ...
  /**
   * Replace the existing id of the node with the new id. If the node is already contained in the
   * this.nodes HashMap it will be deleted and re-inserted into it.
   *
   * @param node
   * @param newId
   */
  ...
  /**
   * Helper method that returns an id value (using the supplied prefix) that does not yet exist in
   * the this.nodes HashMap
   *
   * @param prefix
  ...
  /**
   * Ensure, that the supplied id value isn't already used by any existing place or transition and
   * is also not the beginning of any existing id value.
   *
  ...
  private int arcId = 0;
  /**
   * Create a new id value for an arc. Ensure that the id isn't used by any transitions or places.
   *
   * @return
   */
