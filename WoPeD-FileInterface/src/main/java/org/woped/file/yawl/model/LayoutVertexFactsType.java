...
@XmlType(
    name = "LayoutVertexFactsType",
    propOrder = {"startpoint", "iconpath", "attributes", "notes"})
public class LayoutVertexFactsType {
   ...
   *
   * @param value allowed object is {@link LayoutPointType }
   */
   ...
   *
   * @param value allowed object is {@link LayoutAttributesFactsType }
   */
