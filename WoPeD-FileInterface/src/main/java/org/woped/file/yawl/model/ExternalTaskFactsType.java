...
public class ExternalTaskFactsType extends ExternalNetElementFactsType {
   ...
   *
   * @param value allowed object is {@link ControlTypeType }
   */
   ...
   *
   * @param value allowed object is {@link ConfigurationType }
   */
   ...
   * there is not a <CODE>set</CODE> method for the removesTokens property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link ExternalNetElementType }
   */
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the removesTokensFromFlow property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link RemovesTokensFromFlowType }
   */
   ...
   *
   * @param value allowed object is {@link VarMappingSetType }
   */
   ...
   *
   * @param value allowed object is {@link TimerType }
   */
   ...
   *
   * @param value allowed object is {@link ResourcingFactsType }
   */
   ...
   *
   * @param value allowed object is {@link DecompositionType }
   */
