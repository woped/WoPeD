...
@XmlType(
    name = "AddressType",
    propOrder = {"numAndStreet", "gpoBox", "suburbOrTown", "postOrZipCode", "state", "country"})
public class AddressType {
   ...
   *
   * @param value allowed object is {@link AddressType.NumAndStreet }
   */
