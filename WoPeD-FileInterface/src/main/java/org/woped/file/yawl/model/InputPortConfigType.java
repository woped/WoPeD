...
@XmlType(
    name = "InputPortConfigType",
    propOrder = {"flowSource"})
public class InputPortConfigType {
   ...
   * there is not a <CODE>set</CODE> method for the flowSource property.
   *
   ...
   *
   * @param value allowed object is {@link InputPortValueType }
   */
