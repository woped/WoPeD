...
@XmlType(
    name = "SpecificationSetFactsType",
    propOrder = {"specification", "layout"})
public class SpecificationSetFactsType extends SpecificationSetType {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link YAWLSpecificationFactsType }
   */
   ...
   *
   * @param value allowed object is {@link LayoutFactsType }
   */
