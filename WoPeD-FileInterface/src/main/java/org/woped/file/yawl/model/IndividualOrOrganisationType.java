...
@XmlType(
    name = "IndividualOrOrganisationType",
    propOrder = {"name", "addressOrEmailAddress", "description"})
public class IndividualOrOrganisationType {
  ...
  @XmlElements({
    ...
    @XmlElement(name = "emailAddress", type = String.class)
  })
   ...
   * there is not a <CODE>set</CODE> method for the addressOrEmailAddress property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link AddressType } {@link String
   * }
   */
