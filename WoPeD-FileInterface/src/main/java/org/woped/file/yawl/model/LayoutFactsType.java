...
@XmlType(
    name = "LayoutFactsType",
    propOrder = {"locale", "specification"})
public class LayoutFactsType {
   ...
   *
   * @param value allowed object is {@link LayoutLocaleType }
   */
   ...
   * there is not a <CODE>set</CODE> method for the specification property.
   *
  ...
  @XmlType(
      name = "",
      propOrder = {"size", "net", "labelFontSize"})
  public static class Specification {
    ...
    @XmlAttribute(name = "defaultBgColor")
     ...
     *
     * @param value allowed object is {@link LayoutDimensionType }
     */
     ...
     * </pre>
     *
     * <p>Objects of the following type(s) are allowed in the list {@link LayoutNetFactsType }
     */
