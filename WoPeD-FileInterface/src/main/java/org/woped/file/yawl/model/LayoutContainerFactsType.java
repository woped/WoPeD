...
@XmlType(
    name = "LayoutContainerFactsType",
    propOrder = {"vertexOrLabelOrDecorator"})
public class LayoutContainerFactsType {
   ...
   * there is not a <CODE>set</CODE> method for the vertexOrLabelOrDecorator property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link LayoutVertexFactsType }
   * {@link LayoutLabelFactsType } {@link LayoutDecoratorFactsType }
   */
