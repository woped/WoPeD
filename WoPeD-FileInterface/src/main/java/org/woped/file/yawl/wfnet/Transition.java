...
public class Transition extends WfNetNode {
  ...
  public boolean hasJoinOrSplit() {
    return (this.joinType != JoinSplitType.None) || (this.splitType != JoinSplitType.None);
  }
  ...
  public void copyAttributesTo(Transition node, boolean copy_arcs) {
  ...
  public static String getWoPedOperatorCode(
      Transition.JoinSplitType join, Transition.JoinSplitType split) {
