...
@XmlType(
    name = "TimerType",
    propOrder = {"netparam", "trigger", "expiry", "duration", "durationparams"})
public class TimerType {
   ...
   *
   * @param value allowed object is {@link TimerTriggerType }
   */
   ...
   *
   * @param value allowed object is {@link TimerDurationFactsType }
   */
