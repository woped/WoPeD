 ...
 *         &lt;element name="secondary" type="{http://www.yawlfoundation.org/yawlschema}ResourcingSecondaryFactsType" minOccurs="0"/>
...
@XmlType(
    name = "ResourcingFactsType",
    propOrder = {"offer", "allocate", "start", "secondary", "privileges"})
public class ResourcingFactsType {
  ...
  protected ResourcingSecondaryFactsType secondary;
   ...
   *
   * @param value allowed object is {@link ResourcingOfferFactsType }
   */
   ...
   *
   * @param value allowed object is {@link ResourcingAllocateFactsType }
   */
   ...
   *
   * @param value allowed object is {@link ResourcingInteractionInitiatorType }
   */
   ...
   *
   * @return possible object is {@link ResourcingSecondaryFactsType }
   */
  public ResourcingSecondaryFactsType getSecondary() {
    return secondary;
  }
   ...
   *
   * @param value allowed object is {@link ResourcingSecondaryFactsType }
   */
  public void setSecondary(ResourcingSecondaryFactsType value) {
   ...
   *
   * @param value allowed object is {@link ResourcingPrivilegesFactsType }
   */
