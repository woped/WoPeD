...
@XmlType(
    name = "ExternalNetElementFactsType",
    propOrder = {"name", "documentation", "flowsInto"})
...
public class ExternalNetElementFactsType extends ExternalNetElementType {
   ...
   * there is not a <CODE>set</CODE> method for the flowsInto property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link FlowsIntoType }
   */
