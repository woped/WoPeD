...
/**
 * Java class for ResourcingSecondaryFactsType complex type.
 *
...
@XmlType(
    name = "ResourcingSecondaryFactsType",
    propOrder = {"nonHumanResource", "nonHumanCategory"})
public class ResourcingSecondaryFactsType extends ResourcingSetFactsType {
   ...
   * there is not a <CODE>set</CODE> method for the nonHumanResource property.
   *
   ...
   * <p>This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the nonHumanCategory property.
   *
   * <p>For example, to add a new item, do as follows:
   *
   * <pre>
   ...
   * ResourcingSecondaryFactsType.NonHumanCategory }
   */
