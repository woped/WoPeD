...
public class ApromoreFolderTree extends JTree {
  ...
  private JTree tree;
  public static final String TOP_NODE_NAME = Messages.getString("Apromore.UI.Node.Root.Title");
  private DefaultMutableTreeNode root = new DefaultMutableTreeNode(TOP_NODE_NAME);
  ...
  public void setSubFolders(ArrayList<String> subFolders) {
    ...
    for (String str : subFolders) {
      model.insertNodeInto(new DefaultMutableTreeNode(str), root, root.getChildCount());
    }
    model.reload();
  }
}
