...
public class ApromoreImportFrame extends AbstractApromoreFrame {
  ...
  private JToggleButton getToggleButton() {
    ...
    if (toggleButton == null) {
      ...
      toggleAction.putValue(
          JXCollapsiblePane.COLLAPSE_ICON, UIManager.getIcon("Tree.expandedIcon"));
  ...
  private JCheckBox getTaskToTransitionCheckbox() {
    ...
    if (tasksToTransitionsCheckBox == null) {
      ...
      tasksToTransitionsCheckBox.setText(
          Messages.getString("Apromore.UI.Import.TreatTasksAsTransitions"));
    ...
    Thread queryThread =
        new Thread() {
          ...
          public void run() {
            ...
            importWorker =
                new ImportWorker(
                    ApromoreImportFrame.this, isEdgesToPlaces(), isTasksToTransitions());
