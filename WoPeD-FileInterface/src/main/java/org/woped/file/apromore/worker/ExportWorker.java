...
public class ExportWorker extends SwingWorker<Void, Void> {
  ...
  public ExportWorker(ApromoreExportFrame parent, String version, boolean update) {
      ...
      if (update) {
        ...
        try {
          ...
          processList.updateAction(
              Integer.valueOf(parent.getProcessIDText().getText()),
              parent.getProcessOwnerText().getText(),
              parent.getProcessTypeText().getText(),
        ...
        if (!processList.getProcessNames().contains(parent.getProcessNameText().getText())) {

          processList.exportAction(
              parent.getProcessOwnerText().getText(),
              parent.getProcessFolderBox().getSelectedItem().toString(),
              parent.getProcessNameText().getText(),
              version);
          parent.showDialog(
