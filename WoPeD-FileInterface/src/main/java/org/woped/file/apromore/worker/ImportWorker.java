...
public class ImportWorker extends SwingWorker<Boolean, Void> {
  ...
  public ImportWorker(
      AbstractApromoreFrame parent, boolean edgesToPlaces, boolean tasksToTransitions) {
    this.parent = parent;
    ...
    SwingUtilities.invokeLater(
        new Runnable() {
          ...
          public void run() {
            ...
            boolean succees =
                parent.getProcessList().importAction(false, edgesToPlaces, tasksToTransitions);
