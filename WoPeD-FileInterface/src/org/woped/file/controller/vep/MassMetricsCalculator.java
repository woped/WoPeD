...
public class MassMetricsCalculator {
	...
	/**
	 * Used for mass calculation of WoPeD metrics.
	 * Contained in this project due to the need to open and load files
	 * 
	 * Mass calculation logic (Increasing performance >90%) has been added directly to the IEditor and loader classes
	 */
	...
	/**
	 * Runs the actual calculation, using a path to save the file and the mediator required to open files
	 * 
	 * @param saveFile
	 * @param medi
	 */
	...
	/**
	 * This Thread is used for the actual metrics calculation. It should not intervene with working with other nets or any UI-related functions
	 *
	 */
