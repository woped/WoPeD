 ...
 */
public class OLDPNMLImport2 extends PNMLImport implements WoPeDLogger
{
    ...
    {
        logger.debug("##### START PNML IMPORT (OLD VERSION) #####");
        try
        {
        ...
        {
            e.printStackTrace();
            logger.warn("   ... Could not load PNML file. When saving, new pnml file-format will be created.");
            return false;
        } finally
        {
            logger.debug("##### END PNML IMPORT (OLD VERSION) #####");
        }
    }
