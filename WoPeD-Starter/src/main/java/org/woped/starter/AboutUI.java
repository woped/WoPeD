...
public class AboutUI extends JDialog {
  ...
  private void initialize() {
    ...
    if (getOwner() != null) {
      this.setLocation(
          getOwner().getX() + ((getOwner().getWidth() - this.getWidth()) / 2),
  ...
  private JScrollPane getAboutPanel() {
    ...
    String aboutText =
        "<html><p>"
            + Messages.getStringReplaced("About.Text", aboutArgs)
            + Messages.getString("About.Members")
            + Messages.getString("About.Thanks")
            + Messages.getString("About.Thanks.Names")
            + "</p></html>";
    String javaText =
        "<html><p><b>"
            + Messages.getString("About.Java")
            + ": </b>"
    ...
    if (aboutPanel == null) {
      ...
      logoLabel =
          new JLabel(
              new ImageIcon(getClass().getResource(Messages.getString("Window.About.Image"))));
      ...
      c.insets = new Insets(0, 10, 0, 10);
      homepageLabel =
          new JLabel("<html><p>" + Messages.getString("About.Homepage") + "</p></html>");
      ...
      icLabel.addMouseListener(
          new LaunchDefaultBrowserAction(Messages.getString("About.Iconset.Link"), icLabel));
      panel.add(icLabel, c);
  ...
  private JPanel getButtonPanel() {
    if (buttonPanel == null) {
      ...
      aboutButton.setIcon(
          new ImageIcon(getClass().getResource(Messages.getString("Action.ShowAbout.Icon"))));
