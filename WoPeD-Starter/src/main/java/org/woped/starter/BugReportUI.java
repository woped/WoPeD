...
public class BugReportUI extends JDialog {
  ...
  private JScrollPane getBugReportPanel() {
    if (bugReportPanel == null) {
      ...
      logoLabel =
          new JLabel(new ImageIcon(getClass().getResource(Messages.getString("BugReport.Image"))));
      ...
      bugPageLabel.addMouseListener(
          new LaunchDefaultBrowserAction(Messages.getString("BugReport.URL"), bugPageLabel));
  ...
  private JPanel getButtonPanel() {
    if (buttonPanel == null) {
      ...
      closeButton.setIcon(
          new ImageIcon(getClass().getResource(Messages.getString("BugReport.Close.Icon"))));
