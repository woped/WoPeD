...
public class RunWoPeD extends JFrame {
  ...
  public static void main(String[] args) {
    ...
    if (startDelayed || forceGerman || forceEnglish) args = null;
    ...
    if (Platform.isMac()) {
      ...
      d.setQuitHandler(
          (e, r) ->
              m_dam.fireViewEvent(
                  new ViewEvent(
                      m_dam, AbstractViewEvent.VIEWEVENTTYPE_GUI, AbstractViewEvent.EXIT)));

      d.setAboutHandler(
          e ->
              m_dam.fireViewEvent(
                  new ViewEvent(
                      m_dam, AbstractViewEvent.VIEWEVENTTYPE_GUI, AbstractViewEvent.ABOUT)));

      d.setPreferencesHandler(
          e ->
              m_dam.fireViewEvent(
                  new ViewEvent(
                      m_dam,
  ...
  private void initLogging() {
    ...
    LoggerManager.register(
        new WopedLogger(org.apache.log4j.Logger.getLogger(Constants.GUI_LOGGER)),
        Constants.GUI_LOGGER);
    LoggerManager.register(
        new WopedLogger(
            org.apache.log4j.Logger.getLogger(org.woped.editor.Constants.EDITOR_LOGGER)),
    ...
    LoggerManager.register(
        new WopedLogger(org.apache.log4j.Logger.getLogger(org.woped.file.Constants.FILE_LOGGER)),
    ...
    LoggerManager.register(
        new WopedLogger(
            org.apache.log4j.Logger.getLogger(org.woped.apromore.Constants.APROMORE_LOGGER)),
