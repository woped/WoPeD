...
public class RegistrationUI extends JDialog {
  ...
  private JPanel getRegistrationTextPanel() {
    ...
    if (registrationTextPanel == null) {
      ...
      logoLabel =
          new JLabel(
              new ImageIcon(getClass().getResource(Messages.getString("Window.Logo.Image"))));
      ...
      registrationTextLabel =
          new JLabel(
              "<html><p>"
                  ...
                  + Messages.getString("Registration.Text")
                  + "</p></html>");
  ...
  private JPanel getSocialMediaPanel() {
    ...
    if (socialMediaPanel == null) {
      ...
      TitledBorder border =
          new TitledBorder(Messages.getString("Registration.Panel.SocialMedia.Text"));
      socialMediaPanel.setBorder(
      ...
      facebookLink.addMouseListener(
          new LaunchDefaultBrowserAction(
              Messages.getString("Community.Facebook.link"), facebookLink));
      ...
      googlePlusLink.addMouseListener(
          new LaunchDefaultBrowserAction(
              Messages.getString("Community.Googleplus.link"), googlePlusLink));
      ...
      twitterLink.addMouseListener(
          new LaunchDefaultBrowserAction(
              Messages.getString("Community.Twitter.link"), twitterLink));
          ...
          new WopedButton(
              new AbstractAction() {
                ...
                public void actionPerformed(ActionEvent arg0) {
                  ...
                  String url =
                      Messages.getString("Registration.ServerURL")
                          + "?java="
                          + javaVersion
                          + "&os="
                          + osVersion
                  ...
                  if (initialStart) {
                    ConfigurationManager.getConfiguration()
                        .setShowOnStartup(!showAgainCheckBox.isSelected());
                  }
