...
public class OSXMenu extends JMenu {
   ...
   * @return the OSX menu item
   * @param ignoreDefaultKeyMask pass true if the default key (eg. Win CTRL; Mac cmd) should be
   *     ignored
   * @author <a href="mailto:lukas-riegel@freenet.de">Lukas Riegel</a> <br>
   */
  public OSXMenuItem addMenuItem(
      String itemName, String propertiesPrefixForShortcuts, Boolean ignoreDefaultKeyMask) {
    OSXMenuItem item = new OSXMenuItem(itemName);
  ...
  //	  OSXMenuItem item = new OSXMenuItem(itemName);
  //      item.setAccelerator(KeyStroke.getKeyStroke(shortcut, (modifier |
  // Toolkit.getDefaultToolkit().getMenuShortcutKeyMask())));
  //      this.add(item);
  //      return item;
  //   }
   ...
   * @author <a href="mailto:lukas-riegel@freenet.de">Lukas Riegel</a> <br>
   */
  public OSXCheckboxMenuItem addCheckboxMenuItem(
      String itemName, final JCheckBox synchronizedItem) {
  ...
  public OSXCheckboxMenuItem addCheckboxMenuItem(
      String itemName,
      String propertiesPrefixForShortcuts,
      final JCheckBox synchronizedItem,
      Boolean ignoreDefaultKeyMask) {
    OSXCheckboxMenuItem item = new OSXCheckboxMenuItem(itemName, synchronizedItem);
    if (!ignoreDefaultKeyMask) {
      item.setAccelerator(
          KeyStroke.getKeyStroke(
   ...
   */
  public OSXCheckboxMenuItem addCheckboxMenuItem(
      String itemName, String propertiesPrefixForShortcuts, final JCheckBox synchronizedItem) {
    return addCheckboxMenuItem(itemName, propertiesPrefixForShortcuts, synchronizedItem, false);
  }
  //   public OSXCheckboxMenuItem addCheckboxMenuItemWithShortcut(String itemName, int shortcut,
  // final JCheckBox synchronizedItem) {
  //	  OSXCheckboxMenuItem item = new OSXCheckboxMenuItem(itemName, synchronizedItem);
  //      item.setAccelerator(KeyStroke.getKeyStroke(shortcut,
  // Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
  ...
  //      return item;
  //   }
  //   public OSXCheckboxMenuItem addCheckboxMenuItemWithShortcut(String itemName, int shortcut, int
  // modifier, final JCheckBox synchronizedItem) {
  //	  OSXCheckboxMenuItem item = new OSXCheckboxMenuItem(itemName, synchronizedItem);
  //      item.setAccelerator(KeyStroke.getKeyStroke(shortcut, (modifier |
  // Toolkit.getDefaultToolkit().getMenuShortcutKeyMask())));
  //      this.add(item);
  //      return item;
  //   }
  //   public OSXCheckboxMenuItem addMenuItemWithSingleShortcut(String itemName, int shortcut, final
  // JCheckBox synchronizedItem) {
  //	   OSXCheckboxMenuItem item = new OSXCheckboxMenuItem(itemName, synchronizedItem);
  //      item.setAccelerator(KeyStroke.getKeyStroke(shortcut,0));
  //      this.add(item);
  //      return item;
