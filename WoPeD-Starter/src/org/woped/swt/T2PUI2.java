...
public class T2PUI2 extends JDialog{
	...
	public T2PUI2(AbstractApplicationMediator mediator) {
		this(null, mediator);
	}
	 ...
	 */
	public T2PUI2(Frame owner, AbstractApplicationMediator mediator) throws HeadlessException {
		super(owner, true);
