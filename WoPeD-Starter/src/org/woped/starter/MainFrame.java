...
import org.woped.gui.images.svg.Google_plus_icon;
import org.woped.gui.images.svg.P2T;
import org.woped.gui.images.svg.Test;
...
//			addShortcutToJCommandButton("Metrics.processmetrics", processMetricsButton, ActionFactory.ACTIONID_METRIC);
	...
	private JCommandButton getT2PButton() {
		if (t2pButton == null) {
			t2pButton = new JCommandButton(Messages.getString("T2P.text"), new Test()); //T2P
