...
public class MetricHighlighting {
  ...
  public void addArcIDs(Set<String> arcids) {
    if (arcids != null) for (String arcid : arcids) addArcID(arcid);
  }

  public void addNodeIDs(Set<String> nodeids) {
    if (nodeids != null) for (String nodeid : nodeids) addNodeID(nodeid);
  }

  public void removeNodeIDs(Set<String> nodeids) {
    if (nodeids != null) for (String nodeid : nodeids) removeNodeID(nodeid);
  }
