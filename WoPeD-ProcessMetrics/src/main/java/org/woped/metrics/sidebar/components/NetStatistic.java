...
public class NetStatistic extends JPanel {
  ...
  private void addComponents() {
    ...
    // header label
    JLabel netStatisticLabel =
        new JLabel(Messages.getString(PREFIX_QUALANALYSIS + "NetStatistics"));
    netStatisticLabel.setFont(HEADER_FONT);
    netStatisticLabel.setBorder(BorderFactory.createEmptyBorder(0, 0, 5, 0));
    ...
    ClickLabel clickLabel =
        new ClickLabel(
            ...
            qualanalysisService.getPlaces().iterator(),
            editor);
    clickLabel.setFont(ITEMS_FONT);
    statistics.add(clickLabel);

    JLabel count = new JLabel(String.valueOf(qualanalysisService.getPlaces().size()), JLabel.RIGHT);
    ...
    clickLabel =
        new ClickLabel(
            Messages.getString(PREFIX_QUALANALYSIS + "NumTransitions") + ":",
            qualanalysisService.getTransitions().iterator(),
            editor);
    clickLabel.setFont(ITEMS_FONT);
    statistics.add(clickLabel);
    ...
    clickLabel =
        new ClickLabel(
            SUB_POINT + Messages.getString(PREFIX_QUALANALYSIS + "NumOperators") + ":",
            qualanalysisService.getOperators().iterator(),
            editor);
    clickLabel.setFont(ITEMS_FONT);
    statistics.add(clickLabel);
    ...
    clickLabel =
        new ClickLabel(
            SUB_POINT + Messages.getString(PREFIX_QUALANALYSIS + "NumSubprocesses") + ":",
            qualanalysisService.getSubprocesses().iterator(),
            editor);
    clickLabel.setFont(ITEMS_FONT);
    statistics.add(clickLabel);
    ...
    JLabel arcLabel = new JLabel(Messages.getString(PREFIX_QUALANALYSIS + "NumArcs") + ":");
  ...
  /**
   * @return singleton pattern for generation of an instance of QualanalysisService needs for the
