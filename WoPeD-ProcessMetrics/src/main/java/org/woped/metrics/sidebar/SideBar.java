...
public class SideBar extends JPanel {
  ...
  public JPanel createMainPanel() {
    ...
    // headline
    JLabel metricsLabel = new JLabel(Messages.getString(PREFIX + "SideBar.Header"));
    ...
    metricCategories.addItemListener(
        new ItemListener() {
    ...
    JLabel formulaEnhancementLabel = new JLabel("Metrics Formula Enhancements");
    ...
    formulaEnhancementLabel.addMouseListener(
        new MouseListener() {
    ...
    mainPanel.add(
        new ExportLabel(
            Messages.getImageIcon("Action.Export"), Messages.getString("Metrics.SideBar.Export")),
        c);
    ...
    mainPanel.add(
        new HideLabel(
            ...
            Messages.getString("Metrics.SideBar.Hide")),
        c);
    ...
    mainPanel.add(
        new RevertLabel(
            Messages.getImageIcon("Action.Undo"), Messages.getString("Metrics.SideBar.Revert")),
        c);
    ...
    mainPanel.add(
        new ConfigLabel(
            ...
            Messages.getString("Metrics.SideBar.Config")),
        c);
  ...
  private void refreshUI() {
    ...
    if (metricGroups != null) {
      ...
      for (UIMetricsGroup item : metricGroups) {
        ...
        MetricGroup metricGroup = new MetricGroup(getUiHandler(), editor, item, this);
  ...
  /**
   * @author Mathias Gruschinske label with mouse listener and icon to call the export function to
   *     export the results
   */
  ...
  /**
   * @author Mathias Gruschinske label with mouse listener and icon to collapse all detail panels
   *     and revert the highlighting
   */
