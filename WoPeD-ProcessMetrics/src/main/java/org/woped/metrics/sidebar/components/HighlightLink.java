...
/**
 * @author Mathias Gruschinske Label with mouse listener to highlight the net elements which are
 *     affected by the metric
 */
public class HighlightLink extends JLabel {
  ...
  public HighlightLink(
      final MetricsUIRequestHandler uiHandler, final IEditor editor, final String metricsID) {
    super(" " + metricsID + ":");
