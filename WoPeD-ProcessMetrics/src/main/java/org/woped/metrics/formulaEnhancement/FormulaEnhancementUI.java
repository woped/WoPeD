...
public class FormulaEnhancementUI extends JFrame
  ...
  private String[] columnTitles = {
    Messages.getString("Metrics.FormulaEnhancements.UI.FormulaID"),
    Messages.getString("Metrics.FormulaEnhancements.UI.ActualFormula"), // $NON-NLS-1$ //$NON-NLS-2$
    Messages.getString("Metrics.FormulaEnhancements.UI.EnhancedFormula")
  }; //$NON-NLS-1$
  ...
  private void createUI() {
    DefaultTableModel tableModel =
        new DefaultTableModel(
            FormulaEnhancementList.getInstance().getEnhancementListAsArray(), columnTitles) {
    ...
    acceptButton =
        new JButton(
            Messages.getString("Metrics.FormulaEnhancements.UI.AcceptEnhancements")); // $NON-NLS-1$
    ...
    acceptAllButton =
        new JButton(
            Messages.getString(
                "Metrics.FormulaEnhancements.UI.AcceptAllEnhancements")); //$NON-NLS-1$
    ...
    clearListButton =
        new JButton(Messages.getString("Metrics.FormulaEnhancements.UI.ClearList")); // $NON-NLS-1$
    ...
    closeButton =
        new JButton(Messages.getString("Metrics.FormulaEnhancements.UI.Close")); // $NON-NLS-1$
    this.buttonPanel.add(closeButton);
    closeButton.addActionListener(new closeButtonActionListener(this));
  }

  @Override
  public void formulaEnhancementListChanged(FormulaEnhancementListChangedEvent e) {
    final DefaultTableModel model = (DefaultTableModel) formulaList.getModel();
    model.setDataVector(
        FormulaEnhancementList.getInstance().getEnhancementListAsArray(), columnTitles);
  ...
  /**
   * @author Tobias Lorentz This class is the Button-Listener for the close button It stores a
   *     reference to the formulaEnhancementUI for deregister the listener before closing the ui
   */
