...
public class MetricsBuilderErrorFrame extends JFrame {
  ...
  /**
   * This Variable stores the Error from the consistency check Special Case: this is a object of the
   * NestedCalculateFormulaException and contains multiple Exceptions
   */
   ...
   */
  public MetricsBuilderErrorFrame(CalculateFormulaException e) throws HeadlessException {
    super();
    this.e = e;
    this.createUI();
  ...
  private void createUI() {
    ...
    if (e instanceof NestedCalculateFormulaException) {
      String[] columnTitles = {
        Messages.getString("Metrics.Builder.ErrorFrame.Error")
      }; //$NON-NLS-1$
      DefaultTableModel tableModel =
          new DefaultTableModel(
              ((NestedCalculateFormulaException) e).getExceptionsAsTable(), columnTitles) {
