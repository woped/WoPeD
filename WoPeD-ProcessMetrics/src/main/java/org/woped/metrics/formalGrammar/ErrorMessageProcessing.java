...
public class ErrorMessageProcessing {
  public static String getErrorMessage(
      RecognitionException e, String[] tokens, BaseRecognizer processor) {
    ...
    if (e instanceof org.antlr.runtime.MismatchedTokenException) {
      ...
      if (mte.c == Token.EOF) {
        ...
        msg =
            Messages.getString("Metrics.Calculate.Error.Antlr.mismatchedCharacter")
                + getCharErrorDisplay(mte.c, tokens, processor); // $NON-NLS-1$
        try {
          msg =
              msg
                  + " "
                  + Messages.getString("Metrics.Calculate.Error.Antlr.expecting")
                  + tokens[mte.expecting]; // $NON-NLS-1$
        } catch (ArrayIndexOutOfBoundsException aioob) {
      ...
      return Messages.getString("Metrics.Calculate.Error.Antlr.NoViableAlt")
          + getCharErrorDisplay(e.c, tokens, processor); // $NON-NLS-1$
    } else if (e instanceof org.antlr.runtime.EarlyExitException) {
      return Messages.getString("Metrics.Calculate.Error.Antlr.requiredLoop")
          + getCharErrorDisplay(e.c, tokens, processor); // $NON-NLS-1$
    } else if (e instanceof org.antlr.runtime.MismatchedNotSetException) {
      MismatchedNotSetException mnse = (MismatchedNotSetException) e;
      return Messages.getString("Metrics.Calculate.Error.Antlr.mismatchedCharacter")
          + getCharErrorDisplay(e.c, tokens, processor)
          + Messages.getString("Metrics.Calculate.Error.Antlr.ExpectingSet")
          + mnse.expecting; //$NON-NLS-1$ //$NON-NLS-2$
    } else if (e instanceof org.antlr.runtime.MismatchedSetException) {
      MismatchedSetException mmse = (MismatchedSetException) e;
      return Messages.getString("Metrics.Calculate.Error.Antlr.mismatchedCharacter")
          + getCharErrorDisplay(e.c, tokens, processor)
          + Messages.getString("Metrics.Calculate.Error.Antlr.ExpectingSet")
          + mmse.expecting; //$NON-NLS-1$ //$NON-NLS-2$
      ...
      return Messages.getString("Metrics.Calculate.Error.Antlr.mismatchedCharacter")
          ...
          + Messages.getString("Metrics.Calculate.Error.Antlr.ExpectingSet")
          + //$NON-NLS-1$ //$NON-NLS-2$
          getCharErrorDisplay(mre.a, tokens, processor)
          + ".."
          + getCharErrorDisplay(mre.b, tokens, processor);
    } else {
      return processor.getErrorMessage(e, tokens);
    }
  }
  ...
  public static String getErrorHeader(RecognitionException e) {
    return Messages.getString("Metrics.Calculate.Error.Antlr.Position")
        + " "
