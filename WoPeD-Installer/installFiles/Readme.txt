...
For Microsoft Windows, download WoPeD-install-windows-3.8.0.zip,
unpack it with an archiving tool and run the contained executable
WoPeD-install.exe.

For Linux, download WoPeD-install-linux-3.8.0.tgz, unpack and
...
Root directory:
  ...
  ./WoPeD-Starter-3.8.0.jar         (WoPeD program classes)
