...
public class TimeModelDialog extends JDialog {
  ...
  private void initialize() {
    ...
    timeModelPanel.setBorder(
        BorderFactory.createCompoundBorder(
            BorderFactory.createTitledBorder(Messages.getString("QuantAna.TimeModel.Settings")),
  ...
  private void applyProperties() {
    createTimeModel();
    if (dlg instanceof CapacityAnalysisDialog) ((CapacityAnalysisDialog) dlg).updContents();
    else ((QuantitativeSimulationDialog) dlg).updTimeModel();
    this.dispose();
  }
