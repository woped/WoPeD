          ...
          new Runnable() {
            ...
            public void run() {
              String url =
                  "http://localhost:"
                      + 2711
                      + "/getrequest/?action=showdashboardFull&AutoUpdate="
                      + Boolean.toString(ClientStarter.bAutoUpdate);
              ...
              if (Desktop.isDesktopSupported()) {
                ...
                try {
                  ...
                  LoggerManager.info(
                      Constants.DASHBOARDWEBSRV_LOGGER, "ClientStarter : client gestartet");
                } catch (IOException | URISyntaxException e) {
                  // TODO Auto-generated catch block
                  LoggerManager.error(
                      Constants.DASHBOARDWEBSRV_LOGGER,
                      "Exception in runBrowser.run" + e.toString());
                  // e.printStackTrace();
                }
              } else {
                ...
                try {
                  ...
                  LoggerManager.error(
                      Constants.DASHBOARDWEBSRV_LOGGER,
                      "IOException instarting runtime" + e.toString());
                  // e.printStackTrace();
                }
              }
            }
