...
public class ThinServer {
  ...
  protected static ResourceBundle rb =
      PropertyResourceBundle.getBundle("org.woped.gui.translations.Messages");
  ...
  public void start() {
    try {
      ...
      LoggerManager.error(
          Constants.DASHBOARDWEBSRV_LOGGER, "Exception in Thinserver.start()" + e.toString());
      e.printStackTrace();
      sendShutdownRequest();
    }
  }
  ...
  private ServerSocket getServerSocket() {
    ...
    // LoggerManager.debug(Constants.DASHBOARDWEBSRV_LOGGER, "webserver is already running: " +
    // bAlreadyRunning);
    ...
    if (serverSocket == null) {
      try {
        ...
        LoggerManager.error(
            Constants.DASHBOARDWEBSRV_LOGGER,
            "Exception in Thinserver.getServerSocket()" + e.toString());
      }
    }
    return serverSocket;
  }
  ...
  public void open() {
    ...
    try {
      ...
      LoggerManager.info(
          Constants.DASHBOARDWEBSRV_LOGGER,
          "getting URL of local service and open the System-Default-Browser ");
      ...
      LoggerManager.error(
          Constants.DASHBOARDWEBSRV_LOGGER, "URISyntaxException in .open(): " + e.toString());

    } catch (IOException e) {

      LoggerManager.error(
          Constants.DASHBOARDWEBSRV_LOGGER, "IOException in .open(): " + e.toString());
    }
  }
  /*
