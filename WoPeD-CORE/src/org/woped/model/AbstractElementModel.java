...
public abstract class AbstractElementModel extends DefaultGraphCell implements WoPeDLogger, Serializable
{
    ...
    public AbstractElementModel(CreationMap creationMap, Object userObject, int modelProcessorType)
    {
        ...
        {
            logger.error("It's not allowed to create a Element without id. Please use ModelElementFactory instead.");
        }
