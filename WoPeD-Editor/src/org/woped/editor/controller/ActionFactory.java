...
public class ActionFactory
{
    ...
    public static HashMap<String, WoPeDAction> createStaticActions(ApplicationMediator am)
    {
        ...
        STATIC_ACTION_MAP.put(ACTIONID_DRAWMODE_XORJOINANDSPLIT, new WoPeDAction(am, AbstractViewEvent.VIEWEVENTTYPE_APPLICATION, AbstractViewEvent.DRAWMODE_XORJOIN_ANDSPLIT, null,
...
//        VisualController.getInstance().addElement(STATIC_ACTION_MAP.get(ACTIONID_PRESS), VisualController.WITH_EDITOR, VisualController.IGNORE, VisualController.IGNORE);
        ...
        VisualController.getInstance().addElement(STATIC_ACTION_MAP.get(ACTIONID_ADD_XORJOINANDSPLIT), VisualController.NO_SELECTION, VisualController.IGNORE, VisualController.IGNORE);
        ...
        VisualController.getInstance().addElement(STATIC_ACTION_MAP.get(ACTIONID_CUT), VisualController.TRANSITION_PLACE_SELECTION, VisualController.IGNORE, VisualController.IGNORE);
