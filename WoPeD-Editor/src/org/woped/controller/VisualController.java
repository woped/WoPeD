 ...
 */
public class VisualController implements PropertyChangeListener, GraphSelectionListener, WoPeDLogger
{
    ...
    protected static boolean setEnabled(Object obj, boolean status)
    {
        if (obj != null)
        {
            ...
            {
                logger.warn("Could not change the status (Enableing).");
            }
    ...
    protected static boolean setSelected(Object obj, boolean status)
    {
        if (obj != null)
        {
            ...
            {
                logger.warn("Could not change the status (Selection).");
            }
    ...
    protected static boolean setVisible(Object obj, boolean status)
    {
        if (obj != null)
        {
            ...
            {
                logger.warn("Could not change the status (Visibility).");
            }
