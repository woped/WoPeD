...
import org.woped.gui.config.AbstractConfPanel;
import org.woped.gui.config.ConfPanelTree;
 ...
 */
public class ConfigVC extends JDialog implements TreeSelectionListener, IViewController, WoPeDLogger
{
    // ViewControll
    ...
    public void addConfNodePanel(String parentNodePanelName, AbstractConfPanel nodePanel)
    {
        ...
        {
            logger.warn("A Node-Panel with the name \"" + nodePanel.getPanelName() + "\" has already been added. Please rename.");
        }
    }
