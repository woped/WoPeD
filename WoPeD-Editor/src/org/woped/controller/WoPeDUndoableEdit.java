 ...
 */
public class WoPeDUndoableEdit implements UndoableEdit, WoPeDLogger
{
    ...
    private void insertElements(Object[] elementsInput)
    {
        ...
        if (elements != null)
        {
            ...
            {
                logger.debug("Trying to create " + elements[i].getClass());
                ...
                {
                    logger.debug("Could not insert type:" + elements[i].getClass());
                }
            }
        }
    }
