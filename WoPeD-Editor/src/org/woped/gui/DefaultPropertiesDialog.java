 ...
 * @author Thomas Pohl
 */
public class DefaultPropertiesDialog extends JDialog implements WoPeDLogger, IEditorProperties
{
            ...
            if (m_selection.length == 1)
            {
                ...
                if (m_selection[0] instanceof PetriNetModelElement)
                {
                    ...
                    if (element instanceof PlaceModel)
                    {
                        ...
                        //OLDUserInterface.getInstance().getActiveEditor().getGraph().getGraphLayoutCache().valueForCellChanged(((PlaceModel)element).getNameModel(), ((JTextField) m_parameters.get(NAME)).getText());
                        //((PlaceModel) element).setNameValue(((JTextField) m_parameters.get(NAME)).getText());
                    ...
                    {
                        //OLDUserInterface.getInstance().getActiveEditor().getGraph().getGraphLayoutCache().valueForCellChanged(((TransitionModel)element).getNameModel(), ((JTextField) m_parameters.get(NAME)).getText());
                        //((TransitionModel) element).setNameValue(((JTextField) m_parameters.get(NAME)).getText());
                    }
                }
            }
        }
