 ...
 */
public class ConfPanelTree extends JTree implements WoPeDLogger
{
    ...
    public void setSelectedNode(String name)
    {
        ...
        {
            logger.warn("Could not select node \"" + name + "\"");
        }
    }
    ...
    public void addConfNodePanel(String parentNodeName, String nodePanelName)
    {
        ...
        {
            logger.warn("Could not add \"" + nodePanelName + "\". Parent node \"" + parentNodeName + "\" does not exists.");
        }
    }
