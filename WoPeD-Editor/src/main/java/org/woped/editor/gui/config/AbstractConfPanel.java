 ...
 *     <br>
 *     Every Panel for the <code>ConfUI</code> has to be extended from the <code>AbstractConfPanel
 *     </code>.
 *     <p>Created on: 26.11.2004 Last Change on: 26.11.2004
 */
public abstract class AbstractConfPanel extends JPanel {
  ...
  /**
   * Reads the configuration. Reads the stored values from the configuration object into the
   * displayed fields.
   */
