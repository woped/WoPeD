...
public class ConfMetricsPanel extends AbstractConfPanel {
  ...
  public boolean applyConfiguration() {
    if (useMetricsCheckBox.isSelected() != ConfigurationManager.getConfiguration().isUseMetrics()) {
      JOptionPane.showMessageDialog(
          this,
          Messages.getString("Configuration.Metrics.Dialog.Restart.Message"),
          Messages.getString("Configuration.Metrics.Dialog.Restart.Title"),
      ...
      if (useMetricsCheckBox.isSelected()
          && !ConfigurationManager.hasNonStaticMetricsConfiguration()) {
      ...
      ConfigurationManager.getConfiguration()
          .setAlgorithmDecimalPlaces(
              Integer.parseInt(algorithmDecimalPlacesSpinner.getModel().getValue().toString()));
      ConfigurationManager.getConfiguration()
          .setVariableDecimalPlaces(
              Integer.parseInt(variableDecimalPlacesSpinner.getModel().getValue().toString()));
      ConfigurationManager.getConfiguration()
          .setUseAlgorithmHighlighting(useAlgorithmHighlightingCheckBox.isSelected());
      ConfigurationManager.getConfiguration()
          .setShowNamesInBuilder(showNamesInBuilderCheckBox.isSelected());
      ConfigurationManager.getConfiguration()
          .setShowAdvancedErrorMessages(showAdvancedErrorMessagesCheckBox.isSelected());
    }
  ...
  public void readConfiguration() {
    ...
    else useMetricsCheckBox.setSelected(false);

    variableDecimalPlacesSpinner.setValue(
        ConfigurationManager.getConfiguration().getVariableDecimalPlaces());
    algorithmDecimalPlacesSpinner.setValue(
        ConfigurationManager.getConfiguration().getAlgorithmDecimalPlaces());
    useAlgorithmHighlightingCheckBox.setSelected(
        ConfigurationManager.getConfiguration().isUseAlgorithmHighlighting());
    showNamesInBuilderCheckBox.setSelected(
        ConfigurationManager.getConfiguration().isShowNamesInBuilder());
    showAdvancedErrorMessagesCheckBox.setSelected(
        ConfigurationManager.getConfiguration().isShowAdvancedErrorMessages());
  }
  ...
  private JCheckBox getUseMetricsCheckBox() {
    if (useMetricsCheckBox == null) {
      useMetricsCheckBox =
          new JCheckBox(Messages.getString("Configuration.Metrics.UseMetrics.Label"));
      useMetricsCheckBox.setMinimumSize(new Dimension(100, 20));
      useMetricsCheckBox.setToolTipText(
          Messages.getString("Configuration.Metrics.UseMetrics.Tooltip"));
      ...
      metricsPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Metrics.Panel.MetricsUsage.Title")),
  ...
  private JPanel getMetricsDisplayPanel() {
    if (metricsDisplayPanel == null) {
      ...
      metricsDisplayPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Metrics.Panel.MetricsDisplay.Title")),
              BorderFactory.createEmptyBorder(5, 5, 10, 5)));
      ...
      c.gridx = 1;
      c.gridy = 0;
      metricsDisplayPanel.add(
          new JLabel(Messages.getString("Configuration.Metrics.VariableDecimalPlaces.Label")), c);
      c.weightx = 1;
      c.gridx = 10;
      c.gridy = 0;
      ...
      c.gridy = 1;
      metricsDisplayPanel.add(
          new JLabel(Messages.getString("Configuration.Metrics.AlgorithmDecimalPlaces.Label")), c);
      c.weightx = 1;
      c.gridx = 10;
      c.gridy = 1;
  ...
  private JSpinner getVariableDecimalPlacesSlider() {
    if (variableDecimalPlacesSpinner == null) {
      ...
      ((JSpinner.DefaultEditor) variableDecimalPlacesSpinner.getEditor())
          .getTextField()
          .setEditable(false);
      ((JSpinner.DefaultEditor) variableDecimalPlacesSpinner.getEditor())
          .getTextField()
  ...
  private JSpinner getAlgorithmDecimalPlacesSlider() {
    if (algorithmDecimalPlacesSpinner == null) {
      ...
      ((JSpinner.DefaultEditor) algorithmDecimalPlacesSpinner.getEditor())
          .getTextField()
          .setEditable(false);
      ((JSpinner.DefaultEditor) algorithmDecimalPlacesSpinner.getEditor())
          .getTextField()
  ...
  private JCheckBox getUseAlgorithmHighlightingCheckBox() {
    if (useAlgorithmHighlightingCheckBox == null)
      useAlgorithmHighlightingCheckBox =
          new JCheckBox(Messages.getString("Configuration.Metrics.UseAlgorithmHighlighting"));
  ...
  private JPanel getMetricsBuilderPanel() {
    if (metricsBuilderPanel == null) {
      ...
      metricsBuilderPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Metrics.Panel.MetricsBuilder.Title")),
              BorderFactory.createEmptyBorder(5, 5, 10, 5)));
  ...
  private JCheckBox getShowNamesInBuilderCheckBox() {
    if (showNamesInBuilderCheckBox == null)
      showNamesInBuilderCheckBox =
          new JCheckBox(Messages.getString("Configuration.Metrics.ShowNamesInBuilder"));
  ...
  private JCheckBox getShowAdvancedErrorMessagesCheckBox() {
    if (showAdvancedErrorMessagesCheckBox == null)
      showAdvancedErrorMessagesCheckBox =
          new JCheckBox(Messages.getString("Configuration.Metrics.ShowAdvancedErrorMessages"));
