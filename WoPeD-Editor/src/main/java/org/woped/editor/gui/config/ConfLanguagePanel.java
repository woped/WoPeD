...
public class ConfLanguagePanel extends AbstractConfPanel {
  ...
  public boolean applyConfiguration() {
    ...
    boolean changed =
        !locale
            .getLanguage()
            .equals(ConfigurationManager.getConfiguration().getLocale().getLanguage());
  ...
  private JComboBox getLanguageComboBox() {
    if (languageComboBox == null) {
      ...
      languageComboBox.setToolTipText(
          "<html>" + Messages.getString("Configuration.Language.Tooltip") + "</html>");
    }
      ...
      languagePanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Language.Panel.Language.Title")),
  ...
  private JLabel getLanguageLabel() {
    if (languageLabel == null) {
      languageLabel =
          new JLabel(
              "<html>"
                  + Messages.getString("Configuration.Language.Label.SelectLanguage")
                  + "</html>");
