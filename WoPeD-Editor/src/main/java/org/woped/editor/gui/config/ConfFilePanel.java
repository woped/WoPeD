 ...
 *     <br>
 *     The <code>ConfFilePanel</code> is the <code>AbstractConfPanel</code> for the configuration of
 *     the file handling. <br>
...
public class ConfFilePanel extends AbstractConfPanel {
  ...
  public boolean applyConfiguration() {
    ...
    ConfigurationManager.getConfiguration()
        .setExportToolspecific(getExportToolspecCheckBox().isSelected());
    ConfigurationManager.getConfiguration()
        .setImportToolspecific(getImportToolspecCheckBox().isSelected());
    ConfigurationManager.getConfiguration()
        .setTpnSaveElementAsName(getExportTpnElementAsNameCheckBox().isSelected());
    return true;
  }
  ...
  public void readConfiguration() {
    ...
    getExportToolspecCheckBox()
        .setSelected(ConfigurationManager.getConfiguration().isExportToolspecific());
    getImportToolspecCheckBox()
        .setSelected(ConfigurationManager.getConfiguration().isImportToolspecific());
    getExportTpnElementAsNameCheckBox()
        .setSelected(ConfigurationManager.getConfiguration().isTpnSaveElementAsName());
  }
  ...
  private JPanel getHomeDirPanel() {
    if (homeDirPanel == null) {
      ...
      homeDirPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Files.Panel.HomeDirectory.Title")),
  ...
  private JTextField getHomeDirTextField() {
    if (homeDirTextField == null) {
      ...
      homeDirTextField.setToolTipText(
          "<HTML>"
              + Messages.getString("Configuration.Files.Panel.HomeDirectory.Text.HomeDir.ToolTip")
              + "</HTML>");
      homeDirTextField.addKeyListener(
          new KeyListener() {
  ...
  private JButton getHomeDirChoose() {
    if (homeDirChoose == null) {
      ...
      homeDirChoose.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              ...
              if (new File(ConfigurationManager.getConfiguration().getHomedir()).isDirectory()) {
                jfc =
                    new JFileChooser(
                        new File(ConfigurationManager.getConfiguration().getHomedir()));
              } else {
                jfc =
                    new JFileChooser(
                        new File(ConfigurationManager.getConfiguration().getDefaultHomedir()));
              }
  ...
  private JPanel getRecentFilesPanel() {
    if (recentFilePanel == null) {
      ...
      c.gridx = 0;
      c.weightx = 1;
      recentFilePanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Files.Panel.RecentFiles.Title")),
              BorderFactory.createEmptyBorder(5, 5, 10, 5)));
  ...
  private JButton getRecentFilesDelete() {
    if (recentFileDelete == null) {
      ...
      recentFileDelete.setText(
          Messages.getString("Configuration.Files.Panel.RecentFiles.Text.DeleteRecentFiles"));
      recentFileDelete.setEnabled(
          ConfigurationManager.getConfiguration().getRecentFiles().size() != 0);
      recentFileDelete.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
  ...
  private JCheckBox getExportTpnElementAsNameCheckBox() {
    if (exportTpnElementAsNameCheckBox == null) {
      ...
      exportTpnElementAsNameCheckBox.setText(
          Messages.getString("Configuration.Files.Panel.TPN.Text.ExportID"));
      exportTpnElementAsNameCheckBox.setToolTipText(
          "<HTML>"
              + Messages.getString("Configuration.Files.Panel.TPN.Text.ExportID.ToolTip")
              + "</HTML>");
    }
  ...
  private JPanel getTPNPanel() {
    if (TPNPanel == null) {
      ...
      TPNPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Files.Panel.TPN.Title")),
              BorderFactory.createEmptyBorder(5, 5, 10, 5)));
      c.weightx = 1;
      c.gridx = 0;
      c.gridy = 0;
  ...
  private JCheckBox getImportToolspecCheckBox() {
    if (importToolspecCheckBox == null) {
      ...
      importToolspecCheckBox.setText(
          Messages.getString("Configuration.Files.Panel.PNML.Text.Import"));
      importToolspecCheckBox.setToolTipText(
          "<HTML>"
              + Messages.getString("Configuration.Files.Panel.PNML.Text.Import.ToolTip")
              + "</HTML>");
    }
  ...
  private JPanel getPNMLPanel() {
    if (PNMLPanel == null) {
      ...
      PNMLPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Files.Panel.PNML.Title")),
              BorderFactory.createEmptyBorder(5, 5, 10, 5)));
      c.weightx = 1;
      c.gridx = 0;
      c.gridy = 0;
  ...
  private JCheckBox getExportToolspecCheckBox() {
    if (exportToolspecCheckBox == null) {
      ...
      exportToolspecCheckBox.setText(
          Messages.getString("Configuration.Files.Panel.PNML.Text.Export"));
      exportToolspecCheckBox.setToolTipText(
          "<HTML>"
              + Messages.getString("Configuration.Files.Panel.PNML.Text.Export.ToolTip")
              + "</HTML>");
    }
  ...
  private JCheckBox getHomeDirDefaultCheckBox() {
    if (homeDirDefaultCheckBox == null) {
      ...
      homeDirDefaultCheckBox.setText(
          Messages.getString("Configuration.Files.Panel.HomeDirectory.Text.UseDefault"));
      homeDirDefaultCheckBox.addChangeListener(
          new ChangeListener() {
