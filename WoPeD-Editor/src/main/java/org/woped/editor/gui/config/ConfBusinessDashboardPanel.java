 ...
 *     <br>
 *     The <code>ConfLanguagePanel</code> is the <code>AbstractConfPanel</code> for the
 *     configuration of the language. <br>
...
public class ConfBusinessDashboardPanel extends AbstractConfPanel {
  ...
  public boolean applyConfiguration() {
    ...
    if (newsetting != oldsetting) {
      ...
      ConfigurationManager.getConfiguration()
          .setBusinessDashboardServerPort(Integer.parseInt(getServerPortText().getText()));

      ConfigurationManager.getConfiguration()
          .setBusinessDashboardUseByDefault(useByDefaultBox.isSelected());

      ConfigurationManager.getConfiguration()
          .setBusinessDashboardMaxValues(Integer.parseInt(getMaxValuesText().getText()));
    }
  ...
  public void readConfiguration() {
    ...
    getUseByDefaultBox()
        .setSelected(ConfigurationManager.getConfiguration().getBusinessDashboardUseByDefault());

    getMaxValuesText()
        .setText("" + ConfigurationManager.getConfiguration().getBusinessDashboardMaxValues());
  }
      ...
      settingsPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.BusinessDashboard.ChangeSettings.Panel.Title")),
  ...
  public JCheckBox getUseByDefaultBox() {
    if (useByDefaultBox == null) {
      useByDefaultBox =
          new JCheckBox(Messages.getString("Configuration.BusinessDashboard.Label.UseByDefault"));
      useByDefaultBox.setEnabled(true);
      useByDefaultBox.setToolTipText(
          "<html>"
  ...
  public JTextField getMaxValuesText() {
    if (maxValuesText == null) {
      ...
      maxValuesText.setToolTipText("<html>" + 1000 + "</html>");
    }
