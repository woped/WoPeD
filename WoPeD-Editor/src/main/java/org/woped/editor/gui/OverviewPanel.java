...
public class OverviewPanel extends JPanel
  ...
  /**
   * OverviewPanel provides a 'birds-eye' view of the active document. Must use the {@link
   * #createOverviewPanel}method to create a new instance.
   */
  public OverviewPanel(IEditor editorInterface, JScrollPane scrollPane) {
    ...
    graph =
        new WoPeDJGraph(
            (WoPeDJGraphGraphModel) editorInterface.getGraph().getModel(),
  ...
  public class ViewRedirector extends GraphLayoutCache {
    ...
    public ViewRedirector(GraphLayoutCache realView) {
      super(realView.getModel(), realView.getFactory());
      this.realView = realView;
      setModel(realView.getModel());
    }
  ...
  class PannerViewfinder implements MouseListener, MouseMotionListener, ChangeListener {
    ...
    public void update(Graphics g) {
      ...
      scaledWidth =
          (int) (viewportR.getWidth() * pannerContainerRectangle.getWidth() / viewD.getWidth());
      scaledHeight =
          (int) (viewportR.getHeight() * pannerContainerRectangle.getHeight() / viewD.getHeight());
      ...
      pannerResizeDecoration.setLocation(maxx - DECORATION_SIZE / 2, maxy - DECORATION_SIZE / 2);
