		...
		PropertyChangeListener
{
    ...
    class PannerViewfinder implements MouseListener, MouseMotionListener, ChangeListener
    {
        ...
        public void update(Graphics g)
        {
            ...
            pannerContainerRectangle.setSize(((int) (viewD.getWidth() * combinedScale)) - PANEL_BUFFER, ((int) (viewD.getHeight() * combinedScale)) - PANEL_BUFFER);
        ...
        private void ensureMaxResize()
        {
            ...
            if (!pannerContainerRectangle.contains(pannerViewRectangle))
            {
                ...
                if (r.width < pannerViewRectangle.width)
                {
                    ...
                    pannerViewRectangle.height = pannerViewRectangle.width * pannerViewRectangleCopy.height / pannerViewRectangleCopy.width;
                }
                if (r.height < pannerViewRectangle.height)
                {
                    pannerViewRectangle.height = r.height;
                    pannerViewRectangle.width = pannerViewRectangle.height * pannerViewRectangleCopy.width / pannerViewRectangleCopy.height;
                }
            }
        }
