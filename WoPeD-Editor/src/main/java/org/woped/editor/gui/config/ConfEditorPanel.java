 ...
 *     <br>
 *     The <code>ConfEditorPanel</code> is the <code>AbstractConfPanel</code> for the configuration
 *     of the editor. <br>
...
public class ConfEditorPanel extends AbstractConfPanel {
  ...
  private static final Object[] arrowWidth = {
    new String("default"),
    new Integer(1),
    new Integer(2),
    new Integer(3),
  ...
  private static final Object[] arrowHeadSize = {
    new String("default"),
    new Integer(1),
    new Integer(2),
    new Integer(3),
  ...
  public boolean applyConfiguration() {
    ...
    ConfigurationManager.getConfiguration()
        .setInsertCOPYwhenCopied(getInsertCopyCheckBox().isSelected());
    ConfigurationManager.getConfiguration().setShowGrid(getShowGridCheckBox().isSelected());
    ConfigurationManager.getConfiguration()
        .setArrowheadSize(getArrowheadSizeJComboBox().getSelectedIndex());
    ConfigurationManager.getConfiguration()
        .setArrowWidth(getArrowWidthJComboBox().getSelectedIndex());
    ConfigurationManager.getConfiguration()
        .setFillArrowHead(getArrowFillHeadCheckBox().isSelected());

    boolean changed =
        !lnfClasses
            .get(getLnfChooser().getSelectedItem())
            .equals(ConfigurationManager.getConfiguration().getLookAndFeel());
  ...
  public void readConfiguration() {
    ...
    getInsertCopyCheckBox()
        .setSelected(ConfigurationManager.getConfiguration().isInsertCOPYwhenCopied());
    getShowGridCheckBox().setSelected(ConfigurationManager.getConfiguration().isShowGrid());
    if (ConfigurationManager.getConfiguration().getArrowheadSize()
        == ConfigurationManager.getStandardConfiguration().getArrowheadSize())
      ...
      getArrowheadSizeJComboBox()
          .setSelectedItem(
              arrowHeadSize[ConfigurationManager.getConfiguration().getArrowheadSize()]);
    if (ConfigurationManager.getConfiguration().getArrowWidth()
        == ConfigurationManager.getStandardConfiguration().getArrowWidth())
      ...
      getArrowWidthJComboBox()
          .setSelectedItem(arrowWidth[ConfigurationManager.getConfiguration().getArrowWidth()]);
    getArrowFillHeadCheckBox()
        .setSelected(ConfigurationManager.getConfiguration().isFillArrowHead());
    try {
  ...
  private JCheckBox getEditOnCreationCheckBox() {
    if (editOnCreationCheckBox == null) {
      ...
      editOnCreationCheckBox.setText(
          Messages.getString("Configuration.Editor.Panel.SmartEdit.Text.SmartNameEditing"));
      editOnCreationCheckBox.setToolTipText(
          "<html>"
              + Messages.getString(
                  "Configuration.Editor.Panel.SmartEdit.Text.SmartNameEditing.ToolTip")
              + "</html>");
    }
  ...
  private JCheckBox getInsertCopyCheckBox() {
    if (insertCopyCheckBox == null) {
      ...
      insertCopyCheckBox.setText(
          Messages.getString("Configuration.Editor.Panel.SmartEdit.Text.Add_copy"));
      insertCopyCheckBox.setToolTipText(
          "<html>"
              + Messages.getString("Configuration.Editor.Panel.SmartEdit.Text.Add_copy.ToolTip")
              + "</html>");
    }
  ...
  private JCheckBox getSmartEditingCheckBox() {
    if (smartEditingCheckBox == null) {
      ...
      smartEditingCheckBox.setText(
          Messages.getString("Configuration.Editor.Panel.SmartEdit.Text.SmartArcDrawing"));
      smartEditingCheckBox.setToolTipText(
          "<html>"
              + Messages.getString(
                  "Configuration.Editor.Panel.SmartEdit.Text.SmartArcDrawing.ToolTip")
              + "</html>");
    }
  ...
  private JCheckBox getShowGridCheckBox() {
    if (showGridCheckBox == null) {
      ...
      showGridCheckBox.setToolTipText(
          "<html>"
              + Messages.getString("Configuration.Editor.Panel.Grid.Text.ShowGrid")
              + "</html>");
    }
  ...
  private JPanel getOnCreationPanel() {
    if (onCreationPanel == null) {
      ...
      onCreationPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Editor.Panel.SmartEdit.Title")),
  ...
  private JPanel getGeneralPanel() {
    if (generalPanel == null) {
      ...
      generalPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Editor.Panel.LNF.Title")),
              BorderFactory.createEmptyBorder(5, 5, 10, 5)));
  ...
  private JComboBox getLnfChooser() {
    if (lnfChooser == null) {
      ...
      lnfChooser.setToolTipText(
          "<html>" + Messages.getString("Configuration.Editor.Panel.LNF.Tooltip") + "</html>");
    }
    return lnfChooser;
  }
  ...
  private JPanel getArcPanel() {
    if (arcPanel == null) {
      ...
      arcPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.Editor.Panel.Arcs.Title")),
              BorderFactory.createEmptyBorder(5, 5, 10, 5)));
  ...
  private JLabel getArrowWidthJLabel() {
    if (arrowWidthJLabel == null) {
      arrowWidthJLabel =
          new JLabel(Messages.getString("Configuration.Editor.Panel.Arcs.Label.LineWidth"));
      arrowWidthJLabel.setToolTipText(
          "<html>"
              + Messages.getString("Configuration.Editor.Panel.Arcs.Label.LineWidth.ToolTip")
              + "</html>");
    }
  ...
  private JComboBox getArrowWidthJComboBox() {
    if (arrowWidthJComboBox == null) {
      ...
      arrowWidthJComboBox.setToolTipText(
          "<html>"
              + Messages.getString("Configuration.Editor.Panel.Arcs.Label.LineWidth.ToolTip")
              + "</html>");
    }
  ...
  private JLabel getArrowheadSizeJLabel() {
    if (arrowheadSizeJLabel == null) {
      arrowheadSizeJLabel =
          new JLabel(Messages.getString("Configuration.Editor.Panel.Arcs.Label.ArrowHeadSize"));
      arrowheadSizeJLabel.setToolTipText(
          "<html>"
              + Messages.getString("Configuration.Editor.Panel.Arcs.Label.ArrowHeadSize.ToolTip")
              + "</html>");
    }
  ...
  private JComboBox getArrowheadSizeJComboBox() {
    if (arrowheadSizeJComboBox == null) {
      ...
      arrowheadSizeJComboBox.setToolTipText(
          "<html>"
              + Messages.getString("Configuration.Editor.Panel.Arcs.Label.ArrowHeadSize.ToolTip")
              + "</html>");
    }
  ...
  private JCheckBox getArrowFillHeadCheckBox() {
    if (arrowFillHeadCheckBox == null) {
      ...
      arrowFillHeadCheckBox.setText(
          Messages.getString("Configuration.Editor.Panel.Arcs.Text.FillArrowHeads"));
      arrowFillHeadCheckBox.setToolTipText(
          "<html>"
              + Messages.getString("Configuration.Editor.Panel.Arcs.Text.FillArrowHeads")
              + "</html>");
    }
