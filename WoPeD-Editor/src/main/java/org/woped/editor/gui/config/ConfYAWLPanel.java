...
public class ConfYAWLPanel extends AbstractConfPanel {
  ...
  public boolean applyConfiguration() {
    ...
    ConfigurationManager.getConfiguration()
        .setYAWLExportExplicitPlaces(getYAWLExportExplicitPlacesCheckBox().isSelected());
    ConfigurationManager.getConfiguration()
        .setYAWLExportGroups(getYAWLExportGroupsCheckBox().isSelected());
  ...
  public void readConfiguration() {
    ...
    getYAWLExportExplicitPlacesCheckBox()
        .setSelected(ConfigurationManager.getConfiguration().isYAWLExportExplicitPlaces());
    getYAWLExportGroupsCheckBox()
        .setSelected(ConfigurationManager.getConfiguration().isYAWLExportGroups());
  ...
  private JPanel getYAWLEnabledPanel() {
    if (YAWLEnabledPanel == null) {
      ...
      YAWLEnabledPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.YAWL.Panel.YAWL.Title")),
  ...
  private JPanel getYAWLOptionsPanel() {
    if (YAWLOptionsPanel == null) {
      ...
      GridBagConstraints c = new GridBagConstraints();
      c.anchor = GridBagConstraints.WEST;
      YAWLOptionsPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.YAWL.Panel.YAWL.Options.Title")),
  ...
  private JCheckBox getYAWLExportExplicitPlacesCheckBox() {
    if (yawlExportExplicitPlacesCheckBox == null) {
      ...
      yawlExportExplicitPlacesCheckBox.setText(
          Messages.getString("Configuration.YAWL.Panel.Export.ExplicitPlaces"));
      yawlExportExplicitPlacesCheckBox.setToolTipText(
          "<HTML>"
              + Messages.getString("Configuration.YAWL.Panel.Export.ExplicitPlaces.ToolTip")
              + "</HTML>");
    }
  ...
  private JCheckBox getYAWLExportGroupsCheckBox() {
    if (yawlExportGroupsCheckBox == null) {
      ...
      yawlExportGroupsCheckBox.setText(
          Messages.getString("Configuration.YAWL.Panel.Export.Groups"));
      yawlExportGroupsCheckBox.setToolTipText(
          "<HTML>"
              + Messages.getString("Configuration.YAWL.Panel.Export.Groups.ToolTip")
              + "</HTML>");
    }
  ...
  private JCheckBox getYAWLEnabledBox() {
    if (yawlEnabledBox == null) {
      ...
      yawlEnabledBox.setToolTipText(
          "<html>" + Messages.getString("Configuration.YAWL.Panel.Enabled.Tooltip") + "</html>");
