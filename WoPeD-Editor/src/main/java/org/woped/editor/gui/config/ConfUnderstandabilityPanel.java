 ...
 *     The ConfUnderstandabilityPanel is the configuration panel for WoPeD's understandability
 *     features. So far the configuration for the handle cluster coloring has been implemented.
 */
...
public class ConfUnderstandabilityPanel extends AbstractConfPanel {
  ...
  public boolean applyConfiguration() {
    ...
    ConfigurationManager.getConfiguration()
        .setAlgorithmMode(getAlgorithmModeComboBox().getSelectedIndex());
  ...
  public void readConfiguration() {
    ...
    getAlgorithmModeComboBox()
        .setSelectedIndex(ConfigurationManager.getConfiguration().getAlgorithmMode());
  }
      ...
      colorPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.ColorLayout.ColorPanel.Title")),
  ...
  private JPanel getcolorAlgoPanel() {
    if (colorAlgoPanel == null) {
      ...
      colorAlgoPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Configuration.ColorLayout.ColorAlgoPanel.Title")),
              BorderFactory.createEmptyBorder(5, 5, 10, 5)));
  ...
  private JButton getResetButton() {
    if (colorResetButton == null) {
      ...
      colorResetButton.addActionListener(
          new ActionListener() {
  ...
  private JLabel getAlgorithmModeLabel() {
    if (algorithmModeLabel == null) {
      algorithmModeLabel =
          new JLabel(
              Messages.getString("Configuration.ColorLayout.ColorAlgoPanel.Label.AlgorithmMode"));
    }
  ...
  private String[] getAlgorithmModes() {
    if (algorithmModes == null) {
      ...
      algorithmModes[0] =
          Messages.getString("Configuration.ColorLayout.ColorAlgoPanel.CombBox.AlgorithmMode.Op0");
      algorithmModes[1] =
          Messages.getString("Configuration.ColorLayout.ColorAlgoPanel.CombBox.AlgorithmMode.Op1");
      algorithmModes[2] =
          Messages.getString("Configuration.ColorLayout.ColorAlgoPanel.CombBox.AlgorithmMode.Op2");
    }
  ...
  private void setUnderstandColors() {
    // save to XML file
    ConfigurationManager.getConfiguration()
        .setColor1(colorLabelCollection[0].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor2(colorLabelCollection[1].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor3(colorLabelCollection[2].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor4(colorLabelCollection[3].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor5(colorLabelCollection[4].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor6(colorLabelCollection[5].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor7(colorLabelCollection[6].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor8(colorLabelCollection[7].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor9(colorLabelCollection[8].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor10(colorLabelCollection[9].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor11(colorLabelCollection[10].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor12(colorLabelCollection[11].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor13(colorLabelCollection[12].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor14(colorLabelCollection[13].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor15(colorLabelCollection[14].getBackground().getRGB());
    ConfigurationManager.getConfiguration()
        .setColor16(colorLabelCollection[15].getBackground().getRGB());
  ...
  static class NewColorChooser extends JColorChooser {
    ...
    public static Color showDialog1(Component component, String title, Color initialColor)
