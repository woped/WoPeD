...
public class Receive extends BaseActivity<TReceive> {
   ...
   * @param Variable
   */
  public Receive(String Name, String PartnerLink, String Opetration, String Variable) {
    this(Name);
   ...
   * @param Variable
   */
  public final void fillReceive(String PartnerLink, String Operation, String Variable) {
  ...
  public BaseActivity<?> saveInformation(BPELadditionalPanel bip) {
    ...
    this.fillReceive(panel.getPartnerLink(), panel.getOperation(), panel.getVariable());
    return this;
  }
