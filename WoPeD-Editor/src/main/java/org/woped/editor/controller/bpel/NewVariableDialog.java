...
public class NewVariableDialog extends JDialog {
  ...
  /**
   * @param arg0 TransitionPropertyEditor
   * @param arg1 boolean
   * @throws HeadlessException
   */
  public NewVariableDialog(TransitionPropertyEditor Editor) throws HeadlessException {
    super(Editor, true);
    this._editor = Editor;
    this.init();
  }
  ...
  public void init() {
    ...
    this.setTitle(Messages.getString("Transition.Properties.BPEL.NewVariable"));
  ...
  public JPanel addVariableDialogButtons() {
    if (dialogButtons == null) {
      ...
      c.gridwidth = 1;
      c.insets = new Insets(0, 5, 0, 0);
      JButton b = new JButton(Messages.getString("Transition.Properties.BPEL.Buttons.OK"));
      b.addActionListener(new ButtonEvent(this, NewVariableDialog._OKBUTTON));
      ...
      c.gridwidth = 1;
      c.insets = new Insets(0, 5, 0, 0);
      b = new JButton(Messages.getString("Transition.Properties.BPEL.Buttons.Cancel"));
      b.addActionListener(new ButtonEvent(this, NewVariableDialog._CANCELBUTTON));
      dialogButtons.add(b, c);
    }
  ...
  public boolean isInputOk() {
    BpelVariableList list =
        this._editor.getEditor().getModelProcessor().getElementContainer().getVariableList();
    ...
    if (list.findBpelVaraibleByName(this.VariableName.getText()) != null) {
      new PopUpDialog(
              this, true, "Fehler", "Fehler: Die zu erstellende Bpel-Variable existiert bereits!")
          .setVisible(true);
      return false;
    }
    return true;
  ...
  class ButtonEvent implements ActionListener {
    ...
    public void actionPerformed(ActionEvent arg0) {
      if (this._buttontype == NewVariableDialog._OKBUTTON) {
        if (!this._adaptee.isInputOk()) return;
        this._adaptee
            .getTransitionPropertyEditor()
            .getEditor()
            .getModelProcessor()
            .getElementContainer()
            .addVariable(
