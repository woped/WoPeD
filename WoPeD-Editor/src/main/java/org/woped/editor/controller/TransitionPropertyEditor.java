...
public class TransitionPropertyEditor extends JDialog implements ActionListener, IDialog {
  ...
  private static final String COMBOBOX_YEARS_TEXT =
      Messages.getString("Transition.Properties.Years");
  private static final String COMBOBOX_MONTHS_TEXT =
      Messages.getString("Transition.Properties.Months");
  private static final String COMBOBOX_WEEKS_TEXT =
      Messages.getString("Transition.Properties.Weeks");
  private static final String COMBOBOX_DAYS_TEXT = Messages.getString("Transition.Properties.Days");
  private static final String COMBOBOX_HOURS_TEXT =
      Messages.getString("Transition.Properties.Hours");
  private static final String COMBOBOX_MINUTES_TEXT =
      Messages.getString("Transition.Properties.Minutes");
  private static final String COMBOBOX_SECONDS_TEXT =
      Messages.getString("Transition.Properties.Seconds");
  private static final String[] serviceTimeValues = {
    COMBOBOX_SECONDS_TEXT,
    COMBOBOX_MINUTES_TEXT,
    COMBOBOX_HOURS_TEXT,
    COMBOBOX_DAYS_TEXT,
    COMBOBOX_WEEKS_TEXT,
    COMBOBOX_MONTHS_TEXT,
    COMBOBOX_YEARS_TEXT
  };
  private static final String TRIGGER_NONE =
      Messages.getString("Transition.Properties.Trigger.None");
  private static final String TRIGGER_MESSAGE =
      Messages.getString("Transition.Properties.Trigger.Message");
  private static final String TRIGGER_RESOURCE =
      Messages.getString("Transition.Properties.Trigger.Resource");
  private static final String TRIGGER_TIME =
      Messages.getString("Transition.Properties.Trigger.Time");
  private static final String ORIENTATION_NORTH =
      Messages.getString("Transition.Properties.Orientation.North");
  private static final String ORIENTATION_EAST =
      Messages.getString("Transition.Properties.Orientation.East");
  private static final String ORIENTATION_SOUTH =
      Messages.getString("Transition.Properties.Orientation.South");
  private static final String ORIENTATION_WEST =
      Messages.getString("Transition.Properties.Orientation.West");
  ...
  public TransitionPropertyEditor(
      Frame owner, Point position, TransitionModel transition, EditorVC editor) {
    super(owner, true);
  ...
  private JPanel getNamePanel() {
    if (namePanel == null) {
      ...
      TitledBorder border =
          new TitledBorder(Messages.getString("Transition.Properties.Identification"));
      namePanel.setBorder(
          BorderFactory.createCompoundBorder(border, BorderFactory.createEmptyBorder(5, 5, 0, 5)));
  ...
  private void setTriggerConfiguration() {
    if (transition.getToolSpecific().getTrigger() == null) {
      ...
      if (transition.getToolSpecific().getTrigger().getTriggertype()
      ...
      } else if (transition.getToolSpecific().getTrigger().getTriggertype()
  ...
  private JPanel getOrientationPanel() {
    if (orientationPanel == null) {
      ...
      TitledBorder border =
          new TitledBorder(Messages.getString("Transition.Properties.Orientation"));
      ...
      getOrientationNorthRadioButton()
          .addActionListener(
              new ActionListener() {
      ...
      getOrientationSouthRadioButton()
          .addActionListener(
              new ActionListener() {
                public void actionPerformed(ActionEvent arg0) {
  ...
  public void flipNameResourceTrigger(
      TransitionModel selectedTransition, OperatorPosition oldposition) {
    ...
    if (currentPosition == 0 || currentPosition == 2) {
      selectedTransition
          .getNameModel()
          .setPosition(
              selectedTransition.getX() + selectedTransition.getWidth(), selectedTransition.getY());
      if (selectedTransition.hasTrigger()) {
        selectedTransition
            .getToolSpecific()
            .setTrigger(selectedTransition.getToolSpecific().getTrigger())
            .setPosition(selectedTransition.getX() - 25, selectedTransition.getY() + 10);
      }
      if (selectedTransition.hasResource()) {
        selectedTransition
            .getToolSpecific()
            .setTransResource(selectedTransition.getToolSpecific().getTransResource())
            .setPosition(selectedTransition.getX() - 65, selectedTransition.getY() - 17);
      }
    }
    // East and West
      ...
      if (selectedTransition.hasTrigger()) {
        selectedTransition
            .getToolSpecific()
            .setTrigger(selectedTransition.getToolSpecific().getTrigger())
            .setPosition(selectedTransition.getX() + 10, selectedTransition.getY() - 20);
      }
      if (selectedTransition.hasResource()) {
        selectedTransition
            .getToolSpecific()
            .setTransResource(selectedTransition.getToolSpecific().getTransResource())
            .setPosition(selectedTransition.getX() + 10, selectedTransition.getY() - 47);
      }
    }
  ...
  private void setOrientationConfiguration() {
    if (transition.getToolSpecific().getOperatorPosition() == OperatorPosition.NORTH) {
      ...
      actionPerformed(new ActionEvent(getOrientationNorthRadioButton(), -1, ORIENTATION_NORTH));
      ...
      actionPerformed(new ActionEvent(getOrientationEastRadioButton(), -1, ORIENTATION_EAST));
      ...
      actionPerformed(new ActionEvent(getOrientationSouthRadioButton(), -1, ORIENTATION_SOUTH));
      ...
      actionPerformed(new ActionEvent(getOrientationWestRadioButton(), -1, ORIENTATION_WEST));
    }
  }

  private JLabel getOrientationIcon() {
    if (orientationIcon == null) {
      orientationIcon = new JLabel(Messages.getImageIcon("Popup.Add.Orientation"));
    }
  ...
  private JRadioButton getBranchingNoneRadioButton() {
    if (branchingNoneRadioButton == null) {
      branchingNoneRadioButton =
          new JRadioButton(Messages.getString("Transition.Properties.Branching.None"));
      branchingNoneRadioButton.setActionCommand(
  ...
  private JRadioButton getBranchingAndJoinRadioButton() {
    if (branchingAndJoinRadioButton == null) {
      branchingAndJoinRadioButton =
          new JRadioButton(Messages.getString("Transition.Properties.Branching.AndJoin"));
      branchingAndJoinRadioButton.setActionCommand(
  ...
  private JRadioButton getBranchingAndSplitRadioButton() {
    if (branchingAndSplitRadioButton == null) {
      branchingAndSplitRadioButton =
          new JRadioButton(Messages.getString("Transition.Properties.Branching.AndSplit"));
      branchingAndSplitRadioButton.setActionCommand(
  ...
  private JRadioButton getBranchingAndSplitJoinRadioButton() {
    if (branchingAndSplitJoinRadioButton == null) {
      branchingAndSplitJoinRadioButton =
          new JRadioButton(Messages.getString("Transition.Properties.Branching.AndSplitJoin"));
      branchingAndSplitJoinRadioButton.setActionCommand(
  ...
  private JRadioButton getBranchingXorSplitRadioButton() {
    if (branchingXorSplitRadioButton == null) {
      branchingXorSplitRadioButton =
          new JRadioButton(Messages.getString("Transition.Properties.Branching.XorSplit"));
      branchingXorSplitRadioButton.setActionCommand(
  ...
  private JRadioButton getBranchingXorJoinRadioButton() {
    if (branchingXorJoinRadioButton == null) {
      branchingXorJoinRadioButton =
          new JRadioButton(Messages.getString("Transition.Properties.Branching.XorJoin"));
      branchingXorJoinRadioButton.setActionCommand(
  ...
  private JRadioButton getBranchingXorSplitJoinRadioButton() {
    if (branchingXorSplitJoinRadioButton == null) {
      branchingXorSplitJoinRadioButton =
          new JRadioButton(Messages.getString("Transition.Properties.Branching.XorSplitJoin"));
      branchingXorSplitJoinRadioButton.setActionCommand(
  ...
  private JRadioButton getBranchingAndJoinXorSplitRadioButton() {
    if (branchingAndJoinXorSplitRadioButton == null) {
      branchingAndJoinXorSplitRadioButton =
          new JRadioButton(Messages.getString("Transition.Properties.Branching.AndJoinXorSplit"));
      branchingAndJoinXorSplitRadioButton.setActionCommand(
  ...
  private JRadioButton getBranchingXorJoinAndSplitRadioButton() {
    if (branchingXorJoinAndSplitRadioButton == null) {
      branchingXorJoinAndSplitRadioButton =
          new JRadioButton(Messages.getString("Transition.Properties.Branching.XorJoinAndSplit"));
      branchingXorJoinAndSplitRadioButton.setActionCommand(
  ...
  private JPanel getBranchingXorSplitJoinEntry() {
    if (branchingXorSplitJoinEntry == null) {
      ...
      JPanel j1 = new JPanel();
      j1.setLayout(new BorderLayout());
      j1.add(getBranchingXorSplitJoinRadioButton(), BorderLayout.LINE_START);
      JPanel j2 = new JPanel();
      j2.setLayout(new BorderLayout());
      ...
      branchingXorSplitJoinEntry.add(new JLabel("  "), BorderLayout.LINE_END);
    }
  ...
  private JPanel getBranchingAndJoinXorSplitEntry() {
    if (branchingAndJoinXorSplitEntry == null) {
      ...
      JPanel j1 = new JPanel();
      j1.setLayout(new BorderLayout());
      j1.add(getBranchingAndJoinXorSplitRadioButton(), BorderLayout.LINE_START);
      JPanel j2 = new JPanel();
      j2.setLayout(new BorderLayout());
      ...
      branchingAndJoinXorSplitEntry.add(new JLabel("  "), BorderLayout.LINE_END);
    }
  ...
  private JPanel getBranchingXorJoinAndSplitEntry() {
    if (branchingXorJoinAndSplitEntry == null) {
      ...
      JPanel j1 = new JPanel();
      j1.setLayout(new BorderLayout());
      j1.add(getBranchingXorJoinAndSplitRadioButton(), BorderLayout.LINE_START);
      JPanel j2 = new JPanel();
      j2.setLayout(new BorderLayout());
      ...
      branchingXorJoinAndSplitEntry.add(new JLabel("  "), BorderLayout.LINE_END);
    }
  ...
  private JLabel getBranchingAndJoinXorSplitIcon() {
    if (branchingAndJoinXorSplitIcon == null)
      branchingAndJoinXorSplitIcon = new JLabel(Messages.getImageIcon("Popup.Add.AndJoinXorSplit"));
    return branchingAndJoinXorSplitIcon;
  }

  private JLabel getBranchingXorJoinAndSplitIcon() {
    if (branchingXorJoinAndSplitIcon == null)
      branchingXorJoinAndSplitIcon = new JLabel(Messages.getImageIcon("Popup.Add.XorJoinAndSplit"));
  ...
  private JPanel getServicetimePanel() {
    if (serviceTimePanel == null) {
      ...
      TitledBorder border =
          new TitledBorder(Messages.getString("Transition.Properties.ServiceTime"));
      serviceTimePanel.setBorder(
          BorderFactory.createCompoundBorder(border, BorderFactory.createEmptyBorder(5, 5, 0, 5)));
  ...
  private JLabel getserviceTimeLabel() {
    if (serviceTimeLabel == null) {
      serviceTimeLabel = new JLabel(Messages.getString("Transition.Properties.Average") + ":");
    }
  ...
  private JTextField getserviceTimeTextfield() {
    if (serviceTimeTextField == null) {
      ...
      serviceTimeTextField.setText(Integer.toString(transition.getToolSpecific().getTime()));
  ...
  private JComboBox<String> getserviceTimeComboBox() {
    if (serviceTimeComboBox == null) {
      ...
      serviceTimeComboBox.setSelectedIndex(transition.getToolSpecific().getTimeUnit());
  ...
  private JPanel getResourcePanel() {
    if (resourcePanel == null) {
      ...
      TitledBorder border =
          new TitledBorder(Messages.getString("Transition.Properties.ResourceAssignment"));
  ...
  private JLabel getNumResourcesLabel() {
    if (numResourcesLabel == null) {
      numResourcesLabel =
          new JLabel(Messages.getString("Transition.Properties.AssignedResources") + ": ");
    }
  ...
  private JLabel getResourceGroupLabel() {
    if (resourceGroupLabel == null) {
      resourceGroupLabel =
          new JLabel(" " + Messages.getString("Transition.Properties.Group") + ": ");
    }
  ...
  private DefaultComboBoxModel<String> getRoleComboxBoxModel() {
    if (roleComboBoxModel == null) {
      if (getEditor().getModelProcessor().getRoles() != null) {
        ...
        for (Iterator<ResourceClassModel> iter =
                getEditor().getModelProcessor().getRoles().iterator();
            iter.hasNext(); ) {
  ...
  private DefaultComboBoxModel<String> getGroupComboxBoxModel() {
    if (groupComboBoxModel == null) {
      if (getEditor().getModelProcessor().getOrganizationUnits() != null) {
        ...
        for (Iterator<ResourceClassModel> iter =
                getEditor().getModelProcessor().getOrganizationUnits().iterator();
            iter.hasNext(); ) {
  ...
  private JComboBox<String> getResourceRoleComboBox() {
    if (resourceRoleComboBox == null) {
      ...
      resourceRoleComboBox.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
              updateNumResources();
            }
  ...
  private JComboBox<String> getResourceGroupComboBox() {
    if (resourceGroupComboBox == null) {
      ...
      resourceGroupComboBox.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
              updateNumResources();
            }
  ...
  private JPanel getBPELPanel() {
    ...
    if (bpelPanel == null) {
      ...
      ((BPELadditionalPanel) this.activityChooseComboBox.getSelectedItem())
          .showPanel(this.getBPELPanel(), c2);
      this.repaint();
    }
  ...
  private JPanel getBPELActivityChoosePanel() {
    if (activityChoosePanel == null) {
      ...
      GridBagConstraints c = new GridBagConstraints();
      activityChoosePanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Transition.Properties.BPEL.ActivityChoice")),
  ...
  private JComboBox<BPELadditionalPanel> getActivityComboBox() {
    if (activityChooseComboBox == null) {
      ...
      if (Empty.class.isInstance(this.transition.getBpelData())
        ...
        this.activityChooseComboBox.setSelectedItem(this.getAssignPanel());
      else if (Invoke.class.isInstance(this.transition.getBpelData()))
        this.activityChooseComboBox.setSelectedItem(this.getInvokePanel());
      else if (Receive.class.isInstance(this.transition.getBpelData()))
        this.activityChooseComboBox.setSelectedItem(this.getReceivePanel());
      else if (Reply.class.isInstance(this.transition.getBpelData()))
        this.activityChooseComboBox.setSelectedItem(this.getReplyPanel());
      else if (Wait.class.isInstance(this.transition.getBpelData()))
        this.activityChooseComboBox.setSelectedItem(this.getWaitPanel());

      activityChooseComboBox.addItemListener(
          new ItemListener() {
  ...
  private JLabel getActivityLabel() {
    if (activityChooseLabel == null) {
      activityChooseLabel =
          new JLabel(Messages.getString("Transition.Properties.BPEL.Activity") + ":");
    }
  ...
  private BPELassignPanel getAssignPanel() {
    if (assignPanel == null) {
      ...
      assignPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Transition.Properties.BPEL.Assign")),
              BorderFactory.createEmptyBorder(5, 5, 0, 5)));
    }
  ...
  private BPELinvokePanel getInvokePanel() {
    if (invokePanel == null) {
      ...
      invokePanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Transition.Properties.BPEL.Invoke")),
              BorderFactory.createEmptyBorder(5, 5, 0, 5)));
    }
  ...
  private BPELreceivePanel getReceivePanel() {
    if (receivePanel == null) {
      ...
      receivePanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Transition.Properties.BPEL.Receive")),
              BorderFactory.createEmptyBorder(5, 5, 0, 5)));
    }
  ...
  private BPELreplyPanel getReplyPanel() {
    if (replyPanel == null) {
      ...
      replyPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Transition.Properties.BPEL.Reply")),
              BorderFactory.createEmptyBorder(5, 5, 0, 5)));
    }
  ...
  private BPELwaitPanel getWaitPanel() {
    if (waitPanel == null) {
      ...
      waitPanel.setBorder(
          BorderFactory.createCompoundBorder(
              BorderFactory.createTitledBorder(
                  Messages.getString("Transition.Properties.BPEL.Wait")),
              BorderFactory.createEmptyBorder(5, 5, 0, 5)));
    }
      ...
      buttonOk.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              ...
              //				((BPELadditionalPanel)
              // activityChooseComboBox.getSelectedItem()).saveInfomation();
  ...
  private void apply() {
    ...
    // info
    DefaultGraphCell trigger =
        transition.hasTrigger() ? transition.getToolSpecific().getTrigger() : null;
    DefaultGraphCell resource =
        transition.hasResource() ? transition.getToolSpecific().getTransResource() : null;
    if (trigger != null) {
    ...
    if (command.equals(Messages.getString("Transition.Properties.Branching.None"))
      ...
      transformTransition(
          AbstractPetriNetElementModel.TRANS_OPERATOR_TYPE, OperatorTransitionModel.AND_JOIN_TYPE);
      ...
      transformTransition(
          AbstractPetriNetElementModel.TRANS_OPERATOR_TYPE, OperatorTransitionModel.AND_SPLIT_TYPE);
      ...
      transformTransition(
          ...
          OperatorTransitionModel.AND_SPLITJOIN_TYPE);
      ...
      transformTransition(
          AbstractPetriNetElementModel.TRANS_OPERATOR_TYPE, OperatorTransitionModel.XOR_SPLIT_TYPE);
      ...
      transformTransition(
          AbstractPetriNetElementModel.TRANS_OPERATOR_TYPE, OperatorTransitionModel.XOR_JOIN_TYPE);
    } else if (command.equals(Messages.getString("Transition.Properties.Branching.XorSplitJoin"))
        && type != OperatorTransitionModel.XORJOIN_XORSPLIT_TYPE) {
      transformTransition(
          AbstractPetriNetElementModel.TRANS_OPERATOR_TYPE,
          OperatorTransitionModel.XORJOIN_XORSPLIT_TYPE);
      ...
      transformTransition(
          AbstractPetriNetElementModel.TRANS_OPERATOR_TYPE,
          OperatorTransitionModel.ANDJOIN_XORSPLIT_TYPE);
      ...
      transformTransition(
          AbstractPetriNetElementModel.TRANS_OPERATOR_TYPE,
          OperatorTransitionModel.XORJOIN_ANDSPLIT_TYPE);
    }
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getActionCommand().equals(Messages.getString("Transition.Properties.Branching.None"))) {
      getOrientationEastRadioButton().setEnabled(false);
      getOrientationWestRadioButton().setEnabled(false);
      getOrientationNorthRadioButton().setEnabled(false);
      getOrientationSouthRadioButton().setEnabled(false);
    ...
    if (e.getActionCommand().equals(Messages.getString("Transition.Properties.Branching.AndJoin"))
        || e.getActionCommand()
            .equals(Messages.getString("Transition.Properties.Branching.AndSplit"))
        || e.getActionCommand()
            .equals(Messages.getString("Transition.Properties.Branching.AndSplitJoin"))
        || e.getActionCommand()
            .equals(Messages.getString("Transition.Properties.Branching.XorSplit"))
        || e.getActionCommand()
            .equals(Messages.getString("Transition.Properties.Branching.XorJoin"))
        || e.getActionCommand()
            .equals(Messages.getString("Transition.Properties.Branching.XorSplitJoin"))
        || e.getActionCommand()
            .equals(Messages.getString("Transition.Properties.Branching.AndJoinXorSplit"))
        || e.getActionCommand()
            .equals(Messages.getString("Transition.Properties.Branching.XorJoinAndSplit"))) {
  ...
  private void transformTransition(int nodeType, int operatorType) {
    ...
    while (arcIterator.hasNext()) {
      ...
      if (curArc.getSourceId().equals(oldMap.getId())) outAcrs.add(curArc.getCreationMap());

      if (curArc.getTargetId().equals(oldMap.getId())) incAcrs.add(curArc.getCreationMap());
    }
    ...
    for (int i = 0; i < incAcrs.size(); i++) editor.createArc(incAcrs.get(i), true);
