 ...
 *     an "assign" BPEL activity.
 *     <p>Created on 15.01.2008
 */
public class BPELassignPanel extends BPELadditionalPanel {
  ...
  private JButton getNewFromVariableButton() {
    if (newFromVariableButton == null) {
      ...
      newFromVariableButton.addActionListener(
          new ActionListener() {
  ...
  private JButton getNewToVariableButton() {
    if (newToVariableButton == null) {
      ...
      newToVariableButton.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              NewVariableDialog dialog = new NewVariableDialog(t_editor);
              if (dialog.getActivButton() == NewVariableDialog._OKBUTTON) {
  ...
  public String getFromVariable() {
    if (fromVariableComboBox.getSelectedItem() == null
        || !BpelVariable.class.isInstance(fromVariableComboBox.getSelectedItem())) return "";
  ...
  public void refresh() {
    ...
    if (Assign.class.isInstance(this.transition.getBpelData())) {
      ...
      ModelElementContainer model =
          this.t_editor.getEditor().getModelProcessor().getElementContainer();
  ...
  public void saveInfomation() {
    if (allFieldsFilled() == false) {
      ...
      this.transition.setBaseActivity(
          new Assign(this.transition.getNameValue(), this.getFromVariable(), this.getToVariable()));
    }
  }
