 ...
 *     <p>Created on: 16.03.2005 Last Change on: 16.03.2005
 */
...
public class WoPeDUndoManager extends GraphUndoManager {
  ...
  public void undoableEditHappened(UndoableEditEvent e) {
    ...
    VisualController.getInstance()
        .propertyChange(new PropertyChangeEvent(this, "UndoRedo", null, null));
  }
  ...
  public void undo(Object arg0) {
    Boolean doIt = true;
    if (arg0 == null || !isInProgress()) super.undo();
    else {
  ...
  public void redo(Object arg0) {
    Boolean doIt = true;
    if (arg0 == null || !isInProgress()) super.redo();
    else {
  ...
  public synchronized boolean addEdit(UndoableEdit arg0) {
    if (m_enabled) return super.addEdit(arg0);
  ...
  public boolean canUndo(ModelElementContainer container) {
    if (super.canUndo()) {
      ...
      if (edit.getInserted() != null) return (container.getIdMap().size() > 2);
      else return true;
    }
    return false;
  }
