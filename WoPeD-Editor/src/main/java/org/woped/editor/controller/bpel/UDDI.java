 ...
 *     <p>This is the basic utility-class to connect a UDDI-server. It contains methods to find
 *     businesses and their according offered services.
 *     <p>Created on 10.02.2008
 */
public class UDDI {
  public static String[] find_business(String uddiUrl, String businessName) {
    ...
    // To configure a profile, enable the appropriate set of properties like in the following
    // examples:
