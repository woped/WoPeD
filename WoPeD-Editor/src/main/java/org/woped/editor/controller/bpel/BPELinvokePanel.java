 ...
 *     an "invoke" BPEL activity.
 *     <p>Created on 08.01.2008
 */
public class BPELinvokePanel extends BPELadditionalPanel {
  ...
  private JButton getNewInVariableButton() {
    if (newInVariableButton == null) {
      ...
      newInVariableButton.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
  ...
  private JButton getNewOutVariableButton() {
    if (newOutVariableButton == null) {
      ...
      newOutVariableButton.addActionListener(
          new ActionListener() {
            public void actionPerformed(ActionEvent e) {
              NewVariableDialog dialog = new NewVariableDialog(t_editor);
              if (dialog.getActivButton() == NewVariableDialog._OKBUTTON) {
  ...
  public String getInVariable() {
    if (inVariableComboBox.getSelectedItem() == null) return "";
    return inVariableComboBox.getSelectedItem().toString();
  }

  public String getOutVariable() {
    if (outVariableComboBox.getSelectedItem() == null) return "";
  ...
  public boolean allFieldsFilled() {
    if (partnerLinkComboBox.getSelectedIndex() == 0
        ...
        || outVariableComboBox.getSelectedIndex() == 0) return false;
    return true;
  }
  ...
  public void refresh() {
    ...
    if (Invoke.class.isInstance(this.transition.getBpelData())) {
      ...
      this.inVariableComboBox.setSelectedItem(
          this.t_editor
              .getEditor()
              .getModelProcessor()
              .getElementContainer()
              .findBpelVariableByName(in.getInputVariable()));
      this.outVariableComboBox.setSelectedItem(
          this.t_editor
              .getEditor()
              .getModelProcessor()
              .getElementContainer()
              .findBpelVariableByName(in.getOutputVariable()));
