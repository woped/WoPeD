...
public class WsdlFileRepresentation {
   ...
   ************************************************/
  /**
   * Adds a "partner link type" to the internal ArrayList "partnerLinkTypes" which stores the
   * "partner link types".
   *
   * @param partnerLinkType An object of type "PartnerLinkType" which shall be added to the internal
   *     data storage.
   *     ********************************************************************************************************************
   */
