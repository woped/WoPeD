...
public class GraphTreeModel extends DefaultTreeModel
    implements GraphModelListener, TreeModelListener {
  ...
  public GraphTreeModel(IEditor currentEditor) {
    ...
    PopulateNode((NetInfo) getRoot(), parentEditor.getModelProcessor().getElementContainer());
    reload();
  }
  ...
  public void PopulateNode(NetInfo root, ModelElementContainer elements) {
