  ...
  public void createLayout(LogicalModel lm) {
    ...
    if (lm.allRoles.size() > 0) {
      ...
      if (lm.allCompoundRoles.size() == 1) {
        ...
        if (unrelatedRole == true) {
          CompoundRole allRoles =
              new CompoundRole(Messages.getString("PetriNet.Resources.AllCompoundRolesName"));
        ...
        CompoundRole cr =
            new CompoundRole(Messages.getString("PetriNet.Resources.DefaultCompoundRoleName"));
    ...
    if (lm.allGroups.size() > 0) {
      ...
      if (lm.allCompoundGroups.size() == 1) {
        ...
        if (unrelatedGroup == true) {
          CompoundGroup allGroups =
              new CompoundGroup(Messages.getString("PetriNet.Resources.AllCompoundGroupsName"));
        ...
        CompoundGroup cg =
            new CompoundGroup(Messages.getString("PetriNet.Resources.DefaultCompoundGroupName"));
