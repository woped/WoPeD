...
public class BPELwaitPanel extends BPELadditionalPanel implements ActionListener {
  ...
  private static final String WAIT_DURATION =
      Messages.getString("Transition.Properties.BPEL.Wait.Duration");

  private static final String WAIT_DEADLINE =
  ...
  private JPanel getDurationSubPanel() {
    if (durationSubPanel == null) {
      ...
      c.gridx = 0;
      c.gridy = 0;
      durationSubPanel.add(
          new JLabel(Messages.getString("Transition.Properties.BPEL.Wait.Years")), c);
      c.gridx = 1;
      c.gridy = 0;
      durationSubPanel.add(
          new JLabel(Messages.getString("Transition.Properties.BPEL.Wait.Months")), c);
      c.gridx = 2;
      c.gridy = 0;
      durationSubPanel.add(
          new JLabel(Messages.getString("Transition.Properties.BPEL.Wait.Days")), c);
      ...
      c.gridy = 2;
      durationSubPanel.add(
          new JLabel(Messages.getString("Transition.Properties.BPEL.Wait.Hours")), c);
      c.gridx = 1;
      c.gridy = 2;
      durationSubPanel.add(
          new JLabel(Messages.getString("Transition.Properties.BPEL.Wait.Minutes")), c);
      c.gridx = 2;
      c.gridy = 2;
      durationSubPanel.add(
          new JLabel(Messages.getString("Transition.Properties.BPEL.Wait.Seconds")), c);
  ...
  private JFormattedTextField getDeadlineInputfieldHour() {
    if (deadLineTextFieldHour == null) {
      ...
      this.deadLineHourFilter =
          new JTextFieldEvalution(this.deadLineTextFieldHour, null, new IntegerFilter(0, 23), null);
  ...
  private JFormattedTextField getDeadlineInputfieldMinute() {
    if (deadLineTextFieldMinute == null) {
      ...
      this.deadLineMinuteFilter =
          new JTextFieldEvalution(
              this.deadLineTextFieldMinute, null, new IntegerFilter(0, 59), null);
  ...
  private JFormattedTextField getDeadlineInputfieldSecond() {
    if (deadLineTextFieldSecond == null) {
      ...
      this.deadLineSecondFilter =
          new JTextFieldEvalution(
              this.deadLineTextFieldSecond, null, new IntegerFilter(0, 59), null);
  ...
  public String getDeadLineMonth() {
    if (deadLineTextFieldMinute.getText() == null) return null;
    Calendar c = Calendar.getInstance();
    c.setTime(calendar.getDate());
  ...
  public String getDeadLineHour() {
    if (deadLineTextFieldHour.getText() == null) return null;
  ...
  public String getDeadLineSecond() {
    if (deadLineTextFieldSecond.getText() == null) return null;
  ...
  public String getDurationYear() {
    if (durationTextFieldYear.getText() == null) return null;
    return durationTextFieldYear.getText();
  }

  public String getDurationMonth() {
    if (durationTextFieldMonth.getText() == null) return null;
    return durationTextFieldMonth.getText();
  }

  public String getDurationDay() {
    if (durationTextFieldDay.getText() == null) return null;
    return durationTextFieldDay.getText();
  }

  public String getDurationHour() {
    if (durationTextFieldHour.getText() == null) return null;
    return durationTextFieldHour.getText();
  }

  public String getDurationMinute() {
    if (durationTextFieldMinute.getText() == null) return null;
    return durationTextFieldMinute.getText();
  }

  public String getDurationSecond() {
    if (durationTextFieldSecond.getText() == null) return null;
  ...
  public boolean allFieldsFilled() {
    if (waitDeadlineRadioButton.isSelected()) {
      if (this.deadLineHourFilter.isInputAccepted()
          ...
          && this.deadLineSecondFilter.isInputAccepted()) return true;
      else return false;
    } else {
        ...
        if (waitDeadlineRadioButton.isSelected()) {
          ...
          this.transition.setBaseActivity(
              new Wait(
                      ...
                      Wait._DEADLINE,
                      Integer.parseInt(getDeadLineYear()),
                      Integer.parseInt(getDeadLineMonth()),
                      Integer.parseInt(getDeadLineDay()),
                      Integer.parseInt(getDeadLineHour()),
                      Integer.parseInt(getDeadLineMinute()),
        ...
        if (waitDurationRadioButton.isSelected()) {
          this.transition.setBaseActivity(
              new Wait(
                      this.transition.getNameValue(),
                      Wait._DURATION,
                      Integer.parseInt(getDurationYear()),
                      Integer.parseInt(getDurationMonth()),
                      Integer.parseInt(getDurationDay()),
                      Integer.parseInt(getDurationHour()),
                      Integer.parseInt(getDurationMinute()),
                      Integer.parseInt(getDurationSecond()))
                  .saveInformation(this));
        }
      } catch (Exception e) {
        e.printStackTrace();
