...
public class NewUddiVariableDialog extends JDialog {
   ...
   */
  public NewUddiVariableDialog(Dialog Dialog) throws HeadlessException {
    super(Dialog, true);
    this.init();
  }
  ...
  public void init() {
    ...
    this.setTitle(Messages.getString("Transition.Properties.BPEL.UDDI.CreateUDDITitle"));
    ...
    this.add(
        new JLabel(Messages.getString("Transition.Properties.BPEL.UDDI.VariableName") + ":"), c);
    ...
    c.insets = new Insets(0, 5, 0, 0);
    this.add(
        new JLabel(Messages.getString("Transition.Properties.BPEL.UDDI.VariableURL") + ":"), c);
    ...
    public void actionPerformed(ActionEvent arg0) {
      if (this._buttontype == NewUddiVariableDialog._OKBUTTON) {
        if (!this._adaptee.isInputOk()) {
          ...
          errorPopup.setLocation(
              this._adaptee.getLocation().x + 90, this._adaptee.getLocation().y + 50);
          ...
          errorPopup.add(
              new JLabel(Messages.getString("Transition.Properties.BPEL.ErrorDuringFieldCheck")),
              c);
          ...
          JButton okButton =
              new JButton(Messages.getString("Transition.Properties.BPEL.Buttons.OK"));
