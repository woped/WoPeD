...
/**
 * The Class <code>SGYElement</code> represents an Element/Transition in the Graph. It consists of a
 * reference to an <code>AbstractElementModel</code> and additive attributes necessary to do the
 * SugiyamaAlgortihm.
 *
...
public class SGYElement {
   ...
   *
   * @param aem the reference to the handled <code>AbstractElementModel</code>
   */
   ...
   *
   * @param aem the reference to the handled <code>AbstractElementModel</code>
   * @param isDummyVertex <code>true</code>, if this element is a dummy-vertex; <code>false</code>
   *     (standard) if not.
   * @param source the reference to the source <code>SGYElement</code>
   * @param target the reference to the target <code>SGYElement</code>
   */
  public SGYElement(
      AbstractPetriNetElementModel aem,
      boolean isDummyVertex,
      SGYElement source,
      SGYElement target) {
    this.editorElement = aem;
