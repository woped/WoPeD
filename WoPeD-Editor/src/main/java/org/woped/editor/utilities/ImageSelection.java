...
public class ImageSelection implements Transferable {
   ...
   *
   * @param newDiagramImage the Image to contain.
  ...
  public boolean isDataFlavorSupported(DataFlavor parFlavor) {
    return (parFlavor.getMimeType().equals(imageFlavor.getMimeType())
        && parFlavor.getHumanPresentableName().equals(imageFlavor.getHumanPresentableName()));
  }
