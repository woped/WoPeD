...
class ArcView extends EdgeView {
  ...
  /**
   * @author <a href="mailto:slandes@kybeidos.de">Simon Landes </a> <br>
   *     <p>this inner class contains the Renderer information of an transition
   *     <p>28.03.2003
   */
    ...
    public void paint(Graphics g) {
      ...
      if (edgeShape != null) {
        ...
        if (getGradientColor() != null && !preview) {
          g2.setPaint(
              new GradientPaint(
                  0, 0, getBackground(), getWidth(), getHeight(), getGradientColor(), true));
        }
        ...
        if (arc.displayWeight() && graph != null) {
          ...
          paintLabel(
              g,
              graph.convertValueToString(arc.getInscriptionValue()),
              labelPosition,
              simpleExtraLabels);
        }
        ...
        if (arc.isActivated()) {
          ...
          if (activeIcon != null) {
            g2.drawImage(
                ...
                iconWidth,
                iconHeight,
                activeIcon != null ? activeIcon.getImageObserver() : null);
          }
        }
      }
    }
