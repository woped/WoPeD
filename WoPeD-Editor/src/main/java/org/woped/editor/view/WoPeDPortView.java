...
public class WoPeDPortView extends PortView {
  ...
  private class PetriPortRenderer extends PortRenderer {
    ...
    /**
     * Paint the renderer. Overrides superclass paint to add specific painting. Note: The preview
     * flag is interpreted as "highlight" in this context. (This is used to highlight the port if
