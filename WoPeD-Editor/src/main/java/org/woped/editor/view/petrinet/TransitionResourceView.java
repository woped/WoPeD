...
public class TransitionResourceView extends AbstractElementView {
  ...
  class TransitionResourceRenderer extends VertexRenderer {
    public void paint(Graphics g) {
      ...
      g.fillRect(
          0,
          TransitionResourceModel.DEFAULT_HEIGHT / 2,
          TransitionResourceModel.DEFAULT_WIDTH - 1,
          TransitionResourceModel.DEFAULT_HEIGHT / 2 - 1);
      g.setColor(Color.BLACK);
      g.drawRect(
          0,
          TransitionResourceModel.DEFAULT_HEIGHT / 2,
      ...
      g2.drawString(
          ((TransitionResourceModel) TransitionResourceView.this.getCell()).getTransOrgUnitName(),
          2,
          (TransitionResourceModel.DEFAULT_HEIGHT / 2) - 1);
      g2.setFont(DefaultStaticConfiguration.DEFAULT_RESOURCE_ROLE_FONT);
      g2.drawString(
          ((TransitionResourceModel) TransitionResourceView.this.getCell()).getTransRoleName(),
          2,
          TransitionResourceModel.DEFAULT_HEIGHT - 2);
    }
  }
