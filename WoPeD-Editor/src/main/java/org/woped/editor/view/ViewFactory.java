  ...
  protected VertexView createVertexView(Object cell) {
    if (cell instanceof NameModel) {
      ...
      if (aTCell.getOperatorType() == OperatorTransitionModel.AND_SPLIT_TYPE) {
        ...
        LoggerManager.error(
            Constants.EDITOR_LOGGER, " Not known Aalst ViewType" + cell.getClass().toString());
        // return null;
      ...
      if (aTCell.getTriggertype() == TriggerModel.TRIGGER_MESSAGE) {
        ...
        LoggerManager.error(
            Constants.EDITOR_LOGGER, "Not known Trigger ViewType " + cell.getClass().toString());
        // return null;
        return super.createVertexView(cell);
      }
      ...
      return new VertexView(cell) {
        private VertexRenderer renderer =
            new VertexRenderer() {
      ...
      LoggerManager.error(
          Constants.EDITOR_LOGGER, "Not known ViewType " + cell.getClass().getName().toString());
      // return null;
      return super.createVertexView(cell);
    }
  }
