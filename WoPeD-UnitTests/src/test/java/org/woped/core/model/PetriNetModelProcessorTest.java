...
public class PetriNetModelProcessorTest {
  ...
  public void createArc_IdIsNull_arcIdNotNull() {
    ...
    ArcModel arc =
        sut.createArc(
            null, simpleDemoData.place1Id, simpleDemoData.transition1Id, new Point2D[0], true);
  ...
  public void createArc_IdExists_arcIdNotNull() {
    ...
    ArcModel arc =
        sut.createArc(
            arcId, simpleDemoData.place1Id, simpleDemoData.transition1Id, new Point2D[0], true);
  ...
  public void createArc_IdNotExists_suggestedIdIsUsed() {
    ...
    ArcModel arc =
        sut.createArc(
            expected, simpleDemoData.place1Id, simpleDemoData.transition1Id, new Point2D[0], true);
