...
public class TokenGameControllerTest {
  ...
  @Test
  public void
      executeOperators_sourceIsXorJoinSplitOperatorOutgoingArcTriggered_centerPlaceRemovesTokensAccordingToInnerArcWeight()
          throws Exception {
    ...
    XORJoinSplitOperatorTransitionModel t1 =
        (XORJoinSplitOperatorTransitionModel) container.getElementById(sourceId);
  ...
  @Test
  public void
      executeOperators_sourceIsXorJoinSplitOutgoingArcTriggered_targetPlaceReceivesTokensAccordingToOuterArcWeight()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void
      executeOperators_targetIsXorJoinSplitOperatorIncomingArcTriggered_centerPlaceReceivesTokensAccordingToInnerArcWeight()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
    ...
    XORJoinSplitOperatorTransitionModel t1 =
        (XORJoinSplitOperatorTransitionModel) container.getElementById(targetId);
    PlaceModel centerPlace = t1.getCenterPlace();

    ArcModel innerArc =
        t1.getSimpleTransContainer().findArc(innerTransitionId, centerPlace.getId());
  ...
  @Test
  public void
      executeOperators_targetIsXorJoinSplitOperatorIncomingArcTriggered_sourcePlaceRemovesTokensAccordingToOuterArcWeight()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void
      executeOperators_targetIsXorJoinSplitOperatorIncomingArcClicked_centerPlaceReceivesTokens()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
    ...
    clickedArc.setInscriptionValue(
        outerArcWeight); // outer arc weight does not influence inner arc weight
  ...
  @Test
  public void executeOperators_sourceIsXorJoinSplitOutgoingArcClicked_targetReceivesTokens()
      throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();

    XORJoinSplitOperatorTransitionModel transition =
        (XORJoinSplitOperatorTransitionModel) container.getElementById("t1");
  ...
  @Test
  public void reverseOperatorTransition_targetIsXorJoinOperator_sourceReceivesTokens()
      throws Exception {
    sut = createTestInstance(createXorJoinNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void reverseOperatorTransition_targetIsXorJoinOperator_targetPlaceRemovesTokens()
      throws Exception {
    sut = createTestInstance(createXorJoinNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void
      reverseOperatorTransition_targetIsXorJoinOperator_independentPlaceDoesNotReceiveTokens()
          throws Exception {
    sut = createTestInstance(createXorJoinNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void
      reverseOperatorTransition_targetIsXorJoinSplit_centerPlaceRemovesTokenAccordingToInnerArcWeight()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void reverseOperatorTransition_targetIsXorJoinSplitOperator_centerPlaceRemovesToken()
      throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
    ...
    XORJoinSplitOperatorTransitionModel transition =
        (XORJoinSplitOperatorTransitionModel) container.getElementById(reversedArc.getTargetId());
    PlaceModel centerPlace = transition.getCenterPlace();
  ...
  @Test
  public void
      reverseOperatorTransition_targetIsXorJoinSplitOperatorIncomingArcReversed_sourcePlaceReceivesTokens()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void
      reverseOperatorTransition_targetIsXorJoinSplitOperatorIncomingArcReversed_otherSourcePlacesDoNotChangeTokens()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void
      reverseOperatorTransition_sourceIsXorJoinSplit_centerPlaceAddsTokensAccordingToInnerArcWeight()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
    ...
    ArcModel innerArc =
        t1.getSimpleTransContainer().findArc(centerPlace.getId(), innerTransitionId);
    innerArc.setInscriptionValue(innerArcWeight);
  ...
  @Test
  public void
      reverseOperatorTransition_sourceIsXorJoinSplit_targetPlaceRemovesTokensAccordingToOuterArcWeight()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void
      reverseOperatorTransition_targetIsXorJoinSplitOperatorReverseIncomingArc_targetPlacesDoNotChangeTokens()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void reverseOperatorTransition_sourceIsXorSplitOperator_targetPlaceRemovesTokens()
      throws Exception {
    sut = createTestInstance(createXorSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void reverseOperatorTransition_sourceIsXorSplitOperator_sourcePlaceReceivesTokens()
      throws Exception {
    sut = createTestInstance(createXorSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void
      reverseOperatorTransition_sourceIsXorSplitOperator_independentPlaceDoesNotChangeTokens()
          throws Exception {
    sut = createTestInstance(createXorSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void reverseOperatorTransition_sourceIsXorJoinSplitOperator_centerPlaceReceivesToken()
      throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
    ...
    XORJoinSplitOperatorTransitionModel transition =
        (XORJoinSplitOperatorTransitionModel) container.getElementById(reversedArc.getSourceId());
    PlaceModel centerPlace = transition.getCenterPlace();
  ...
  @Test
  public void reverseOperatorTransition_sourceIsXorJoinSplitOperator_targetPlaceRemovesTokens()
      throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void
      reverseOperatorTransition_sourceIsXorJoinSplitOperator_otherTargetPlacesDoesNotChangeTokens()
          throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void reverseOperatorTransition_sourceIsXorJoinSplitOperator_sourcePlacesDoNotChangeTokens()
      throws Exception {
    sut = createTestInstance(createXorJoinSplitNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void produceTokensBackward_arcFromPlaceToTransition_sourcePlaceReceivesToken()
      throws Exception {
  ...
  public void produceTokensBackward_arcFromTransitionToPlace_logsError() throws Exception {
    ...
    verify(mockLogger)
        .warn(
            "TokenGame: Cannot receive token. Target is not a place. Ignore arc: "
                + reversedArc.getId());
  }
  ...
  @Test
  public void produceTokensBackward_arcHasWeight_sourcePlaceReceivesTokensAccordingToWeight()
      throws Exception {
    sut = createTestInstance(netGenerator.createSimpleNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  public void produceTokens_arcFromPlaceToTransition_logsError() throws Exception {
    ...
    verify(mockLogger)
        .warn("TokenGame: Cannot receive token. Target is not a place. Ignore arc: " + arc.getId());
  }
  ...
  public void consumeTokens_arcFromTransitionToPlace_logsWarning() throws Exception {
    ...
    verify(mockLogger)
        .warn("TokenGame: Cannot send token. Source is not a place. Ignore arc: " + arc.getId());
  }
  ...
  @Test
  public void consumeTokensBackward_validArcWithWeight_placeAddsTokensAccordingToWeight()
      throws Exception {
    sut = createTestInstance(netGenerator.createSimpleNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  public void consumeTokensBackward_arcFromPlaceToTransition_logsWarning() throws Exception {
    ...
    verify(mockLogger)
        .warn(
            "TokenGame: Cannot send token. Source is not a place. Ignore arc: "
                + reversedArc.getId());
  }
  ...
  @Test
  public void setArcActiveState_activateAndPlaceFulfillsRequirements_arcIsSetToTrue()
      throws Exception {
    sut = createTestInstance(netGenerator.createSimpleNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void setArcActiveState_placeHasNotEnoughTokensAccordingToWeight_arcActiveStateSetToFalse()
      throws Exception {
    sut = createTestInstance(createXorJoinNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void setArcActiveState_activateAndPlaceDoesNotFulfillsRequirements_arcStateIsFalse()
      throws Exception {
    sut = createTestInstance(netGenerator.createSimpleNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
  ...
  @Test
  public void setArcActiveState_deactivateArcIsAlreadyActivated_arcIsNotActivated()
      throws Exception {
    sut = createTestInstance(netGenerator.createSimpleNet());
    ModelElementContainer container = sut.getThisEditor().getModelProcessor().getElementContainer();
