...
public class MarkingTest {
  ...
  public void asMultiString_twoPlacesWithoutTokens_returnsEmptyBrackets() throws Exception {
    ...
    Marking cut =
        new Marking(
            new int[] {0, 0}, new PlaceNode[] {place1, place2}, new boolean[] {false, false});
  ...
  public void asMultiString_placesWithoutTokens_thosePlacesAreNotContained() throws Exception {
    ...
    Marking cut =
        new Marking(
            new int[] {2, 0}, new PlaceNode[] {place1, place2}, new boolean[] {false, false});
  ...
  @Test
  public void asMultiString_placesWithUnboundTokens_thosePlacesAreContainedWithOmegaTokens()
      throws Exception {
  ...
  public void asMultiString_placesWithDifferentIdLength_hasShortLexOrdering() throws Exception {
    ...
    Marking cut =
        new Marking(
            new int[] {1, 1}, new PlaceNode[] {place1, place2}, new boolean[] {false, false});
  ...
  public void asTokenVectorString_placeUnbound_outputContainsUnboundSign() throws Exception {
    ...
    Marking cut =
        new Marking(
            new int[] {1, 0}, new PlaceNode[] {place1, place2}, new boolean[] {false, true});
  ...
  @Test
  public void lessOrEqual_bothUnlimitedDifferentTokens_returnsTrueBothDirections()
      throws Exception {
    IMarking m1 = createDemoMarking(new int[] {1, 0, 0}, new boolean[] {true, true, true});
