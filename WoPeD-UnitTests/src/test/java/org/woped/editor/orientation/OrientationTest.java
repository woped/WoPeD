...
public class OrientationTest {
  ...
  public void moveAllElements_simpleNetWithOneArcPoint_movesAllElements() throws Exception {
    ...
    Point2D expectedTransitionLocation =
        new Point2D.Double(t1.getX() + offsetX, t1.getY() + offsetY);
    Point2D expectedArcPointLocation =
        new Point2D.Double(arcPoint.getX() + offsetX, arcPoint.getY() + offsetY);
