  ...
  public Set<Map.Entry<K,V>> entrySet() {
    return new AbstractSet<Map.Entry<K,V>>() {
      ...
      public Iterator<Map.Entry<K,V>> iterator() {
        ...
        class NullingIterator implements Iterator<Map.Entry<K,V>> {
        ...
        Iterator<Entry<K, V>> iter2 = new FilteredIterator<Entry<K,V>>(new NullingIterator(deltaMap.entrySet().iterator()), filter2);
