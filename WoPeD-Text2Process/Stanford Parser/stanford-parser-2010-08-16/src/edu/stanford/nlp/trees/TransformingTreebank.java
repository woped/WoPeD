 ...
 *  <code>iterator()</code>.
 *  <p>
 *  <i>Important note</i>: This class will only function properly if the TreeTransfomer
...
class MyTreeTransformer implements TreeTransformer {

  public Tree transformTree(Tree tree) {
    Tree treeCopy = tree.deeperCopy();
...
class MyTreeTransformer2 implements TreeTransformer {
