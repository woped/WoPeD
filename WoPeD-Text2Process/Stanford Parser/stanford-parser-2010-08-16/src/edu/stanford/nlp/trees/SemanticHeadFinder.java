 ...
 * Moreover, the parser often gets wrong sentences like "How much was the check?":
...
public class SemanticHeadFinder extends ModCollinsHeadFinder {
  ...
  private HashSet<String> barriers;
  ...
  public SemanticHeadFinder(TreebankLanguagePack tlp, boolean cop) {
    ...
    if (cop) {
      copulars.addAll(Arrays.asList(new String[]{"be", "being", "Being", "been", "am", "are", "is", "was", "were", "'m", "'re", "'s", "s", "seem", "seems", "seemed", "appear", "appears", "appeared", "stay", "stays", "stayed", "remain", "remains", "remained", "resemble", "resembles", "resembled", "become", "becomes", "became"}));
    ...
    barriers = new HashSet<String>();
    barriers.addAll(Arrays.asList(new String[]{"SBAR", "SBARQ", "NP", "PP"}));
  }
  ...
  private void ruleChanges() {
    ...
    nonTerminalInfo.put("NP", new String[][]{{"rightdis", "NN", "NNP", "NNPS", "NNS", "NX", "JJR"}, {"left", "NP", "PRP"}, {"rightdis", "$", "ADJP", "PRN"}, {"right", "CD"}, {"rightdis", "JJ", "JJS", "RB", "QP", "DT", "WDT", "RBR", "ADVP"}, {"left", "POS"}, rightExceptPunct});
    // WHNP clauses should have the same sort of head as an NP
    nonTerminalInfo.remove("WHNP");
    nonTerminalInfo.put("WHNP", new String[][]{{"left", "NP"}, {"rightdis", "NN", "NNP", "NNPS", "NNS", "NX", "POS", "JJR", "WP"}, {"rightdis", "$", "ADJP", "PRN"}, {"right", "CD"}, {"rightdis", "JJ", "JJS", "RB", "QP"}, {"left", "WHNP", "WHPP", "WHADJP", "WP$", "WP", "WDT"}});
    //WHADJP
    nonTerminalInfo.remove("WHADJP");
    nonTerminalInfo.put("WHADJP", new String[][]{{"left", "ADJP", "JJ", "JJR"}, {"right", "RB"}, rightExceptPunct});
    //WHADJP
    nonTerminalInfo.remove("WHADVP");
    ...
    nonTerminalInfo.put("FRAG", new String[][]{{"left", "ADJP", "ADVP", "FRAG", "S"}, leftExceptPunct});
    ...
    // PRN: sentence first
    nonTerminalInfo.put("PRN", new String[][]{{"left", "VP", "S", "SINV", "SBAR", "NP", "ADJP", "PP", "ADVP", "INTJ", "WHNP", "NAC", "VBP", "JJ", "NN", "NNP"}, leftExceptPunct});

    // add the constituent XS (special node to add a layer in a QP tree)
  ...
  protected Tree determineNonTrivialHead(Tree t, Tree parent) {
    ...
    if ((motherCat.equals("VP") || motherCat.equals("SQ") || motherCat.equals("SINV"))) {
      ...
      if (DEBUG) {
        ...
        System.err.println("hasVerbalAuxiliary[verbAux](" + t + ") = " + hasVerbalAuxiliary(kids, verbalAuxiliaries));
        System.err.println("hasVerbalAuxiliary[copulars](" + t + ") = " + hasVerbalAuxiliary(kids, copulars));
      }
