...
public class IOUtils {
  ...
  private static InputStream getInputStreamFromString(String textFileOrUrl)
      throws IOException {
    InputStream is;
  ...
  public static BufferedReader readReaderFromString(String textFileOrUrl)
    ...
    return new BufferedReader(new InputStreamReader(
        getInputStreamFromString(textFileOrUrl)));
  }
    ...
    return new Iterable<File>() {
      public Iterator<File> iterator() {
        return new AbstractIterator<File>() {
          private Queue<File> files = new LinkedList<File>(Collections
              .singleton(dir));
