...
public class DocumentPreprocessor {
  ...
  /** Get sentence of text from a reader.  This one assumes no extra escaping of tokens
   *  (use what tokenizer gives), do automatic sentence segmentation (no sentence delimiter
   *  in the input) and no POS tags on tokens in the input.
   *
    * @param input a Reader of text
  ...
  /**
   * Returns a list of sentences contained in an XML file, occurring between
   * the begin and end of a selected tag.
   *
