...
//      pw.println(" N: " + getNum());
  ...
  */
  ...
  public static class RuleErrorEval extends AbstractEval {
    ...
    protected <T> void display(ClassicCounter<T> c, int num, PrintWriter pw) {
  ...
  public static class CatErrorEval extends AbstractEval {
    ...
    List<String> myMakeObjects(Tree tree) {
    ...
    protected <T> void display(ClassicCounter<T> c, PrintWriter pw) {
