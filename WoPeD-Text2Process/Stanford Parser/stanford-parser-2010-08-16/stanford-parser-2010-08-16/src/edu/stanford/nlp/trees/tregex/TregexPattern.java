 ...
 * Trying to do so will cause a {@link ParseException} to be thrown. Named nodes <it>can be put within the scope of an optionality operator</it>.
 *
 ...
 * <ul>
 *
 * <li> Due to the lack of parent pointers in {@link edu.stanford.nlp.trees.Tree}s, parents are found via
...
public abstract class TregexPattern implements Serializable {
   ...
   * @throws ParseException if the string does not parse
   */
