...
public class ChineseTreebankParserParams extends AbstractTreebankParserParams {
  ...
  /* --------- not used now
    ...
    // big flat FRAGs....
    private static String[] splitters5 = new String[] {"NN^FRAG", "NT^FRAG", "NR^FRAG", "VV^FRAG", "VV^VCD", "VV^VRD", "NP^NP", "VP^VP", "IP^ROOT", "IP^IP", "PU^NP", "PU^FRAG", "P^PP~VP", "P^PP~IP"};
    private static String[] splitters6 = new String[] {"VV^VCD", "VV^VRD", "NP^NP", "VP^VP", "IP^ROOT", "IP^IP", "PU^NP", "P^PP~VP", "P^PP~IP"};
    private static String[] splitters7 = new String[] {"NP^NP", "VP^VP", "IP^ROOT", "IP^IP", "PU^NP", "P^PP~VP", "P^PP~IP"};
    private static String[] splitters8 = new String[] {"IP^ROOT", "IP^IP", "PU^NP", "P^PP~VP", "P^PP~IP"};
    private static String[] splitters9 = new String[] {"VV^VCD", "VV^VRD", "NP^NP", "VP^VP", "IP^ROOT", "IP^IP", "P^PP~VP", "P^PP~IP"};
    private static String[] splitters10 = new String[] {"NP^NP", "VP^VP", "IP^ROOT", "IP^IP", "P^PP~VP", "P^PP~IP"};
  ...
  public int setOptionFlag(String[] args, int i) {
    ...
    if (args[i].equalsIgnoreCase("-paRootDtr")) {
      ...
      segmentMaxMatch = true;
      try {
        segmenter = (WordSegmenter) Class.forName("edu.stanford.nlp.wordseg.MaxMatchSegmenter").newInstance();
      } catch (Exception e) {
        printlnErr("Couldn't instantiate segmenter " + "edu.stanford.nlp.wordseg.MaxMatchSegmenter" + ": " + e);
      }
      i++;
  ...
  @Override
  public Extractor<DependencyGrammar> dependencyGrammarExtractor(final Options op) {
    /* ----------
  ...
  public Sentence<Word> defaultTestSentence() {
    return Sentence.toSentence("\u951f\u65a4\u62f7", "\u951f\u65a4\u62f7", "\u5b66\u6821", "\u951f\u65a4\u62f7", "\u5b66\u4e60", "\u951f\u65a4\u62f7");
  }
