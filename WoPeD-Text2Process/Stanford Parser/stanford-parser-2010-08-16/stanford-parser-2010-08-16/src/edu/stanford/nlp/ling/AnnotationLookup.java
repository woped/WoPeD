...
import edu.stanford.nlp.ling.CoreAnnotations.CorefAnnotation;
...
public class AnnotationLookup {
  ...
  public enum KeyLookup {
    ...
    WORD_KEY(WordAnnotation.class, OldFeatureLabelKeys.WORD_KEY),
    ...
    COREF_KEY(CorefAnnotation.class, OldFeatureLabelKeys.COREF_KEY),
    ...
    CURRENT_KEY(CurrentAnnotation.class, OldFeatureLabelKeys.CURRENT_KEY),
