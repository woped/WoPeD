...
public class PetriNet {
	...
	public void transformToWorkflowNet() throws PetrinetGenerationException {
        if(isEmptyPetrinet()){
            throw new PetrinetGenerationException("Workflownet cant be created based on the given input.");
        }
    ...
    private boolean isEmptyPetrinet(){
	  return arcList.size()==0 ||placeList.size()==0|| transitionList.size()==0;
    }
    ...
    private void unifySources(){
        ...
        if(sources.size()>1){
            ...
            Transition t = elementBuilder.createTransition("start process",false,false,"");
