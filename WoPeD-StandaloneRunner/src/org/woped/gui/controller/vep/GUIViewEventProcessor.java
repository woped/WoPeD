...
public class GUIViewEventProcessor extends AbstractEventProcessor
{
    ...
    private void quit()
    {
        ...
        for (Iterator iter = editorList.iterator(); iter.hasNext();)
        {
            ...
            processViewEvent(new ViewEvent(editor, AbstractViewEvent.VIEWEVENTTYPE_GUI, AbstractViewEvent.CLOSE));
        ...
        if (editor instanceof EditorVC)
        {
            ...
            if (!editorVC.isSaved())
            {
                ...
                if (editorVC.getDefaultFileType() != FileFilterImpl.SAMPLEFilter)
                {
                    ...
                    {
                        // try to save
                        getMediator().processViewEvent(new ViewEvent(editor, AbstractViewEvent.VIEWEVENTTYPE_FILE, AbstractViewEvent.SAVE));
