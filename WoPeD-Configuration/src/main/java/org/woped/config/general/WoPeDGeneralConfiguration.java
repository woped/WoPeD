...
public class WoPeDGeneralConfiguration extends WoPeDConfiguration implements IGeneralConfiguration {
  ...
  public boolean readConfig() {
    ...
    if (new File(fn).exists()) {
      LoggerManager.info(
          Constants.CONFIG_LOGGER, rb.getString("Init.Config.LoadingFrom") + ": " + fn + ".");
  ...
  public boolean readConfig(XmlObject configDoc) {
    ...
    if (confDoc != null && (config = confDoc.getConfiguration()) != null) {
      ...
      setWindowSize(
          new Dimension(
              config.getGui().getWindow().getWidth(), config.getGui().getWindow().getHeight()));
  ...
  public boolean isEditingOnCreation() {
    return getConfDocument().getConfiguration().getEditor().getEditOnCreation();
  }

  /**
   * Sets the editingOnCreation.
   *
   * @param editingOnCreation The editingOnCreation to set
   */
  public void setEditingOnCreation(boolean editingOnCreation) {
    if (editingOnCreation != getConfDocument().getConfiguration().getEditor().getEditOnCreation()) {
      getConfDocument().getConfiguration().getEditor().setEditOnCreation(editingOnCreation);
    }
  }
   ...
   *
   * @param insertCOPYwhenCopied The insertCOPYwhencopied to set
   */
  public void setInsertCOPYwhenCopied(boolean insertCOPYwhenCopied) {
    getConfDocument().getConfiguration().getEditor().setInsertCopy(insertCOPYwhenCopied);
  }
  ...
  public boolean isExportToolspecific() {
    return getConfDocument().getConfiguration().getTools().getExporting().getToolspecific();
  }
  ...
  public boolean isImportToolspecific() {
    return getConfDocument().getConfiguration().getTools().getImporting().getToolspecific();
  }

  /**
   * Sets the exportToolspecific.
   *
   * @param exportToolspecific The exportToolspecific to set
   */
   ...
   *
   * @param importToolspecific The importToolspecific to set
   */
  ...
  public void addRecentFile(String name, String path) {
    try {
      ...
      for (int idx = 0; idx < runtimeRecentFiles.size(); idx++) {
        if (((WoPeDRecentFile) runtimeRecentFiles.get(idx)).getPath().equals(path)) {
          // delete the entry
  ...
  public boolean isMaximizeWindow() {
    return getConfDocument().getConfiguration().getGui().getWindow().getMaximize();
  }
  ...
  public Dimension getWindowSize() {
    return new Dimension(
        getConfDocument().getConfiguration().getGui().getWindow().getWidth(),
        getConfDocument().getConfiguration().getGui().getWindow().getHeight());
  }
  ...
  public void setWindowSize(Dimension windowSize) {
    ...
    getConfDocument().getConfiguration().getGui().getWindow().setWidth((int) windowSize.getWidth());
  }

  public void setMaximizeWindow(boolean maximized) {
    getConfDocument().getConfiguration().getGui().getWindow().setMaximize(maximized);
  }
   ...
   *
   * @param hd The home directory to set
   */
  ...
  public boolean isUseWoflan() {
    return getConfDocument().getConfiguration().getTools().getWoflan().getUseWoflan();
  }
  ...
  public String getWoflanPath() {
    return getConfDocument().getConfiguration().getTools().getWoflan().getWoflanPath();
  }

  /**
   * Sets the useWoflan.
   *
   * @param useWoflan The useWoflan to set
   */
  public void setUseWoflan(boolean useWoflan) {
    getConfDocument().getConfiguration().getTools().getWoflan().setUseWoflan(useWoflan);
  }

  /**
   * Sets the woflanPath.
   *
   * @param woflanPath The woflanPath to set
   */
  public void setWoflanPath(String woflanPath) {
    getConfDocument().getConfiguration().getTools().getWoflan().setWoflanPath(woflanPath);
  }
  ...
  public boolean isSmartEditing() {
    return getConfDocument().getConfiguration().getEditor().getSmartEditing();
  }

  /**
   * Sets the smartEditing.
   *
   * @param smartEditing The smartEditing to set
   */
  public void setSmartEditing(boolean smartEditing) {
    getConfDocument().getConfiguration().getEditor().setSmartEditing(smartEditing);
  }
  ...
  public void setTpnSaveElementAsName(boolean b) {
    getConfDocument().getConfiguration().getTools().getExporting().setTpnExportElementAsName(b);
  }
  ...
  public String getLookAndFeel() {
    return getConfDocument().getConfiguration().getGui().getWindow().getLookAndFeel();
  }
  ...
  public void setArrowheadSize(int headSize) {
    getConfDocument().getConfiguration().getEditor().setArrowheadSize(headSize);
  }
  ...
  public void setFillArrowHead(boolean fill) {
    getConfDocument().getConfiguration().getEditor().setArrowFilledHead(fill);
  }
  ...
  public void setLocaleLanguage(String language) {
    getConfDocument().getConfiguration().getGui().getLocale().setLanguage(language);
  }
  ...
  public void setLocale() {
    ...
    LoggerManager.info(
        Constants.CONFIG_LOGGER,
        (this.locale.equals(Locale.GERMANY) ? "Setze Locale auf " : "Setting Locale to ")
            + this.locale);
  }
  ...
  public int getDefaultColor1() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor1();
  }

  public int getDefaultColor2() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor2();
  }

  public int getDefaultColor3() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor3();
  }

  public int getDefaultColor4() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor4();
  }

  public int getDefaultColor5() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor5();
  }

  public int getDefaultColor6() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor6();
  }

  public int getDefaultColor7() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor7();
  }

  public int getDefaultColor8() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor8();
  }

  public int getDefaultColor9() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor9();
  }

  public int getDefaultColor10() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor10();
  }

  public int getDefaultColor11() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor11();
  }

  public int getDefaultColor12() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor12();
  }

  public int getDefaultColor13() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor13();
  }

  public int getDefaultColor14() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor14();
  }

  public int getDefaultColor15() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor15();
  }

  public int getDefaultColor16() {
    return getConfDocument().getConfiguration().getColoring().getDefaultcolor16();
  }
  ...
  public void setApromoreServerURL(String server) {
    getConfDocument().getConfiguration().getTools().setAproServerURL(server);
  }
  ...
  public void setApromoreProxyName(String proxyName) {
    getConfDocument().getConfiguration().getTools().setAproProxyName(proxyName);
  }
  ...
  public void setCurrentApromoreIndex(int index) {
    getConfDocument().getConfiguration().getTools().setAproCurrentIndex(index);
  }

  @Override
  public boolean isSetApromorePassword() {
    return getConfDocument().getConfiguration().getTools().isSetAproPassword();
  }
  ...
  public boolean isSetApromoreServers() {
    boolean result = getConfDocument().getConfiguration().isSetApromoreServers();
    return result;
  }
  ...
  public int getApromoreServerListLength() {
    return getConfDocument().getConfiguration().getApromoreServers().sizeOfApromoreServerArray();
  }

  @Override
  public ApromoreServer[] getApromoreServers() {
    return getConfDocument().getConfiguration().getApromoreServers().getApromoreServerArray();
  }
  ...
  public void addApromoreServer(
    ...
    if (isSetApromoreServers()) {
      setServerAttribute(ID, name, url, port, path, user, pwd, useProxy, proxyUrl, proxyPort);
    } else {
      addServersList();
      setServerAttribute(ID, name, url, port, path, user, pwd, useProxy, proxyUrl, proxyPort);
    }
  ...
  private void setServerAttribute(
      int ID,
      String name,
      String url,
      int port,
      ...
      String proxyUrl,
      int proxyPort) {
    getConfDocument().getConfiguration().getApromoreServers().addNewApromoreServer();
  ...
  public void removeApromoreServer(int index) {
    getConfDocument().getConfiguration().getApromoreServers().removeApromoreServer(index);
  }
  ...
  public boolean getBusinessDashboardUseByDefault() {
    ...
    if (bd.isSetUsebydefault()) {
      return getConfDocument().getConfiguration().getBusinessdashboard().getUsebydefault();
    } else
      return ConfigurationManager.getStandardConfiguration().getBusinessDashboardUseByDefault();
  }
   ...
   *
   * @param exportExplicitPlaces The exportToolspecific to set
   */
