 ...
 *     Philip Allgaier <br>
 *     All configuration data for WoPeD. Reads/saves the configuration permanently from/to file.
 *     During runtime the configuration data is stored in the generated XMLBeans objects.
 */
public abstract class WoPeDConfiguration implements IConfiguration {
  ...
  public void setDefaultHomedir(String dhd) {
    LoggerManager.info(
        Constants.CONFIG_LOGGER, rb.getString("Init.Config.SettingDfHomeDir") + ": " + dhd);
    defaultHomedir = dhd;
  }
  ...
  public void setCurrentWorkingdir(String cwd) {
    LoggerManager.info(
        Constants.CONFIG_LOGGER, rb.getString("Init.Config.SettingWorkDir") + ": " + cwd);
  ...
  public boolean saveConfig() {
    ...
    if (confOk)
      LoggerManager.info(
          ...
          rb.getString("Exit.Config.SavingSuccess") + ": " + getConfigFilePath());
    else
      LoggerManager.error(
          Constants.CONFIG_LOGGER,
          rb.getString("Exit.Config.SavingError") + ": " + getConfigFilePath());
